...
const page = 1;
  ...
  const { data } = await pandascore.players.getPlayers(
  {
		filter: filter,
		range: range,
    sort: [[]],
...
(async () => {
  ...
  const { data } = await pandascore.players.getPlayersPlayerIdOrSlug();
...
const page = 1;
  ...
  const { data } = await pandascore.players.getPlayersPlayerIdOrSlugLeagues(
  ,
  {
		filter: filter,
		range: range,
...
const page = 1;
  ...
  const { data } = await pandascore.players.getPlayersPlayerIdOrSlugMatches(
  ,
  {
		filter: filter,
		range: range,
...
const page = 1;
  ...
  const { data } = await pandascore.players.getPlayersPlayerIdOrSlugSeries(
  ,
  {
		filter: filter,
		range: range,
...
const page = 1;
  ...
  const { data } = await pandascore.players.getPlayersPlayerIdOrSlugTournaments(
  ,
  {
		filter: filter,
		range: range,
