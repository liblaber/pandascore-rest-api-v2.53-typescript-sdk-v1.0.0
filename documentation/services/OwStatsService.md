...
(async () => {
  ...
  const { data } = await pandascore.owStats.getOwGamesOwGameIdPlayersPlayerIdOrSlugStats(4);
...
(async () => {
  ...
  const { data } = await pandascore.owStats.getOwMatchesMatchIdOrSlugPlayersStats();
...
const playerIdOrSlug = 2;
  ...
  const { data } = await pandascore.owStats.getOwMatchesMatchIdOrSlugPlayersPlayerIdOrSlugStats(
  ,
...
(async () => {
  ...
  const { data } = await pandascore.owStats.getOwPlayersPlayerIdOrSlugStats(
  ,
  {
    from_: "2017-07-21",
    to: "2017-07-21",
...
const playerIdOrSlug = 2;
  ...
  const { data } = await pandascore.owStats.getOwSeriesSerieIdOrSlugPlayersPlayerIdOrSlugStats(
  ,
...
const playerIdOrSlug = 2;
  ...
  const { data } = await pandascore.owStats.getOwTournamentsTournamentIdOrSlugPlayersPlayerIdOrSlugStats(
  ,
