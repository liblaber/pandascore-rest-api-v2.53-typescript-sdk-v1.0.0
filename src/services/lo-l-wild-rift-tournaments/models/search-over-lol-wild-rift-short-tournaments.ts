 ...
 */
export const searchOverLolWildRiftShortTournaments: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {SearchOverLolWildRiftShortTournaments} searchOverLolWildRiftShortTournaments
 * @property {string}
 * @property {string}
 * @property {string}
 ...
 */
export type SearchOverLolWildRiftShortTournaments = z.infer<typeof searchOverLolWildRiftShortTournaments>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverLolWildRiftShortTournamentsResponse: any = z.lazy(() => {
  return z
    .object({
      name: z.string().optional(),
      prizepool: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverLolWildRiftShortTournamentsRequest: any = z.lazy(() => {
  return z
    .object({
