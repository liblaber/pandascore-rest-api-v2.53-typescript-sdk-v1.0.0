...
import {
  ...
  filterOverLolWildRiftShortTournamentsVideogameTitleRequest,
  filterOverLolWildRiftShortTournamentsVideogameTitleResponse,
} from './filter-over-lol-wild-rift-short-tournaments-videogame-title';
 ...
 */
export const filterOverLolWildRiftShortTournaments: any = z.lazy(() => {
  return z.object({
    ...
    videogameTitle: z.array(filterOverLolWildRiftShortTournamentsVideogameTitle).min(1).optional(),
...
/**
 *
 * @typedef  {FilterOverLolWildRiftShortTournaments} filterOverLolWildRiftShortTournaments
 * @property {string[]}
 ...
 * @property {FilterOverLolWildRiftShortTournamentsVideogameTitle[]} - A videogame title id or slug. <br/>Only for `/csgo/*`, `/codmw/*`, `/fifa/*` and `/ow/*` endpoints <br/>
 * @property {OpponentId[]}
 * @property {OpponentType[]}
 */
export type FilterOverLolWildRiftShortTournaments = z.infer<typeof filterOverLolWildRiftShortTournaments>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverLolWildRiftShortTournamentsResponse: any = z.lazy(() => {
  return z
    .object({
      ...
      slug: z.array(z.string()).min(1).optional(),
      tier: z.array(searchOverValorantShortTournamentsTier2).min(1).optional(),
      videogame_title: z.array(filterOverLolWildRiftShortTournamentsVideogameTitleResponse).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverLolWildRiftShortTournamentsRequest: any = z.lazy(() => {
  return z
    .object({
      ...
      videogameTitle: z.array(filterOverLolWildRiftShortTournamentsVideogameTitleRequest).nullish(),
