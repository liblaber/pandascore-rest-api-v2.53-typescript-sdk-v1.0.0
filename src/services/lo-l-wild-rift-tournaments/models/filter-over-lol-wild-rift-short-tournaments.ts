 ...
 */
export const filterOverLolWildRiftShortTournaments = z.lazy(() => {
  return z.object({
 ...
 */
export const filterOverLolWildRiftShortTournamentsResponse = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverLolWildRiftShortTournamentsRequest = z.lazy(() => {
  return z
    .object({
