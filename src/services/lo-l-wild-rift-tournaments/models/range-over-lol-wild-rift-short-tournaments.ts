 ...
 */
export const rangeOverLolWildRiftShortTournaments = z.lazy(() => {
  return z.object({
 ...
 */
export const rangeOverLolWildRiftShortTournamentsResponse = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverLolWildRiftShortTournamentsRequest = z.lazy(() => {
  return z
    .object({
