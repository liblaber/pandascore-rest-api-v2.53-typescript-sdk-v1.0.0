 ...
 */
export const rangeOverLolWildRiftShortTournaments: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {RangeOverLolWildRiftShortTournaments} rangeOverLolWildRiftShortTournaments
 * @property {string[]}
 * @property {boolean[]}
 * @property {string[]}
 * @property {boolean[]}
 ...
 */
export type RangeOverLolWildRiftShortTournaments = z.infer<typeof rangeOverLolWildRiftShortTournaments>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverLolWildRiftShortTournamentsResponse: any = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverLolWildRiftShortTournamentsRequest: any = z.lazy(() => {
  return z
    .object({
