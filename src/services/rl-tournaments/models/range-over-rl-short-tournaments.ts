 ...
 */
export const rangeOverRlShortTournaments: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {RangeOverRlShortTournaments} rangeOverRlShortTournaments
 * @property {string[]}
 * @property {boolean[]}
 * @property {string[]}
 * @property {boolean[]}
 ...
 */
export type RangeOverRlShortTournaments = z.infer<typeof rangeOverRlShortTournaments>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverRlShortTournamentsResponse: any = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverRlShortTournamentsRequest: any = z.lazy(() => {
  return z
    .object({
