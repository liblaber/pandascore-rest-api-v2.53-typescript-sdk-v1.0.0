 ...
 */
export const rangeOverRlShortTournaments = z.lazy(() => {
  return z.object({
 ...
 */
export const rangeOverRlShortTournamentsResponse = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverRlShortTournamentsRequest = z.lazy(() => {
  return z
    .object({
