 ...
 */
export const filterOverRlShortTournaments = z.lazy(() => {
  return z.object({
 ...
 */
export const filterOverRlShortTournamentsResponse = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverRlShortTournamentsRequest = z.lazy(() => {
  return z
    .object({
