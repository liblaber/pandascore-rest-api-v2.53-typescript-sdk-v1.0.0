 ...
 */
export const searchOverRlShortTournaments: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {SearchOverRlShortTournaments} searchOverRlShortTournaments
 * @property {string}
 * @property {string}
 * @property {string}
 ...
 */
export type SearchOverRlShortTournaments = z.infer<typeof searchOverRlShortTournaments>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverRlShortTournamentsResponse: any = z.lazy(() => {
  return z
    .object({
      name: z.string().optional(),
      prizepool: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverRlShortTournamentsRequest: any = z.lazy(() => {
  return z
    .object({
