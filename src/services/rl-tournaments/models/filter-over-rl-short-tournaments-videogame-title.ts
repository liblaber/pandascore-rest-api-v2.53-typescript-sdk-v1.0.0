 ...
 */
export const filterOverRlShortTournamentsVideogameTitle = z.lazy(() => {
 ...
 */
export const filterOverRlShortTournamentsVideogameTitleResponse = z.lazy(() => {
  return z.union([z.number(), z.string()]);
});
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverRlShortTournamentsVideogameTitleRequest = z.lazy(() => {
  return z.union([z.number(), z.string()]);
});
