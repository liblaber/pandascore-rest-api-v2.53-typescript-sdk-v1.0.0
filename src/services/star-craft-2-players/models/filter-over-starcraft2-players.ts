 ...
 */
export const filterOverStarcraft2Players: any = z.lazy(() => {
  return z.object({
 ...
 */
export const filterOverStarcraft2PlayersResponse: any = z.lazy(() => {
  return z
    .object({
      active: z.boolean().optional(),
      birthday: z.array(z.string()).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverStarcraft2PlayersRequest: any = z.lazy(() => {
  return z
    .object({
