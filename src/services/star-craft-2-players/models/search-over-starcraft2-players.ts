 ...
 */
export const searchOverStarcraft2Players: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {SearchOverStarcraft2Players} searchOverStarcraft2Players
 ...
 */
export type SearchOverStarcraft2Players = z.infer<typeof searchOverStarcraft2Players>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverStarcraft2PlayersResponse: any = z.lazy(() => {
  return z
    .object({
      birthday: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverStarcraft2PlayersRequest: any = z.lazy(() => {
  return z
    .object({
