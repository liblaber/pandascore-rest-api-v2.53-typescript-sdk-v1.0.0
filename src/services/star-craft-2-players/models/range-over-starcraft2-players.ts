 ...
 */
export const rangeOverStarcraft2Players = z.lazy(() => {
  return z.object({
 ...
 */
export const rangeOverStarcraft2PlayersResponse = z.lazy(() => {
  return z
    .object({
      birthday: z.array(z.string()).min(2).max(2).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverStarcraft2PlayersRequest = z.lazy(() => {
  return z
    .object({
