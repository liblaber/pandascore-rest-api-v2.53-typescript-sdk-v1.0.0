 ...
 */
export const rangeOverR6SiegeTeams: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {RangeOverR6SiegeTeams} rangeOverR6SiegeTeams
 * @property {string[]}
 * @property {number[]}
 * @property {string[]}
 * @property {string[]}
 ...
 * @property {string[]}
 */
export type RangeOverR6SiegeTeams = z.infer<typeof rangeOverR6SiegeTeams>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverR6SiegeTeamsResponse: any = z.lazy(() => {
  return z
    .object({
      acronym: z.array(z.string()).min(2).max(2).optional(),
      id: z.array(z.number()).min(2).max(2).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverR6SiegeTeamsRequest: any = z.lazy(() => {
  return z
    .object({
