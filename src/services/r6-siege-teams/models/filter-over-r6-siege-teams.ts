 ...
 */
export const filterOverR6SiegeTeams: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {FilterOverR6SiegeTeams} filterOverR6SiegeTeams
 * @property {string[]}
 * @property {number[]}
 * @property {string[]}
 * @property {string[]}
 ...
 */
export type FilterOverR6SiegeTeams = z.infer<typeof filterOverR6SiegeTeams>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverR6SiegeTeamsResponse: any = z.lazy(() => {
  return z
    .object({
      acronym: z.array(z.string()).min(1).optional(),
      id: z.array(z.number()).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverR6SiegeTeamsRequest: any = z.lazy(() => {
  return z
    .object({
