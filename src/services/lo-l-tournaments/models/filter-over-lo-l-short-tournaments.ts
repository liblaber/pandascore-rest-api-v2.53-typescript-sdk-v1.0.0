...
import {
  ...
  filterOverLoLShortTournamentsVideogameTitleRequest,
  filterOverLoLShortTournamentsVideogameTitleResponse,
} from './filter-over-lo-l-short-tournaments-videogame-title';
 ...
 */
export const filterOverLoLShortTournaments: any = z.lazy(() => {
  return z.object({
    ...
    videogameTitle: z.array(filterOverLoLShortTournamentsVideogameTitle).min(1).optional(),
...
/**
 *
 * @typedef  {FilterOverLoLShortTournaments} filterOverLoLShortTournaments
 * @property {string[]}
 ...
 * @property {FilterOverLoLShortTournamentsVideogameTitle[]} - A videogame title id or slug. <br/>Only for `/csgo/*`, `/codmw/*`, `/fifa/*` and `/ow/*` endpoints <br/>
 * @property {OpponentId[]}
 * @property {OpponentType[]}
 */
export type FilterOverLoLShortTournaments = z.infer<typeof filterOverLoLShortTournaments>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverLoLShortTournamentsResponse: any = z.lazy(() => {
  return z
    .object({
      ...
      slug: z.array(z.string()).min(1).optional(),
      tier: z.array(searchOverValorantShortTournamentsTier2).min(1).optional(),
      videogame_title: z.array(filterOverLoLShortTournamentsVideogameTitleResponse).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverLoLShortTournamentsRequest: any = z.lazy(() => {
  return z
    .object({
      ...
      videogameTitle: z.array(filterOverLoLShortTournamentsVideogameTitleRequest).nullish(),
