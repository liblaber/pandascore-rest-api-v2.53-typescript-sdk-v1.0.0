 ...
 */
export const filterOverLoLShortTournaments = z.lazy(() => {
  return z.object({
 ...
 */
export const filterOverLoLShortTournamentsResponse = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverLoLShortTournamentsRequest = z.lazy(() => {
  return z
    .object({
