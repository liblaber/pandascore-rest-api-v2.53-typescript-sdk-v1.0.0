 ...
 */
export const rangeOverLoLShortTournaments: any = z.lazy(() => {
  return z.object({
 ...
 */
export const rangeOverLoLShortTournamentsResponse: any = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverLoLShortTournamentsRequest: any = z.lazy(() => {
  return z
    .object({
