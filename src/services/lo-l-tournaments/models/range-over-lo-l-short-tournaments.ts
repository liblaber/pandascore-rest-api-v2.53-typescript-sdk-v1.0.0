 ...
 */
export const rangeOverLoLShortTournaments = z.lazy(() => {
  return z.object({
 ...
 */
export const rangeOverLoLShortTournamentsResponse = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverLoLShortTournamentsRequest = z.lazy(() => {
  return z
    .object({
