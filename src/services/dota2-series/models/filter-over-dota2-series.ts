...
import {
  ...
  filterOverDota2SeriesVideogameTitleRequest,
  filterOverDota2SeriesVideogameTitleResponse,
} from './filter-over-dota2-series-videogame-title';
 ...
 */
export const filterOverDota2Series: any = z.lazy(() => {
  return z.object({
    ...
    videogameTitle: z.array(filterOverDota2SeriesVideogameTitle).min(1).optional(),
...
/**
 *
 * @typedef  {FilterOverDota2Series} filterOverDota2Series
 * @property {string[]}
 * @property {string[]}
 * @property {number[]}
 * @property {number[]}
 ...
 * @property {string[]}
 * @property {string[]}
 * @property {FilterOverDota2SeriesVideogameTitle[]} - A videogame title id or slug. <br/>Only for `/csgo/*`, `/codmw/*`, `/fifa/*` and `/ow/*` endpoints <br/>
 * @property {OpponentId[]}
 * @property {OpponentType[]}
 * @property {number[]}
 */
export type FilterOverDota2Series = z.infer<typeof filterOverDota2Series>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverDota2SeriesResponse: any = z.lazy(() => {
  return z
    .object({
      ...
      season: z.array(z.string()).min(1).optional(),
      slug: z.array(z.string()).min(1).optional(),
      videogame_title: z.array(filterOverDota2SeriesVideogameTitleResponse).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverDota2SeriesRequest: any = z.lazy(() => {
  return z
    .object({
      ...
      videogameTitle: z.array(filterOverDota2SeriesVideogameTitleRequest).nullish(),
