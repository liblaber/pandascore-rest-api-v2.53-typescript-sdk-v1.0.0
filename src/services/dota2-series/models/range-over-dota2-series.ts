 ...
 */
export const rangeOverDota2Series: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {RangeOverDota2Series} rangeOverDota2Series
 * @property {string[]}
 * @property {string[]}
 * @property {number[]}
 * @property {number[]}
 ...
 * @property {number[]}
 */
export type RangeOverDota2Series = z.infer<typeof rangeOverDota2Series>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverDota2SeriesResponse: any = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverDota2SeriesRequest: any = z.lazy(() => {
  return z
    .object({
