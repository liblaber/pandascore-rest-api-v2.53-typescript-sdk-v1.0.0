 ...
 */
export const searchOverValorantMatches: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {SearchOverValorantMatches} searchOverValorantMatches
 * @property {MatchType}
 * @property {string}
 * @property {string}
 ...
 */
export type SearchOverValorantMatches = z.infer<typeof searchOverValorantMatches>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverValorantMatchesResponse: any = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverValorantMatchesRequest: any = z.lazy(() => {
  return z
    .object({
