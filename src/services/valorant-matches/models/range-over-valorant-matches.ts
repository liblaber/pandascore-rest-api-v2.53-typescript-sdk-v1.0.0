 ...
 */
export const rangeOverValorantMatches: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {RangeOverValorantMatches} rangeOverValorantMatches
 * @property {string[]}
 * @property {boolean[]}
 * @property {boolean[]}
 * @property {string[]}
 ...
 */
export type RangeOverValorantMatches = z.infer<typeof rangeOverValorantMatches>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverValorantMatchesResponse: any = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverValorantMatchesRequest: any = z.lazy(() => {
  return z
    .object({
