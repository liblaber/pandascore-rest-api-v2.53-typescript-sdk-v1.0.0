 ...
 */
export const filterOverValorantMatches = z.lazy(() => {
  return z.object({
 ...
 */
export const filterOverValorantMatchesResponse = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverValorantMatchesRequest = z.lazy(() => {
  return z
    .object({
