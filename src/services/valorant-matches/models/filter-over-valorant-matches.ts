...
import {
  ...
  filterOverValorantMatchesOpponentIdRequest,
  filterOverValorantMatchesOpponentIdResponse,
} from './filter-over-valorant-matches-opponent-id';
...
import {
  ...
  filterOverValorantMatchesVideogameTitleRequest,
  filterOverValorantMatchesVideogameTitleResponse,
} from './filter-over-valorant-matches-videogame-title';
import {
  filterOverValorantMatchesVideogameVersion,
  filterOverValorantMatchesVideogameVersionRequest,
  filterOverValorantMatchesVideogameVersionResponse,
} from './filter-over-valorant-matches-videogame-version';
 ...
 */
export const filterOverValorantMatches: any = z.lazy(() => {
  return z.object({
    ...
    opponentId: z.array(filterOverValorantMatchesOpponentId).min(1).optional(),
    ...
    videogameTitle: z.array(filterOverValorantMatchesVideogameTitle).min(1).optional(),
    videogameVersion: z.array(filterOverValorantMatchesVideogameVersion).min(1).optional(),
...
/**
 *
 * @typedef  {FilterOverValorantMatches} filterOverValorantMatches
 * @property {string[]}
 ...
 * @property {boolean}
 * @property {number[]}
 * @property {FilterOverValorantMatchesOpponentId[]} - A Team or a Player (id or slug). You can use`filter[winner_type]=Team` or `filter[winner_type]=Player` to focus on teams or players.
 ...
 * @property {FilterOverValorantMatchesVideogameTitle[]} - A videogame title id or slug. <br/>Only for `/csgo/*`, `/codmw/*`, `/fifa/*` and `/ow/*` endpoints <br/>
 * @property {FilterOverValorantMatchesVideogameVersion[]} - Filter by the names of videogame versions, all versions using `filter[videogame_version]=all`, or by the latest version using `filter[videogame_version]=latest` <br/>Only for `valorant/*` and `/lol/*` endpoints. <br/>
 * @property {OpponentId[]}
 * @property {MatchWinnerType[]}
 */
export type FilterOverValorantMatches = z.infer<typeof filterOverValorantMatches>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverValorantMatchesResponse: any = z.lazy(() => {
  return z
    .object({
      ...
      opponent_id: z.array(filterOverValorantMatchesOpponentIdResponse).min(1).optional(),
      ...
      videogame_title: z.array(filterOverValorantMatchesVideogameTitleResponse).min(1).optional(),
      videogame_version: z.array(filterOverValorantMatchesVideogameVersionResponse).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverValorantMatchesRequest: any = z.lazy(() => {
  return z
    .object({
      ...
      opponentId: z.array(filterOverValorantMatchesOpponentIdRequest).nullish(),
      ...
      videogameTitle: z.array(filterOverValorantMatchesVideogameTitleRequest).nullish(),
      videogameVersion: z.array(filterOverValorantMatchesVideogameVersionRequest).nullish(),
