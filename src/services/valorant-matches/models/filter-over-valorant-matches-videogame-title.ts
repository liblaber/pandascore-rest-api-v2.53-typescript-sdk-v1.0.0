 ...
 */
export const filterOverValorantMatchesVideogameTitle = z.lazy(() => {
 ...
 */
export const filterOverValorantMatchesVideogameTitleResponse = z.lazy(() => {
  return z.union([z.number(), z.string()]);
});
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverValorantMatchesVideogameTitleRequest = z.lazy(() => {
  return z.union([z.number(), z.string()]);
});
