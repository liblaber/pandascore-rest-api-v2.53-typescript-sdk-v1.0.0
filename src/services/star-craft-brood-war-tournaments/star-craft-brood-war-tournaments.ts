...
export class StarCraftBroodWarTournamentsService extends BaseService {
  ...
  async getStarcraftBroodWarTournaments(
    ...
    const path = '/starcraft-brood-war/tournaments';
    const options: any = {
  ...
  async getStarcraftBroodWarTournamentsPast(
    ...
    const path = '/starcraft-brood-war/tournaments/past';
    const options: any = {
      responseSchema: z.array(shortTournamentResponse),
      requestSchema: z.any(),
      queryParams: {},
  ...
  async getStarcraftBroodWarTournamentsRunning(
    ...
    const path = '/starcraft-brood-war/tournaments/running';
    const options: any = {
      responseSchema: z.array(shortTournamentResponse),
      requestSchema: z.any(),
      queryParams: {},
  ...
  async getStarcraftBroodWarTournamentsUpcoming(
    ...
    const path = '/starcraft-brood-war/tournaments/upcoming';
    const options: any = {
      responseSchema: z.array(shortTournamentResponse),
      requestSchema: z.any(),
      queryParams: {},
