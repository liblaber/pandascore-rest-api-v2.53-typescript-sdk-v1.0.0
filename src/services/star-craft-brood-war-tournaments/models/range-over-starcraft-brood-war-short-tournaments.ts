 ...
 */
export const rangeOverStarcraftBroodWarShortTournaments: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {RangeOverStarcraftBroodWarShortTournaments} rangeOverStarcraftBroodWarShortTournaments
 * @property {string[]}
 * @property {boolean[]}
 * @property {string[]}
 * @property {boolean[]}
 ...
 */
export type RangeOverStarcraftBroodWarShortTournaments = z.infer<typeof rangeOverStarcraftBroodWarShortTournaments>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverStarcraftBroodWarShortTournamentsResponse: any = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverStarcraftBroodWarShortTournamentsRequest: any = z.lazy(() => {
  return z
    .object({
