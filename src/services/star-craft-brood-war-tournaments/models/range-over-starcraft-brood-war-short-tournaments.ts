 ...
 */
export const rangeOverStarcraftBroodWarShortTournaments = z.lazy(() => {
  return z.object({
    ...
    tier: z.array(z.string()).min(2).max(2).optional(),
 ...
 */
export const rangeOverStarcraftBroodWarShortTournamentsResponse = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverStarcraftBroodWarShortTournamentsRequest = z.lazy(() => {
  return z
    .object({
