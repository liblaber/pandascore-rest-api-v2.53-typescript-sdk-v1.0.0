 ...
 */
export const searchOverStarcraftBroodWarShortTournaments: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {SearchOverStarcraftBroodWarShortTournaments} searchOverStarcraftBroodWarShortTournaments
 * @property {string}
 * @property {string}
 * @property {string}
 ...
 */
export type SearchOverStarcraftBroodWarShortTournaments = z.infer<typeof searchOverStarcraftBroodWarShortTournaments>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverStarcraftBroodWarShortTournamentsResponse: any = z.lazy(() => {
  return z
    .object({
      name: z.string().optional(),
      prizepool: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverStarcraftBroodWarShortTournamentsRequest: any = z.lazy(() => {
  return z
    .object({
