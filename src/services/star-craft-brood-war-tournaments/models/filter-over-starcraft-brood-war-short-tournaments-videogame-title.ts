 ...
 */
export const filterOverStarcraftBroodWarShortTournamentsVideogameTitle = z.lazy(() => {
 ...
 */
export const filterOverStarcraftBroodWarShortTournamentsVideogameTitleResponse = z.lazy(() => {
  return z.union([z.number(), z.string()]);
});
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverStarcraftBroodWarShortTournamentsVideogameTitleRequest = z.lazy(() => {
  return z.union([z.number(), z.string()]);
});
