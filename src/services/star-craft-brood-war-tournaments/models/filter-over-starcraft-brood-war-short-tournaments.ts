...
import {
  ...
  filterOverStarcraftBroodWarShortTournamentsVideogameTitleRequest,
  filterOverStarcraftBroodWarShortTournamentsVideogameTitleResponse,
} from './filter-over-starcraft-brood-war-short-tournaments-videogame-title';
 ...
 */
export const filterOverStarcraftBroodWarShortTournaments: any = z.lazy(() => {
  return z.object({
    ...
    videogameTitle: z.array(filterOverStarcraftBroodWarShortTournamentsVideogameTitle).min(1).optional(),
...
/**
 *
 * @typedef  {FilterOverStarcraftBroodWarShortTournaments} filterOverStarcraftBroodWarShortTournaments
 * @property {string[]}
 ...
 * @property {FilterOverStarcraftBroodWarShortTournamentsVideogameTitle[]} - A videogame title id or slug. <br/>Only for `/csgo/*`, `/codmw/*`, `/fifa/*` and `/ow/*` endpoints <br/>
 * @property {OpponentId[]}
 * @property {OpponentType[]}
 */
export type FilterOverStarcraftBroodWarShortTournaments = z.infer<typeof filterOverStarcraftBroodWarShortTournaments>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverStarcraftBroodWarShortTournamentsResponse: any = z.lazy(() => {
  return z
    .object({
      ...
      slug: z.array(z.string()).min(1).optional(),
      tier: z.array(searchOverValorantShortTournamentsTier2).min(1).optional(),
      videogame_title: z.array(filterOverStarcraftBroodWarShortTournamentsVideogameTitleResponse).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverStarcraftBroodWarShortTournamentsRequest: any = z.lazy(() => {
  return z
    .object({
      ...
      videogameTitle: z.array(filterOverStarcraftBroodWarShortTournamentsVideogameTitleRequest).nullish(),
