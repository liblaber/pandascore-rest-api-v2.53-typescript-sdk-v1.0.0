 ...
 */
export const filterOverStarcraftBroodWarShortTournaments = z.lazy(() => {
  return z.object({
 ...
 */
export const filterOverStarcraftBroodWarShortTournamentsResponse = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverStarcraftBroodWarShortTournamentsRequest = z.lazy(() => {
  return z
    .object({
