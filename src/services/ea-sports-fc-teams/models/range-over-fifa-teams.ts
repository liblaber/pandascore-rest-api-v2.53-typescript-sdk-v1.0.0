 ...
 */
export const rangeOverFifaTeams: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {RangeOverFifaTeams} rangeOverFifaTeams
 * @property {string[]}
 * @property {number[]}
 * @property {string[]}
 * @property {string[]}
 ...
 * @property {string[]}
 */
export type RangeOverFifaTeams = z.infer<typeof rangeOverFifaTeams>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverFifaTeamsResponse: any = z.lazy(() => {
  return z
    .object({
      acronym: z.array(z.string()).min(2).max(2).optional(),
      id: z.array(z.number()).min(2).max(2).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverFifaTeamsRequest: any = z.lazy(() => {
  return z
    .object({
