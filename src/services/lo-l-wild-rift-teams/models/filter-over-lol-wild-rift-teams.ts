 ...
 */
export const filterOverLolWildRiftTeams: any = z.lazy(() => {
  return z.object({
 ...
 */
export const filterOverLolWildRiftTeamsResponse: any = z.lazy(() => {
  return z
    .object({
      acronym: z.array(z.string()).min(1).optional(),
      id: z.array(z.number()).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverLolWildRiftTeamsRequest: any = z.lazy(() => {
  return z
    .object({
