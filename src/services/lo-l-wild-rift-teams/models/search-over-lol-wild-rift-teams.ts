 ...
 */
export const searchOverLolWildRiftTeams = z.lazy(() => {
  return z.object({
 ...
 */
export const searchOverLolWildRiftTeamsResponse = z.lazy(() => {
  return z
    .object({
      acronym: z.string().optional(),
      location: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverLolWildRiftTeamsRequest = z.lazy(() => {
  return z
    .object({
