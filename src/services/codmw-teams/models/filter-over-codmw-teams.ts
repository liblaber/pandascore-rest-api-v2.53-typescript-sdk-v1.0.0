 ...
 */
export const filterOverCodmwTeams: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {FilterOverCodmwTeams} filterOverCodmwTeams
 * @property {string[]}
 * @property {number[]}
 * @property {string[]}
 * @property {string[]}
 ...
 */
export type FilterOverCodmwTeams = z.infer<typeof filterOverCodmwTeams>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverCodmwTeamsResponse: any = z.lazy(() => {
  return z
    .object({
      acronym: z.array(z.string()).min(1).optional(),
      id: z.array(z.number()).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverCodmwTeamsRequest: any = z.lazy(() => {
  return z
    .object({
