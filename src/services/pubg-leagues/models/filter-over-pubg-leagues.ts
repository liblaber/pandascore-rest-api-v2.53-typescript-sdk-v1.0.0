 ...
 */
export const filterOverPubgLeagues: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {FilterOverPubgLeagues} filterOverPubgLeagues
 * @property {number[]}
 * @property {string[]}
 * @property {string[]}
 * @property {string[]}
 * @property {string[]}
 */
export type FilterOverPubgLeagues = z.infer<typeof filterOverPubgLeagues>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverPubgLeaguesResponse: any = z.lazy(() => {
  return z
    .object({
      id: z.array(z.number()).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverPubgLeaguesRequest: any = z.lazy(() => {
  return z
    .object({
