 ...
 */
export const filterOverStarcraft2Leagues = z.lazy(() => {
  return z.object({
 ...
 */
export const filterOverStarcraft2LeaguesResponse = z.lazy(() => {
  return z
    .object({
      id: z.array(z.number()).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverStarcraft2LeaguesRequest = z.lazy(() => {
  return z
    .object({
