 ...
 */
export const filterOverCsgoTeams: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {FilterOverCsgoTeams} filterOverCsgoTeams
 * @property {string[]}
 * @property {number[]}
 * @property {string[]}
 * @property {string[]}
 ...
 */
export type FilterOverCsgoTeams = z.infer<typeof filterOverCsgoTeams>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverCsgoTeamsResponse: any = z.lazy(() => {
  return z
    .object({
      acronym: z.array(z.string()).min(1).optional(),
      id: z.array(z.number()).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverCsgoTeamsRequest: any = z.lazy(() => {
  return z
    .object({
