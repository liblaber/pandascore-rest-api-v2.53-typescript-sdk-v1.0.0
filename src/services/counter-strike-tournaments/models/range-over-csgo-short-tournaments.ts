 ...
 */
export const rangeOverCsgoShortTournaments = z.lazy(() => {
  return z.object({
 ...
 */
export const rangeOverCsgoShortTournamentsResponse = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverCsgoShortTournamentsRequest = z.lazy(() => {
  return z
    .object({
