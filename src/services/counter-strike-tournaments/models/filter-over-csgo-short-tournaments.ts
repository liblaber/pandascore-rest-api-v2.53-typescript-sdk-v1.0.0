 ...
 */
export const filterOverCsgoShortTournaments = z.lazy(() => {
  return z.object({
 ...
 */
export const filterOverCsgoShortTournamentsResponse = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverCsgoShortTournamentsRequest = z.lazy(() => {
  return z
    .object({
