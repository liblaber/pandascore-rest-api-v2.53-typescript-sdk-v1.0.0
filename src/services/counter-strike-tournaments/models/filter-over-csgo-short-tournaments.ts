...
import {
  ...
  filterOverCsgoShortTournamentsVideogameTitleRequest,
  filterOverCsgoShortTournamentsVideogameTitleResponse,
} from './filter-over-csgo-short-tournaments-videogame-title';
 ...
 */
export const filterOverCsgoShortTournaments: any = z.lazy(() => {
  return z.object({
    ...
    videogameTitle: z.array(filterOverCsgoShortTournamentsVideogameTitle).min(1).optional(),
...
/**
 *
 * @typedef  {FilterOverCsgoShortTournaments} filterOverCsgoShortTournaments
 * @property {string[]}
 ...
 * @property {FilterOverCsgoShortTournamentsVideogameTitle[]} - A videogame title id or slug. <br/>Only for `/csgo/*`, `/codmw/*`, `/fifa/*` and `/ow/*` endpoints <br/>
 * @property {OpponentId[]}
 * @property {OpponentType[]}
 */
export type FilterOverCsgoShortTournaments = z.infer<typeof filterOverCsgoShortTournaments>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverCsgoShortTournamentsResponse: any = z.lazy(() => {
  return z
    .object({
      ...
      slug: z.array(z.string()).min(1).optional(),
      tier: z.array(searchOverValorantShortTournamentsTier2).min(1).optional(),
      videogame_title: z.array(filterOverCsgoShortTournamentsVideogameTitleResponse).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverCsgoShortTournamentsRequest: any = z.lazy(() => {
  return z
    .object({
      ...
      videogameTitle: z.array(filterOverCsgoShortTournamentsVideogameTitleRequest).nullish(),
