 ...
 */
export const rangeOverLoLLeagues: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {RangeOverLoLLeagues} rangeOverLoLLeagues
 * @property {number[]}
 * @property {string[]}
 * @property {string[]}
 * @property {string[]}
 * @property {string[]}
 */
export type RangeOverLoLLeagues = z.infer<typeof rangeOverLoLLeagues>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverLoLLeaguesResponse: any = z.lazy(() => {
  return z
    .object({
      id: z.array(z.number()).min(2).max(2).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverLoLLeaguesRequest: any = z.lazy(() => {
  return z
    .object({
