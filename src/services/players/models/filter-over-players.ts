 ...
 */
export const filterOverPlayers: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {FilterOverPlayers} filterOverPlayers
 ...
 */
export type FilterOverPlayers = z.infer<typeof filterOverPlayers>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverPlayersResponse: any = z.lazy(() => {
  return z
    .object({
      active: z.boolean().optional(),
      birthday: z.array(z.string()).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverPlayersRequest: any = z.lazy(() => {
  return z
    .object({
