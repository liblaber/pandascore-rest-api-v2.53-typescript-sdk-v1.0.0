 ...
 */
export const searchOverPlayers: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {SearchOverPlayers} searchOverPlayers
 ...
 */
export type SearchOverPlayers = z.infer<typeof searchOverPlayers>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverPlayersResponse: any = z.lazy(() => {
  return z
    .object({
      birthday: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverPlayersRequest: any = z.lazy(() => {
  return z
    .object({
