 ...
 */
export const searchOverR6SiegeSeries: any = z.lazy(() => {
  return z.object({
 ...
 */
export const searchOverR6SiegeSeriesResponse: any = z.lazy(() => {
  return z
    .object({
      name: z.string().optional(),
      season: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverR6SiegeSeriesRequest: any = z.lazy(() => {
  return z
    .object({
