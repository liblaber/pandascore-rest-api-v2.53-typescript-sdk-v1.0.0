 ...
 */
export const rangeOverR6SiegeSeries: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {RangeOverR6SiegeSeries} rangeOverR6SiegeSeries
 * @property {string[]}
 * @property {string[]}
 * @property {number[]}
 * @property {number[]}
 ...
 * @property {number[]}
 */
export type RangeOverR6SiegeSeries = z.infer<typeof rangeOverR6SiegeSeries>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverR6SiegeSeriesResponse: any = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverR6SiegeSeriesRequest: any = z.lazy(() => {
  return z
    .object({
