...
import {
  ...
  filterOverR6SiegeSeriesVideogameTitleRequest,
  filterOverR6SiegeSeriesVideogameTitleResponse,
} from './filter-over-r6-siege-series-videogame-title';
 ...
 */
export const filterOverR6SiegeSeries: any = z.lazy(() => {
  return z.object({
    ...
    videogameTitle: z.array(filterOverR6SiegeSeriesVideogameTitle).min(1).optional(),
...
/**
 *
 * @typedef  {FilterOverR6SiegeSeries} filterOverR6SiegeSeries
 * @property {string[]}
 * @property {string[]}
 * @property {number[]}
 * @property {number[]}
 ...
 * @property {string[]}
 * @property {string[]}
 * @property {FilterOverR6SiegeSeriesVideogameTitle[]} - A videogame title id or slug. <br/>Only for `/csgo/*`, `/codmw/*`, `/fifa/*` and `/ow/*` endpoints <br/>
 * @property {OpponentId[]}
 * @property {OpponentType[]}
 * @property {number[]}
 */
export type FilterOverR6SiegeSeries = z.infer<typeof filterOverR6SiegeSeries>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverR6SiegeSeriesResponse: any = z.lazy(() => {
  return z
    .object({
      ...
      season: z.array(z.string()).min(1).optional(),
      slug: z.array(z.string()).min(1).optional(),
      videogame_title: z.array(filterOverR6SiegeSeriesVideogameTitleResponse).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverR6SiegeSeriesRequest: any = z.lazy(() => {
  return z
    .object({
      ...
      videogameTitle: z.array(filterOverR6SiegeSeriesVideogameTitleRequest).nullish(),
