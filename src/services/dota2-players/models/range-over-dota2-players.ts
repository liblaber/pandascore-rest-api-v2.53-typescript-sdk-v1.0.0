 ...
 */
export const rangeOverDota2Players: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {RangeOverDota2Players} rangeOverDota2Players
 * @property {string[]}
 * @property {string[]}
 * @property {number[]}
 * @property {string[]}
 ...
 * @property {string[]}
 */
export type RangeOverDota2Players = z.infer<typeof rangeOverDota2Players>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverDota2PlayersResponse: any = z.lazy(() => {
  return z
    .object({
      birthday: z.array(z.string()).min(2).max(2).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverDota2PlayersRequest: any = z.lazy(() => {
  return z
    .object({
