 ...
 */
export const filterOverDota2Players: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {FilterOverDota2Players} filterOverDota2Players
 ...
 */
export type FilterOverDota2Players = z.infer<typeof filterOverDota2Players>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverDota2PlayersResponse: any = z.lazy(() => {
  return z
    .object({
      active: z.boolean().optional(),
      birthday: z.array(z.string()).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverDota2PlayersRequest: any = z.lazy(() => {
  return z
    .object({
