 ...
 */
export const searchOverDota2Players: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {SearchOverDota2Players} searchOverDota2Players
 ...
 */
export type SearchOverDota2Players = z.infer<typeof searchOverDota2Players>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverDota2PlayersResponse: any = z.lazy(() => {
  return z
    .object({
      birthday: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverDota2PlayersRequest: any = z.lazy(() => {
  return z
    .object({
