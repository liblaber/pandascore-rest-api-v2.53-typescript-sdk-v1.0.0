 ...
 */
export const filterOverStarcraftBroodWarTeams = z.lazy(() => {
  return z.object({
 ...
 */
export const filterOverStarcraftBroodWarTeamsResponse = z.lazy(() => {
  return z
    .object({
      acronym: z.array(z.string()).min(1).optional(),
      id: z.array(z.number()).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverStarcraftBroodWarTeamsRequest = z.lazy(() => {
  return z
    .object({
