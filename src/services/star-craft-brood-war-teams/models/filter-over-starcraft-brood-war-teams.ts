 ...
 */
export const filterOverStarcraftBroodWarTeams = z.object({
 ...
 */
export const filterOverStarcraftBroodWarTeamsResponse = z
  .object({
    acronym: z.array(z.string()).min(1).optional(),
    id: z.array(z.number()).min(1).optional(),
    location: z.array(z.string()).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverStarcraftBroodWarTeamsRequest = z
  .object({
