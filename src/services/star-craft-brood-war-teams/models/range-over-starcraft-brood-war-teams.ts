 ...
 */
export const rangeOverStarcraftBroodWarTeams = z.object({
 ...
 */
export const rangeOverStarcraftBroodWarTeamsResponse = z
  .object({
    acronym: z.array(z.string()).min(2).max(2).optional(),
    id: z.array(z.number()).min(2).max(2).optional(),
    location: z.array(z.string()).min(2).max(2).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverStarcraftBroodWarTeamsRequest = z
  .object({
