 ...
 */
export const valorantFullRoundDefenderTeam = z.object({
 ...
 */
export const valorantFullRoundDefenderTeamResponse = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const valorantFullRoundDefenderTeamRequest = z
  .object({
