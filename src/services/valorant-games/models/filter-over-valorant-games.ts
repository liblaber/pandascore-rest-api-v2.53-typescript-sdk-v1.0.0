 ...
 */
export const filterOverValorantGames: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {FilterOverValorantGames} filterOverValorantGames
 * @property {string[]}
 ...
 * @property {GameStatus[]}
 */
export type FilterOverValorantGames = z.infer<typeof filterOverValorantGames>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverValorantGamesResponse: any = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverValorantGamesRequest: any = z.lazy(() => {
  return z
    .object({
