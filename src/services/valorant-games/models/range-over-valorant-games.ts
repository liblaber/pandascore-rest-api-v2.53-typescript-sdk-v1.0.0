 ...
 */
export const rangeOverValorantGames: any = z.lazy(() => {
  return z.object({
 ...
 */
export const rangeOverValorantGamesResponse: any = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverValorantGamesRequest: any = z.lazy(() => {
  return z
    .object({
