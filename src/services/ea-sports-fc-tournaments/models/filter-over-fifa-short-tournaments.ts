...
import {
  ...
  filterOverFifaShortTournamentsVideogameTitleRequest,
  filterOverFifaShortTournamentsVideogameTitleResponse,
} from './filter-over-fifa-short-tournaments-videogame-title';
 ...
 */
export const filterOverFifaShortTournaments: any = z.lazy(() => {
  return z.object({
    ...
    videogameTitle: z.array(filterOverFifaShortTournamentsVideogameTitle).min(1).optional(),
...
/**
 *
 * @typedef  {FilterOverFifaShortTournaments} filterOverFifaShortTournaments
 * @property {string[]}
 ...
 * @property {FilterOverFifaShortTournamentsVideogameTitle[]} - A videogame title id or slug. <br/>Only for `/csgo/*`, `/codmw/*`, `/fifa/*` and `/ow/*` endpoints <br/>
 * @property {OpponentId[]}
 * @property {OpponentType[]}
 */
export type FilterOverFifaShortTournaments = z.infer<typeof filterOverFifaShortTournaments>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverFifaShortTournamentsResponse: any = z.lazy(() => {
  return z
    .object({
      ...
      slug: z.array(z.string()).min(1).optional(),
      tier: z.array(searchOverValorantShortTournamentsTier2).min(1).optional(),
      videogame_title: z.array(filterOverFifaShortTournamentsVideogameTitleResponse).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverFifaShortTournamentsRequest: any = z.lazy(() => {
  return z
    .object({
      ...
      videogameTitle: z.array(filterOverFifaShortTournamentsVideogameTitleRequest).nullish(),
