 ...
 */
export const rangeOverFifaShortTournaments = z.lazy(() => {
  return z.object({
 ...
 */
export const rangeOverFifaShortTournamentsResponse = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverFifaShortTournamentsRequest = z.lazy(() => {
  return z
    .object({
