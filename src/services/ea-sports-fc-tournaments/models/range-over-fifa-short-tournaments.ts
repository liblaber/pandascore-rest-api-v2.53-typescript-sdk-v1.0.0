 ...
 */
export const rangeOverFifaShortTournaments: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {RangeOverFifaShortTournaments} rangeOverFifaShortTournaments
 * @property {string[]}
 * @property {boolean[]}
 * @property {string[]}
 * @property {boolean[]}
 ...
 */
export type RangeOverFifaShortTournaments = z.infer<typeof rangeOverFifaShortTournaments>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverFifaShortTournamentsResponse: any = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverFifaShortTournamentsRequest: any = z.lazy(() => {
  return z
    .object({
