 ...
 */
export const rangeOverLolWildRiftLeagues: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {RangeOverLolWildRiftLeagues} rangeOverLolWildRiftLeagues
 * @property {number[]}
 * @property {string[]}
 * @property {string[]}
 * @property {string[]}
 * @property {string[]}
 */
export type RangeOverLolWildRiftLeagues = z.infer<typeof rangeOverLolWildRiftLeagues>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverLolWildRiftLeaguesResponse: any = z.lazy(() => {
  return z
    .object({
      id: z.array(z.number()).min(2).max(2).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverLolWildRiftLeaguesRequest: any = z.lazy(() => {
  return z
    .object({
