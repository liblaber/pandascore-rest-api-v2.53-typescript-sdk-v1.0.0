 ...
 */
export const rangeOverLolWildRiftLeagues = z.lazy(() => {
  return z.object({
 ...
 */
export const rangeOverLolWildRiftLeaguesResponse = z.lazy(() => {
  return z
    .object({
      id: z.array(z.number()).min(2).max(2).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverLolWildRiftLeaguesRequest = z.lazy(() => {
  return z
    .object({
