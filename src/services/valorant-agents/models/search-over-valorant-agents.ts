 ...
 */
export const searchOverValorantAgents: any = z.lazy(() => {
  return z.object({
 ...
 */
export const searchOverValorantAgentsResponse: any = z.lazy(() => {
  return z
    .object({
      name: z.string().optional(),
    })
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverValorantAgentsRequest: any = z.lazy(() => {
