...
import {
  ...
  filterOverFifaMatchesOpponentIdRequest,
  filterOverFifaMatchesOpponentIdResponse,
} from './filter-over-fifa-matches-opponent-id';
...
import {
  ...
  filterOverFifaMatchesVideogameTitleRequest,
  filterOverFifaMatchesVideogameTitleResponse,
} from './filter-over-fifa-matches-videogame-title';
import {
  filterOverFifaMatchesVideogameVersion,
  filterOverFifaMatchesVideogameVersionRequest,
  filterOverFifaMatchesVideogameVersionResponse,
} from './filter-over-fifa-matches-videogame-version';
 ...
 */
export const filterOverFifaMatches: any = z.lazy(() => {
  return z.object({
    ...
    opponentId: z.array(filterOverFifaMatchesOpponentId).min(1).optional(),
    ...
    videogameTitle: z.array(filterOverFifaMatchesVideogameTitle).min(1).optional(),
    videogameVersion: z.array(filterOverFifaMatchesVideogameVersion).min(1).optional(),
...
/**
 *
 * @typedef  {FilterOverFifaMatches} filterOverFifaMatches
 * @property {string[]}
 ...
 * @property {boolean}
 * @property {number[]}
 * @property {FilterOverFifaMatchesOpponentId[]} - A Team or a Player (id or slug). You can use`filter[winner_type]=Team` or `filter[winner_type]=Player` to focus on teams or players.
 ...
 * @property {FilterOverFifaMatchesVideogameTitle[]} - A videogame title id or slug. <br/>Only for `/csgo/*`, `/codmw/*`, `/fifa/*` and `/ow/*` endpoints <br/>
 * @property {FilterOverFifaMatchesVideogameVersion[]} - Filter by the names of videogame versions, all versions using `filter[videogame_version]=all`, or by the latest version using `filter[videogame_version]=latest` <br/>Only for `valorant/*` and `/lol/*` endpoints. <br/>
 * @property {OpponentId[]}
 * @property {MatchWinnerType[]}
 */
export type FilterOverFifaMatches = z.infer<typeof filterOverFifaMatches>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverFifaMatchesResponse: any = z.lazy(() => {
  return z
    .object({
      ...
      opponent_id: z.array(filterOverFifaMatchesOpponentIdResponse).min(1).optional(),
      ...
      videogame_title: z.array(filterOverFifaMatchesVideogameTitleResponse).min(1).optional(),
      videogame_version: z.array(filterOverFifaMatchesVideogameVersionResponse).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverFifaMatchesRequest: any = z.lazy(() => {
  return z
    .object({
      ...
      opponentId: z.array(filterOverFifaMatchesOpponentIdRequest).nullish(),
      ...
      videogameTitle: z.array(filterOverFifaMatchesVideogameTitleRequest).nullish(),
      videogameVersion: z.array(filterOverFifaMatchesVideogameVersionRequest).nullish(),
