 ...
 */
export const searchOverFifaMatches: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {SearchOverFifaMatches} searchOverFifaMatches
 * @property {MatchType}
 * @property {string}
 * @property {string}
 ...
 */
export type SearchOverFifaMatches = z.infer<typeof searchOverFifaMatches>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverFifaMatchesResponse: any = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverFifaMatchesRequest: any = z.lazy(() => {
  return z
    .object({
