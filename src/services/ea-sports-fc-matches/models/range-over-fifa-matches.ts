 ...
 */
export const rangeOverFifaMatches: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {RangeOverFifaMatches} rangeOverFifaMatches
 * @property {string[]}
 * @property {boolean[]}
 * @property {boolean[]}
 * @property {string[]}
 ...
 */
export type RangeOverFifaMatches = z.infer<typeof rangeOverFifaMatches>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverFifaMatchesResponse: any = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverFifaMatchesRequest: any = z.lazy(() => {
  return z
    .object({
