 ...
 */
export const valorantStatsForPlayerBySerie: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {ValorantStatsForPlayerBySerie} valorantStatsForPlayerBySerie
 ...
 */
export type ValorantStatsForPlayerBySerie = z.infer<typeof valorantStatsForPlayerBySerie>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const valorantStatsForPlayerBySerieResponse: any = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const valorantStatsForPlayerBySerieRequest: any = z.lazy(() => {
  return z
    .object({
