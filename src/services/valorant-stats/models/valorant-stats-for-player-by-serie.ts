 ...
 */
export const valorantStatsForPlayerBySerie = z.object({
 ...
 */
export const valorantStatsForPlayerBySerieResponse = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const valorantStatsForPlayerBySerieRequest = z
  .object({
