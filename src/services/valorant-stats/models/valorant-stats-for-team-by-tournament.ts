 ...
 */
export const valorantStatsForTeamByTournament = z.object({
 ...
 */
export const valorantStatsForTeamByTournamentResponse = z
  .object({
    assists: z.number().gte(0),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const valorantStatsForTeamByTournamentRequest = z
  .object({
