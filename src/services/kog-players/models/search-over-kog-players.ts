 ...
 */
export const searchOverKogPlayers: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {SearchOverKogPlayers} searchOverKogPlayers
 ...
 */
export type SearchOverKogPlayers = z.infer<typeof searchOverKogPlayers>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverKogPlayersResponse: any = z.lazy(() => {
  return z
    .object({
      birthday: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverKogPlayersRequest: any = z.lazy(() => {
  return z
    .object({
