 ...
 */
export const filterOverKogPlayers: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {FilterOverKogPlayers} filterOverKogPlayers
 ...
 */
export type FilterOverKogPlayers = z.infer<typeof filterOverKogPlayers>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverKogPlayersResponse: any = z.lazy(() => {
  return z
    .object({
      active: z.boolean().optional(),
      birthday: z.array(z.string()).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverKogPlayersRequest: any = z.lazy(() => {
  return z
    .object({
