 ...
 */
export const rangeOverKogPlayers = z.object({
...
/**
 *
 * @typedef  {RangeOverKogPlayers} rangeOverKogPlayers
 * @property {string[]}
 * @property {string[]}
 * @property {number[]}
 * @property {string[]}
 ...
 * @property {string[]}
 */
export type RangeOverKogPlayers = z.infer<typeof rangeOverKogPlayers>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverKogPlayersResponse = z
  .object({
    birthday: z.array(z.string()).min(2).max(2).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverKogPlayersRequest = z
  .object({
