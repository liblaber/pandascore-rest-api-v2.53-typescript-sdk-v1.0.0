...
import {
  ...
  filterOverLoLSeriesVideogameTitleRequest,
  filterOverLoLSeriesVideogameTitleResponse,
} from './filter-over-lo-l-series-videogame-title';
 ...
 */
export const filterOverLoLSeries: any = z.lazy(() => {
  return z.object({
    ...
    videogameTitle: z.array(filterOverLoLSeriesVideogameTitle).min(1).optional(),
...
/**
 *
 * @typedef  {FilterOverLoLSeries} filterOverLoLSeries
 * @property {string[]}
 * @property {string[]}
 * @property {number[]}
 * @property {number[]}
 ...
 * @property {string[]}
 * @property {string[]}
 * @property {FilterOverLoLSeriesVideogameTitle[]} - A videogame title id or slug. <br/>Only for `/csgo/*`, `/codmw/*`, `/fifa/*` and `/ow/*` endpoints <br/>
 * @property {OpponentId[]}
 * @property {OpponentType[]}
 * @property {number[]}
 */
export type FilterOverLoLSeries = z.infer<typeof filterOverLoLSeries>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverLoLSeriesResponse: any = z.lazy(() => {
  return z
    .object({
      ...
      season: z.array(z.string()).min(1).optional(),
      slug: z.array(z.string()).min(1).optional(),
      videogame_title: z.array(filterOverLoLSeriesVideogameTitleResponse).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverLoLSeriesRequest: any = z.lazy(() => {
  return z
    .object({
      ...
      videogameTitle: z.array(filterOverLoLSeriesVideogameTitleRequest).nullish(),
