 ...
 */
export const rangeOverLoLSeries: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {RangeOverLoLSeries} rangeOverLoLSeries
 * @property {string[]}
 * @property {string[]}
 * @property {number[]}
 * @property {number[]}
 ...
 * @property {number[]}
 */
export type RangeOverLoLSeries = z.infer<typeof rangeOverLoLSeries>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverLoLSeriesResponse: any = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverLoLSeriesRequest: any = z.lazy(() => {
  return z
    .object({
