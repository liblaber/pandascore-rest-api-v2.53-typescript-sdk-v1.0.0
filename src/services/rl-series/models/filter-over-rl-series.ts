...
import {
  ...
  filterOverRlSeriesVideogameTitleRequest,
  filterOverRlSeriesVideogameTitleResponse,
} from './filter-over-rl-series-videogame-title';
 ...
 */
export const filterOverRlSeries: any = z.lazy(() => {
  return z.object({
    ...
    videogameTitle: z.array(filterOverRlSeriesVideogameTitle).min(1).optional(),
...
/**
 *
 * @typedef  {FilterOverRlSeries} filterOverRlSeries
 * @property {string[]}
 * @property {string[]}
 * @property {number[]}
 * @property {number[]}
 ...
 * @property {string[]}
 * @property {string[]}
 * @property {FilterOverRlSeriesVideogameTitle[]} - A videogame title id or slug. <br/>Only for `/csgo/*`, `/codmw/*`, `/fifa/*` and `/ow/*` endpoints <br/>
 * @property {OpponentId[]}
 * @property {OpponentType[]}
 * @property {number[]}
 */
export type FilterOverRlSeries = z.infer<typeof filterOverRlSeries>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverRlSeriesResponse: any = z.lazy(() => {
  return z
    .object({
      ...
      season: z.array(z.string()).min(1).optional(),
      slug: z.array(z.string()).min(1).optional(),
      videogame_title: z.array(filterOverRlSeriesVideogameTitleResponse).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverRlSeriesRequest: any = z.lazy(() => {
  return z
    .object({
      ...
      videogameTitle: z.array(filterOverRlSeriesVideogameTitleRequest).nullish(),
