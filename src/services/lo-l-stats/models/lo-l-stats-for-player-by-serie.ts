 ...
 */
export const loLStatsForPlayerBySerie: any = z.lazy(() => {
  return z.object({
    active: z.boolean(),
    age: z.number().gte(0).nullable(),
    birthday: z.string().nullable(),
    currentTeam: loLStatsForPlayerBySerieCurrentTeam.nullable(),
 ...
 */
export const loLStatsForPlayerBySerieResponse: any = z.lazy(() => {
  return z
    .object({
      active: z.boolean(),
      age: z.number().gte(0).nullable(),
      birthday: z.string().nullable(),
      current_team: loLStatsForPlayerBySerieCurrentTeamResponse.nullable(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const loLStatsForPlayerBySerieRequest: any = z.lazy(() => {
  return z
    .object({
