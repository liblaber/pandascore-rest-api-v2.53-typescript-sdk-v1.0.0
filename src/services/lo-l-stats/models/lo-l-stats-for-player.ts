...
import {
  loLTotalPlayerStat,
  loLTotalPlayerStatRequest,
  loLTotalPlayerStatResponse,
} from './lo-l-total-player-stat';

/**
 * The shape of the model inside the application code - what the users use
 */
export const loLStatsForPlayer = z.object({
  active: z.boolean(),
  age: z.number().gte(0),
  birthday: z.string(),
 ...
 */
export const loLStatsForPlayerResponse = z
  .object({
    active: z.boolean(),
    age: z.number().gte(0),
    birthday: z.string(),
    current_team: loLStatsForPlayerCurrentTeamResponse,
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const loLStatsForPlayerRequest = z
  .object({
