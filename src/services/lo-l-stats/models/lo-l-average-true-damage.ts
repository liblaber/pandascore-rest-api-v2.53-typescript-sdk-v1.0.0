 ...
 */
export const loLAverageTrueDamage: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {LoLAverageTrueDamage} loLAverageTrueDamage
 * @property {number}
 ...
 * @property {number}
 */
export type LoLAverageTrueDamage = z.infer<typeof loLAverageTrueDamage>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const loLAverageTrueDamageResponse: any = z.lazy(() => {
  return z
    .object({
      dealt: z.number().gte(0).nullable(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const loLAverageTrueDamageRequest: any = z.lazy(() => {
  return z
    .object({
