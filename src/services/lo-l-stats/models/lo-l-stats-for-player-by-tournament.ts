 ...
 */
export const loLStatsForPlayerByTournament = z.object({
  active: z.boolean(),
  age: z.number().gte(0),
  birthday: z.string(),
 ...
 */
export const loLStatsForPlayerByTournamentResponse = z
  .object({
    active: z.boolean(),
    age: z.number().gte(0),
    birthday: z.string(),
    current_team: loLStatsForPlayerByTournamentCurrentTeamResponse,
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const loLStatsForPlayerByTournamentRequest = z
  .object({
