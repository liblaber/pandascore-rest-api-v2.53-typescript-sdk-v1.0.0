...
import { baseLoLItem, baseLoLItemRequest, baseLoLItemResponse } from '../../common/base-lo-l-item';
...
import { loLMastery, loLMasteryRequest, loLMasteryResponse } from '../../common/lo-l-mastery';
import {
...
} from '../../common/lo-l-player-runes-reforged';
import { loLSpell, loLSpellRequest, loLSpellResponse } from '../../common/lo-l-spell';
import { baseTeam, baseTeamRequest, baseTeamResponse } from '../../common/base-team';
import { loLWards, loLWardsRequest, loLWardsResponse } from '../../common/lo-l-wards';
...
export const loLGamePlayerForStatsResponse: any = z.lazy(() => {
  return z
    .object({
      assists: z.number().gte(0).nullable(),
      champion: loLGamePlayerForStatsChampionResponse.nullable(),
