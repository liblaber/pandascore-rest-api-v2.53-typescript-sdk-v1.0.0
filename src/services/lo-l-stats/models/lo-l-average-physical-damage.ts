 ...
 */
export const loLAveragePhysicalDamage: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {LoLAveragePhysicalDamage} loLAveragePhysicalDamage
 * @property {number}
 ...
 * @property {number}
 */
export type LoLAveragePhysicalDamage = z.infer<typeof loLAveragePhysicalDamage>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const loLAveragePhysicalDamageResponse: any = z.lazy(() => {
  return z
    .object({
      dealt: z.number().gte(0).nullable(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const loLAveragePhysicalDamageRequest: any = z.lazy(() => {
  return z
    .object({
