 ...
 */
export const loLAverageMagicDamage: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {LoLAverageMagicDamage} loLAverageMagicDamage
 * @property {number}
 ...
 * @property {number}
 */
export type LoLAverageMagicDamage = z.infer<typeof loLAverageMagicDamage>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const loLAverageMagicDamageResponse: any = z.lazy(() => {
  return z
    .object({
      dealt: z.number().gte(0).nullable(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const loLAverageMagicDamageRequest: any = z.lazy(() => {
  return z
    .object({
