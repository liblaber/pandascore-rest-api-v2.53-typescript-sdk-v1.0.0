...
import {
  loLTeamLastGame,
  loLTeamLastGameRequest,
  loLTeamLastGameResponse,
} from '../../common/lo-l-team-last-game';
import {
  loLBannedChampion,
  loLBannedChampionRequest,
  loLBannedChampionResponse,
} from '../../common/lo-l-banned-champion';
import {
  loLPickedChampion,
  loLPickedChampionRequest,
  loLPickedChampionResponse,
} from '../../common/lo-l-picked-champion';
import { basePlayer, basePlayerRequest, basePlayerResponse } from '../../common/base-player';
import {
  loLTeamBySerieStat,
  loLTeamBySerieStatRequest,
  loLTeamBySerieStatResponse,
} from '../../common/lo-l-team-by-serie-stat';
import {
  loLTotalTeamStat,
  loLTotalTeamStatRequest,
  loLTotalTeamStatResponse,
} from './lo-l-total-team-stat';

/**
 * The shape of the model inside the application code - what the users use
 */
export const loLStatsForTeam = z.object({
  acronym: z.string(),
  id: z.number().gte(1),
  imageUrl: z.string(),
 ...
 */
export const loLStatsForTeamResponse = z
  .object({
    acronym: z.string(),
    id: z.number().gte(1),
    image_url: z.string(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const loLStatsForTeamRequest = z
  .object({
