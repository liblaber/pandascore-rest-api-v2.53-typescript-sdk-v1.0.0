 ...
 */
export const rangeOverCsgoLeagues: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {RangeOverCsgoLeagues} rangeOverCsgoLeagues
 * @property {number[]}
 * @property {string[]}
 * @property {string[]}
 * @property {string[]}
 * @property {string[]}
 */
export type RangeOverCsgoLeagues = z.infer<typeof rangeOverCsgoLeagues>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverCsgoLeaguesResponse: any = z.lazy(() => {
  return z
    .object({
      id: z.array(z.number()).min(2).max(2).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverCsgoLeaguesRequest: any = z.lazy(() => {
  return z
    .object({
