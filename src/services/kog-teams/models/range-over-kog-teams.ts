 ...
 */
export const rangeOverKogTeams: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {RangeOverKogTeams} rangeOverKogTeams
 * @property {string[]}
 * @property {number[]}
 * @property {string[]}
 * @property {string[]}
 ...
 * @property {string[]}
 */
export type RangeOverKogTeams = z.infer<typeof rangeOverKogTeams>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverKogTeamsResponse: any = z.lazy(() => {
  return z
    .object({
      acronym: z.array(z.string()).min(2).max(2).optional(),
      id: z.array(z.number()).min(2).max(2).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverKogTeamsRequest: any = z.lazy(() => {
  return z
    .object({
