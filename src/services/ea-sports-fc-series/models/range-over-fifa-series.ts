 ...
 */
export const rangeOverFifaSeries: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {RangeOverFifaSeries} rangeOverFifaSeries
 * @property {string[]}
 * @property {string[]}
 * @property {number[]}
 * @property {number[]}
 ...
 * @property {number[]}
 */
export type RangeOverFifaSeries = z.infer<typeof rangeOverFifaSeries>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverFifaSeriesResponse: any = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverFifaSeriesRequest: any = z.lazy(() => {
  return z
    .object({
