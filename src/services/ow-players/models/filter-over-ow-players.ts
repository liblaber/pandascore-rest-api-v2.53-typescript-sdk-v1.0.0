 ...
 */
export const filterOverOwPlayers: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {FilterOverOwPlayers} filterOverOwPlayers
 ...
 */
export type FilterOverOwPlayers = z.infer<typeof filterOverOwPlayers>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverOwPlayersResponse: any = z.lazy(() => {
  return z
    .object({
      active: z.boolean().optional(),
      birthday: z.array(z.string()).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverOwPlayersRequest: any = z.lazy(() => {
  return z
    .object({
