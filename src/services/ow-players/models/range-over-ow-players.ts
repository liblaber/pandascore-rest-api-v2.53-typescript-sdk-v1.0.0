 ...
 */
export const rangeOverOwPlayers: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {RangeOverOwPlayers} rangeOverOwPlayers
 * @property {string[]}
 * @property {string[]}
 * @property {number[]}
 * @property {string[]}
 ...
 * @property {string[]}
 */
export type RangeOverOwPlayers = z.infer<typeof rangeOverOwPlayers>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverOwPlayersResponse: any = z.lazy(() => {
  return z
    .object({
      birthday: z.array(z.string()).min(2).max(2).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverOwPlayersRequest: any = z.lazy(() => {
  return z
    .object({
