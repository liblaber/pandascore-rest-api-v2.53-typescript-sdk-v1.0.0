 ...
 */
export const searchOverOwPlayers: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {SearchOverOwPlayers} searchOverOwPlayers
 ...
 */
export type SearchOverOwPlayers = z.infer<typeof searchOverOwPlayers>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverOwPlayersResponse: any = z.lazy(() => {
  return z
    .object({
      birthday: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverOwPlayersRequest: any = z.lazy(() => {
  return z
    .object({
