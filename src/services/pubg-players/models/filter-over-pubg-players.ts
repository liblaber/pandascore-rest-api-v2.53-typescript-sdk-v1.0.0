 ...
 */
export const filterOverPubgPlayers: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {FilterOverPubgPlayers} filterOverPubgPlayers
 ...
 */
export type FilterOverPubgPlayers = z.infer<typeof filterOverPubgPlayers>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverPubgPlayersResponse: any = z.lazy(() => {
  return z
    .object({
      active: z.boolean().optional(),
      birthday: z.array(z.string()).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverPubgPlayersRequest: any = z.lazy(() => {
  return z
    .object({
