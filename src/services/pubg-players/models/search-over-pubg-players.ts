 ...
 */
export const searchOverPubgPlayers: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {SearchOverPubgPlayers} searchOverPubgPlayers
 ...
 */
export type SearchOverPubgPlayers = z.infer<typeof searchOverPubgPlayers>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverPubgPlayersResponse: any = z.lazy(() => {
  return z
    .object({
      birthday: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverPubgPlayersRequest: any = z.lazy(() => {
  return z
    .object({
