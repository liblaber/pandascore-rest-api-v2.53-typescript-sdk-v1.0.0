 ...
 */
export const rangeOverCodmwLeagues: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {RangeOverCodmwLeagues} rangeOverCodmwLeagues
 * @property {number[]}
 * @property {string[]}
 * @property {string[]}
 * @property {string[]}
 * @property {string[]}
 */
export type RangeOverCodmwLeagues = z.infer<typeof rangeOverCodmwLeagues>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverCodmwLeaguesResponse: any = z.lazy(() => {
  return z
    .object({
      id: z.array(z.number()).min(2).max(2).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverCodmwLeaguesRequest: any = z.lazy(() => {
  return z
    .object({
