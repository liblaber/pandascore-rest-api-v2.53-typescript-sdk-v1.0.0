 ...
 */
export const filterOverCodmwLeagues: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {FilterOverCodmwLeagues} filterOverCodmwLeagues
 * @property {number[]}
 * @property {string[]}
 * @property {string[]}
 * @property {string[]}
 * @property {string[]}
 */
export type FilterOverCodmwLeagues = z.infer<typeof filterOverCodmwLeagues>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverCodmwLeaguesResponse: any = z.lazy(() => {
  return z
    .object({
      id: z.array(z.number()).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverCodmwLeaguesRequest: any = z.lazy(() => {
  return z
    .object({
