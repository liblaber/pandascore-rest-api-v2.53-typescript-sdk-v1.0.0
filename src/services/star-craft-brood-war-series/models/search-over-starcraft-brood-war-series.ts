 ...
 */
export const searchOverStarcraftBroodWarSeries = z.lazy(() => {
  return z.object({
 ...
 */
export const searchOverStarcraftBroodWarSeriesResponse = z.lazy(() => {
  return z
    .object({
      name: z.string().optional(),
      season: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverStarcraftBroodWarSeriesRequest = z.lazy(() => {
  return z
    .object({
