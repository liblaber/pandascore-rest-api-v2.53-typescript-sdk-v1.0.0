 ...
 */
export const filterOverStarcraftBroodWarSeries = z.lazy(() => {
  return z.object({
 ...
 */
export const filterOverStarcraftBroodWarSeriesResponse = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverStarcraftBroodWarSeriesRequest = z.lazy(() => {
  return z
    .object({
