...
import {
  ...
  filterOverStarcraftBroodWarSeriesVideogameTitleRequest,
  filterOverStarcraftBroodWarSeriesVideogameTitleResponse,
} from './filter-over-starcraft-brood-war-series-videogame-title';
 ...
 */
export const filterOverStarcraftBroodWarSeries: any = z.lazy(() => {
  return z.object({
    ...
    videogameTitle: z.array(filterOverStarcraftBroodWarSeriesVideogameTitle).min(1).optional(),
...
/**
 *
 * @typedef  {FilterOverStarcraftBroodWarSeries} filterOverStarcraftBroodWarSeries
 * @property {string[]}
 * @property {string[]}
 * @property {number[]}
 * @property {number[]}
 ...
 * @property {string[]}
 * @property {string[]}
 * @property {FilterOverStarcraftBroodWarSeriesVideogameTitle[]} - A videogame title id or slug. <br/>Only for `/csgo/*`, `/codmw/*`, `/fifa/*` and `/ow/*` endpoints <br/>
 * @property {OpponentId[]}
 * @property {OpponentType[]}
 * @property {number[]}
 */
export type FilterOverStarcraftBroodWarSeries = z.infer<typeof filterOverStarcraftBroodWarSeries>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverStarcraftBroodWarSeriesResponse: any = z.lazy(() => {
  return z
    .object({
      ...
      season: z.array(z.string()).min(1).optional(),
      slug: z.array(z.string()).min(1).optional(),
      videogame_title: z.array(filterOverStarcraftBroodWarSeriesVideogameTitleResponse).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverStarcraftBroodWarSeriesRequest: any = z.lazy(() => {
  return z
    .object({
      ...
      videogameTitle: z.array(filterOverStarcraftBroodWarSeriesVideogameTitleRequest).nullish(),
