 ...
 */
export const rangeOverStarcraftBroodWarSeries: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {RangeOverStarcraftBroodWarSeries} rangeOverStarcraftBroodWarSeries
 * @property {string[]}
 * @property {string[]}
 * @property {number[]}
 * @property {number[]}
 ...
 * @property {number[]}
 */
export type RangeOverStarcraftBroodWarSeries = z.infer<typeof rangeOverStarcraftBroodWarSeries>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverStarcraftBroodWarSeriesResponse: any = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverStarcraftBroodWarSeriesRequest: any = z.lazy(() => {
  return z
    .object({
