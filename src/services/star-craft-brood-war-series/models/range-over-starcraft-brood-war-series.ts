 ...
 */
export const rangeOverStarcraftBroodWarSeries = z.lazy(() => {
  return z.object({
 ...
 */
export const rangeOverStarcraftBroodWarSeriesResponse = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverStarcraftBroodWarSeriesRequest = z.lazy(() => {
  return z
    .object({
