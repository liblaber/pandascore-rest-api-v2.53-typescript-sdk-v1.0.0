 ...
 */
export const rangeOverPubgShortTournaments = z.lazy(() => {
  return z.object({
 ...
 */
export const rangeOverPubgShortTournamentsResponse = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverPubgShortTournamentsRequest = z.lazy(() => {
  return z
    .object({
