...
import {
  ...
  filterOverPubgShortTournamentsVideogameTitleRequest,
  filterOverPubgShortTournamentsVideogameTitleResponse,
} from './filter-over-pubg-short-tournaments-videogame-title';
 ...
 */
export const filterOverPubgShortTournaments: any = z.lazy(() => {
  return z.object({
    ...
    videogameTitle: z.array(filterOverPubgShortTournamentsVideogameTitle).min(1).optional(),
...
/**
 *
 * @typedef  {FilterOverPubgShortTournaments} filterOverPubgShortTournaments
 * @property {string[]}
 ...
 * @property {FilterOverPubgShortTournamentsVideogameTitle[]} - A videogame title id or slug. <br/>Only for `/csgo/*`, `/codmw/*`, `/fifa/*` and `/ow/*` endpoints <br/>
 * @property {OpponentId[]}
 * @property {OpponentType[]}
 */
export type FilterOverPubgShortTournaments = z.infer<typeof filterOverPubgShortTournaments>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverPubgShortTournamentsResponse: any = z.lazy(() => {
  return z
    .object({
      ...
      slug: z.array(z.string()).min(1).optional(),
      tier: z.array(searchOverValorantShortTournamentsTier2).min(1).optional(),
      videogame_title: z.array(filterOverPubgShortTournamentsVideogameTitleResponse).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverPubgShortTournamentsRequest: any = z.lazy(() => {
  return z
    .object({
      ...
      videogameTitle: z.array(filterOverPubgShortTournamentsVideogameTitleRequest).nullish(),
