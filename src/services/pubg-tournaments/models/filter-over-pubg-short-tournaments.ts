 ...
 */
export const filterOverPubgShortTournaments = z.lazy(() => {
  return z.object({
 ...
 */
export const filterOverPubgShortTournamentsResponse = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverPubgShortTournamentsRequest = z.lazy(() => {
  return z
    .object({
