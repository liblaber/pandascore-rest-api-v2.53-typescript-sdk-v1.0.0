 ...
 */
export const searchOverPubgShortTournaments: any = z.lazy(() => {
  return z.object({
 ...
 */
export const searchOverPubgShortTournamentsResponse: any = z.lazy(() => {
  return z
    .object({
      name: z.string().optional(),
      prizepool: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverPubgShortTournamentsRequest: any = z.lazy(() => {
  return z
    .object({
