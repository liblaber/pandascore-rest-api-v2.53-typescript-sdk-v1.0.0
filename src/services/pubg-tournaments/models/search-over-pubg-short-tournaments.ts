 ...
 */
export const searchOverPubgShortTournaments = z.lazy(() => {
  return z.object({
 ...
 */
export const searchOverPubgShortTournamentsResponse = z.lazy(() => {
  return z
    .object({
      name: z.string().optional(),
      prizepool: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverPubgShortTournamentsRequest = z.lazy(() => {
  return z
    .object({
