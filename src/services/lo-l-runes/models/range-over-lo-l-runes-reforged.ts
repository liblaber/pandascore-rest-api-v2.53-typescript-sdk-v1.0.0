 ...
 */
export const rangeOverLoLRunesReforged = z.lazy(() => {
  return z.object({
 ...
 */
export const rangeOverLoLRunesReforgedResponse = z.lazy(() => {
  return z
    .object({
      id: z.array(z.number()).min(2).max(2).optional(),
      name: z.array(z.string()).min(2).max(2).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverLoLRunesReforgedRequest = z.lazy(() => {
