 ...
 */
export const searchOverLoLRunesReforged = z.lazy(() => {
  return z.object({
 ...
 */
export const searchOverLoLRunesReforgedResponse = z.lazy(() => {
  return z
    .object({
      name: z.string().optional(),
    })
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverLoLRunesReforgedRequest = z.lazy(() => {
