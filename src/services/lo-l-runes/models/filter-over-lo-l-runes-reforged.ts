 ...
 */
export const filterOverLoLRunesReforged = z.lazy(() => {
  return z.object({
 ...
 */
export const filterOverLoLRunesReforgedResponse = z.lazy(() => {
  return z
    .object({
      id: z.array(z.number()).min(1).optional(),
      name: z.array(z.string()).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverLoLRunesReforgedRequest = z.lazy(() => {
