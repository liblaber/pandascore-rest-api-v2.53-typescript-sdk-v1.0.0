 ...
 */
export const rangeOverStarcraftBroodWarLeagues = z.object({
 ...
 */
export const rangeOverStarcraftBroodWarLeaguesResponse = z
  .object({
    id: z.array(z.number()).min(2).max(2).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverStarcraftBroodWarLeaguesRequest = z
  .object({
