 ...
 */
export const searchOverValorantPlayers: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {SearchOverValorantPlayers} searchOverValorantPlayers
 ...
 */
export type SearchOverValorantPlayers = z.infer<typeof searchOverValorantPlayers>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverValorantPlayersResponse: any = z.lazy(() => {
  return z
    .object({
      birthday: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverValorantPlayersRequest: any = z.lazy(() => {
  return z
    .object({
