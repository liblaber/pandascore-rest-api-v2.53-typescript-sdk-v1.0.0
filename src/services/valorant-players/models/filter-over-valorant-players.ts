 ...
 */
export const filterOverValorantPlayers: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {FilterOverValorantPlayers} filterOverValorantPlayers
 ...
 */
export type FilterOverValorantPlayers = z.infer<typeof filterOverValorantPlayers>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverValorantPlayersResponse: any = z.lazy(() => {
  return z
    .object({
      active: z.boolean().optional(),
      birthday: z.array(z.string()).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverValorantPlayersRequest: any = z.lazy(() => {
  return z
    .object({
