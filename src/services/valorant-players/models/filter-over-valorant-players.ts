 ...
 */
export const filterOverValorantPlayers = z.lazy(() => {
  return z.object({
 ...
 */
export const filterOverValorantPlayersResponse = z.lazy(() => {
  return z
    .object({
      active: z.boolean().optional(),
      birthday: z.array(z.string()).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverValorantPlayersRequest = z.lazy(() => {
  return z
    .object({
