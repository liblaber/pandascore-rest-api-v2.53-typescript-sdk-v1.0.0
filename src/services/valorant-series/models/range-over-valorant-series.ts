 ...
 */
export const rangeOverValorantSeries: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {RangeOverValorantSeries} rangeOverValorantSeries
 * @property {string[]}
 * @property {string[]}
 * @property {number[]}
 * @property {number[]}
 ...
 * @property {number[]}
 */
export type RangeOverValorantSeries = z.infer<typeof rangeOverValorantSeries>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverValorantSeriesResponse: any = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverValorantSeriesRequest: any = z.lazy(() => {
  return z
    .object({
