 ...
 */
export const matchOpponentBasePlayer: any = z.lazy(() => {
  return z.object({
    active: z.boolean(),
...
/**
 *
 * @typedef  {MatchOpponentBasePlayer} matchOpponentBasePlayer
 ...
 */
export type MatchOpponentBasePlayer = z.infer<typeof matchOpponentBasePlayer>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const matchOpponentBasePlayerResponse: any = z.lazy(() => {
  return z
    .object({
      active: z.boolean(),
      age: z.number().gte(0).nullable(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const matchOpponentBasePlayerRequest: any = z.lazy(() => {
  return z
    .object({
