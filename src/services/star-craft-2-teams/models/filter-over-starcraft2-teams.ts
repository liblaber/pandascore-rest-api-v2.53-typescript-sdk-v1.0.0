 ...
 */
export const filterOverStarcraft2Teams: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {FilterOverStarcraft2Teams} filterOverStarcraft2Teams
 * @property {string[]}
 * @property {number[]}
 * @property {string[]}
 * @property {string[]}
 ...
 */
export type FilterOverStarcraft2Teams = z.infer<typeof filterOverStarcraft2Teams>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverStarcraft2TeamsResponse: any = z.lazy(() => {
  return z
    .object({
      acronym: z.array(z.string()).min(1).optional(),
      id: z.array(z.number()).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverStarcraft2TeamsRequest: any = z.lazy(() => {
  return z
    .object({
