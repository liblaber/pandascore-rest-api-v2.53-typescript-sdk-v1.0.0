 ...
 */
export const filterOverStarcraft2Teams = z.lazy(() => {
  return z.object({
 ...
 */
export const filterOverStarcraft2TeamsResponse = z.lazy(() => {
  return z
    .object({
      acronym: z.array(z.string()).min(1).optional(),
      id: z.array(z.number()).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverStarcraft2TeamsRequest = z.lazy(() => {
  return z
    .object({
