 ...
 */
export const rangeOverCodmwMatches: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {RangeOverCodmwMatches} rangeOverCodmwMatches
 * @property {string[]}
 * @property {boolean[]}
 * @property {boolean[]}
 * @property {string[]}
 ...
 */
export type RangeOverCodmwMatches = z.infer<typeof rangeOverCodmwMatches>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverCodmwMatchesResponse: any = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverCodmwMatchesRequest: any = z.lazy(() => {
  return z
    .object({
