...
import {
  ...
  filterOverCodmwMatchesOpponentIdRequest,
  filterOverCodmwMatchesOpponentIdResponse,
} from './filter-over-codmw-matches-opponent-id';
...
import {
  ...
  filterOverCodmwMatchesVideogameTitleRequest,
  filterOverCodmwMatchesVideogameTitleResponse,
} from './filter-over-codmw-matches-videogame-title';
import {
  filterOverCodmwMatchesVideogameVersion,
  filterOverCodmwMatchesVideogameVersionRequest,
  filterOverCodmwMatchesVideogameVersionResponse,
} from './filter-over-codmw-matches-videogame-version';
 ...
 */
export const filterOverCodmwMatches: any = z.lazy(() => {
  return z.object({
    ...
    opponentId: z.array(filterOverCodmwMatchesOpponentId).min(1).optional(),
    ...
    videogameTitle: z.array(filterOverCodmwMatchesVideogameTitle).min(1).optional(),
    videogameVersion: z.array(filterOverCodmwMatchesVideogameVersion).min(1).optional(),
...
/**
 *
 * @typedef  {FilterOverCodmwMatches} filterOverCodmwMatches
 * @property {string[]}
 ...
 * @property {boolean}
 * @property {number[]}
 * @property {FilterOverCodmwMatchesOpponentId[]} - A Team or a Player (id or slug). You can use`filter[winner_type]=Team` or `filter[winner_type]=Player` to focus on teams or players.
 ...
 * @property {FilterOverCodmwMatchesVideogameTitle[]} - A videogame title id or slug. <br/>Only for `/csgo/*`, `/codmw/*`, `/fifa/*` and `/ow/*` endpoints <br/>
 * @property {FilterOverCodmwMatchesVideogameVersion[]} - Filter by the names of videogame versions, all versions using `filter[videogame_version]=all`, or by the latest version using `filter[videogame_version]=latest` <br/>Only for `valorant/*` and `/lol/*` endpoints. <br/>
 * @property {OpponentId[]}
 * @property {MatchWinnerType[]}
 */
export type FilterOverCodmwMatches = z.infer<typeof filterOverCodmwMatches>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverCodmwMatchesResponse: any = z.lazy(() => {
  return z
    .object({
      ...
      opponent_id: z.array(filterOverCodmwMatchesOpponentIdResponse).min(1).optional(),
      ...
      videogame_title: z.array(filterOverCodmwMatchesVideogameTitleResponse).min(1).optional(),
      videogame_version: z.array(filterOverCodmwMatchesVideogameVersionResponse).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverCodmwMatchesRequest: any = z.lazy(() => {
  return z
    .object({
      ...
      opponentId: z.array(filterOverCodmwMatchesOpponentIdRequest).nullish(),
      ...
      videogameTitle: z.array(filterOverCodmwMatchesVideogameTitleRequest).nullish(),
      videogameVersion: z.array(filterOverCodmwMatchesVideogameVersionRequest).nullish(),
