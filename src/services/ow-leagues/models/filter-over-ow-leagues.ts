 ...
 */
export const filterOverOwLeagues: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {FilterOverOwLeagues} filterOverOwLeagues
 * @property {number[]}
 * @property {string[]}
 * @property {string[]}
 * @property {string[]}
 * @property {string[]}
 */
export type FilterOverOwLeagues = z.infer<typeof filterOverOwLeagues>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverOwLeaguesResponse: any = z.lazy(() => {
  return z
    .object({
      id: z.array(z.number()).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverOwLeaguesRequest: any = z.lazy(() => {
  return z
    .object({
