 ...
 */
export const rangeOverOwLeagues: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {RangeOverOwLeagues} rangeOverOwLeagues
 * @property {number[]}
 * @property {string[]}
 * @property {string[]}
 * @property {string[]}
 * @property {string[]}
 */
export type RangeOverOwLeagues = z.infer<typeof rangeOverOwLeagues>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverOwLeaguesResponse: any = z.lazy(() => {
  return z
    .object({
      id: z.array(z.number()).min(2).max(2).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverOwLeaguesRequest: any = z.lazy(() => {
  return z
    .object({
