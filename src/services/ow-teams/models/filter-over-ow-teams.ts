 ...
 */
export const filterOverOwTeams: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {FilterOverOwTeams} filterOverOwTeams
 * @property {string[]}
 * @property {number[]}
 * @property {string[]}
 * @property {string[]}
 ...
 */
export type FilterOverOwTeams = z.infer<typeof filterOverOwTeams>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverOwTeamsResponse: any = z.lazy(() => {
  return z
    .object({
      acronym: z.array(z.string()).min(1).optional(),
      id: z.array(z.number()).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverOwTeamsRequest: any = z.lazy(() => {
  return z
    .object({
