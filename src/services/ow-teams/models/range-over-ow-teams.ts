 ...
 */
export const rangeOverOwTeams: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {RangeOverOwTeams} rangeOverOwTeams
 * @property {string[]}
 * @property {number[]}
 * @property {string[]}
 * @property {string[]}
 ...
 * @property {string[]}
 */
export type RangeOverOwTeams = z.infer<typeof rangeOverOwTeams>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverOwTeamsResponse: any = z.lazy(() => {
  return z
    .object({
      acronym: z.array(z.string()).min(2).max(2).optional(),
      id: z.array(z.number()).min(2).max(2).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverOwTeamsRequest: any = z.lazy(() => {
  return z
    .object({
