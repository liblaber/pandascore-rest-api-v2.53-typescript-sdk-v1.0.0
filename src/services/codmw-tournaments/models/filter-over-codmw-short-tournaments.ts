...
import {
  ...
  filterOverCodmwShortTournamentsVideogameTitleRequest,
  filterOverCodmwShortTournamentsVideogameTitleResponse,
} from './filter-over-codmw-short-tournaments-videogame-title';
 ...
 */
export const filterOverCodmwShortTournaments: any = z.lazy(() => {
  return z.object({
    ...
    videogameTitle: z.array(filterOverCodmwShortTournamentsVideogameTitle).min(1).optional(),
...
/**
 *
 * @typedef  {FilterOverCodmwShortTournaments} filterOverCodmwShortTournaments
 * @property {string[]}
 ...
 * @property {FilterOverCodmwShortTournamentsVideogameTitle[]} - A videogame title id or slug. <br/>Only for `/csgo/*`, `/codmw/*`, `/fifa/*` and `/ow/*` endpoints <br/>
 * @property {OpponentId[]}
 * @property {OpponentType[]}
 */
export type FilterOverCodmwShortTournaments = z.infer<typeof filterOverCodmwShortTournaments>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverCodmwShortTournamentsResponse: any = z.lazy(() => {
  return z
    .object({
      ...
      slug: z.array(z.string()).min(1).optional(),
      tier: z.array(searchOverValorantShortTournamentsTier2).min(1).optional(),
      videogame_title: z.array(filterOverCodmwShortTournamentsVideogameTitleResponse).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverCodmwShortTournamentsRequest: any = z.lazy(() => {
  return z
    .object({
      ...
      videogameTitle: z.array(filterOverCodmwShortTournamentsVideogameTitleRequest).nullish(),
