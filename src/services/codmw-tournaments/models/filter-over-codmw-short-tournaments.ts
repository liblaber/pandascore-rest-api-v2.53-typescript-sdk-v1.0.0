 ...
 */
export const filterOverCodmwShortTournaments = z.lazy(() => {
  return z.object({
 ...
 */
export const filterOverCodmwShortTournamentsResponse = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverCodmwShortTournamentsRequest = z.lazy(() => {
  return z
    .object({
