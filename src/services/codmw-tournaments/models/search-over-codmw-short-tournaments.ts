 ...
 */
export const searchOverCodmwShortTournaments: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {SearchOverCodmwShortTournaments} searchOverCodmwShortTournaments
 * @property {string}
 * @property {string}
 * @property {string}
 ...
 */
export type SearchOverCodmwShortTournaments = z.infer<typeof searchOverCodmwShortTournaments>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverCodmwShortTournamentsResponse: any = z.lazy(() => {
  return z
    .object({
      name: z.string().optional(),
      prizepool: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverCodmwShortTournamentsRequest: any = z.lazy(() => {
  return z
    .object({
