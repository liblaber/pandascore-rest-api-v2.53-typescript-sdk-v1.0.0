 ...
 */
export const rangeOverCodmwShortTournaments = z.lazy(() => {
  return z.object({
 ...
 */
export const rangeOverCodmwShortTournamentsResponse = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverCodmwShortTournamentsRequest = z.lazy(() => {
  return z
    .object({
