 ...
 */
export const filterOverCsgoPlayers: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {FilterOverCsgoPlayers} filterOverCsgoPlayers
 ...
 */
export type FilterOverCsgoPlayers = z.infer<typeof filterOverCsgoPlayers>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverCsgoPlayersResponse: any = z.lazy(() => {
  return z
    .object({
      active: z.boolean().optional(),
      birthday: z.array(z.string()).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverCsgoPlayersRequest: any = z.lazy(() => {
  return z
    .object({
