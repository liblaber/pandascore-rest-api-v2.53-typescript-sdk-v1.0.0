 ...
 */
export const rangeOverCsgoPlayers: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {RangeOverCsgoPlayers} rangeOverCsgoPlayers
 * @property {string[]}
 * @property {string[]}
 * @property {number[]}
 * @property {string[]}
 ...
 * @property {string[]}
 */
export type RangeOverCsgoPlayers = z.infer<typeof rangeOverCsgoPlayers>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverCsgoPlayersResponse: any = z.lazy(() => {
  return z
    .object({
      birthday: z.array(z.string()).min(2).max(2).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverCsgoPlayersRequest: any = z.lazy(() => {
  return z
    .object({
