 ...
 */
export const searchOverCsgoPlayers: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {SearchOverCsgoPlayers} searchOverCsgoPlayers
 ...
 */
export type SearchOverCsgoPlayers = z.infer<typeof searchOverCsgoPlayers>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverCsgoPlayersResponse: any = z.lazy(() => {
  return z
    .object({
      birthday: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverCsgoPlayersRequest: any = z.lazy(() => {
  return z
    .object({
