 ...
 */
export const searchOverValorantShortTournaments = z.lazy(() => {
  return z.object({
 ...
 */
export const searchOverValorantShortTournamentsResponse = z.lazy(() => {
  return z
    .object({
      name: z.string().optional(),
      prizepool: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverValorantShortTournamentsRequest = z.lazy(() => {
  return z
    .object({
