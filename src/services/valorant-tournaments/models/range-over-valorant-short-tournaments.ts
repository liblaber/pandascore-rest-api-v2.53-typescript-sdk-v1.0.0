 ...
 */
export const rangeOverValorantShortTournaments = z.lazy(() => {
  return z.object({
 ...
 */
export const rangeOverValorantShortTournamentsResponse = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverValorantShortTournamentsRequest = z.lazy(() => {
  return z
    .object({
