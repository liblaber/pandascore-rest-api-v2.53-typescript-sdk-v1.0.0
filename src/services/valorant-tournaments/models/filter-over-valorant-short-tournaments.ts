 ...
 */
export const filterOverValorantShortTournaments = z.lazy(() => {
  return z.object({
 ...
 */
export const filterOverValorantShortTournamentsResponse = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverValorantShortTournamentsRequest = z.lazy(() => {
  return z
    .object({
