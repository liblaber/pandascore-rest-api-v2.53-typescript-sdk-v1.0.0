...
import {
  ...
  filterOverValorantShortTournamentsVideogameTitleRequest,
  filterOverValorantShortTournamentsVideogameTitleResponse,
} from './filter-over-valorant-short-tournaments-videogame-title';
 ...
 */
export const filterOverValorantShortTournaments: any = z.lazy(() => {
  return z.object({
    ...
    videogameTitle: z.array(filterOverValorantShortTournamentsVideogameTitle).min(1).optional(),
...
/**
 *
 * @typedef  {FilterOverValorantShortTournaments} filterOverValorantShortTournaments
 * @property {string[]}
 ...
 * @property {FilterOverValorantShortTournamentsVideogameTitle[]} - A videogame title id or slug. <br/>Only for `/csgo/*`, `/codmw/*`, `/fifa/*` and `/ow/*` endpoints <br/>
 * @property {OpponentId[]}
 * @property {OpponentType[]}
 */
export type FilterOverValorantShortTournaments = z.infer<typeof filterOverValorantShortTournaments>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverValorantShortTournamentsResponse: any = z.lazy(() => {
  return z
    .object({
      ...
      slug: z.array(z.string()).min(1).optional(),
      tier: z.array(searchOverValorantShortTournamentsTier2).min(1).optional(),
      videogame_title: z.array(filterOverValorantShortTournamentsVideogameTitleResponse).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverValorantShortTournamentsRequest: any = z.lazy(() => {
  return z
    .object({
      ...
      videogameTitle: z.array(filterOverValorantShortTournamentsVideogameTitleRequest).nullish(),
