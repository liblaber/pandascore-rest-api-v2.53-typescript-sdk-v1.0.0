 ...
 */
export const filterOverOwGames: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {FilterOverOwGames} filterOverOwGames
 * @property {string[]}
 ...
 */
export type FilterOverOwGames = z.infer<typeof filterOverOwGames>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverOwGamesResponse: any = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverOwGamesRequest: any = z.lazy(() => {
  return z
    .object({
