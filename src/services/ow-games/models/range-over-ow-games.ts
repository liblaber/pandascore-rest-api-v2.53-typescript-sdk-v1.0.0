 ...
 */
export const rangeOverOwGames: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {RangeOverOwGames} rangeOverOwGames
 * @property {string[]}
 * @property {boolean[]}
 * @property {boolean[]}
 * @property {string[]}
 ...
 */
export type RangeOverOwGames = z.infer<typeof rangeOverOwGames>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverOwGamesResponse: any = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverOwGamesRequest: any = z.lazy(() => {
  return z
    .object({
