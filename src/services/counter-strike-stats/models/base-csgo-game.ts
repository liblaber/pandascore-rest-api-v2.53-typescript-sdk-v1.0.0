import { z } from 'zod';
import { baseCsgoGameMap, baseCsgoGameMapRequest, baseCsgoGameMapResponse } from './base-csgo-game-map';
 ...
 */
export const baseCsgoGame: any = z.lazy(() => {
  return z.object({
    ...
    winner: gameWinner,
    winnerType: baseCsgoGameWinnerType.nullable(),
  });
});
 ...
 */
export const baseCsgoGameResponse: any = z.lazy(() => {
  return z
    .object({
      ...
      id: z.number().gte(1),
      length: z.number().gte(0).nullable(),
      map: baseCsgoGameMapResponse.nullable(),
      ...
      winner_type: baseCsgoGameWinnerType.nullable(),
    })
    .transform((data) => ({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const baseCsgoGameRequest: any = z.lazy(() => {
  return z
    .object({
