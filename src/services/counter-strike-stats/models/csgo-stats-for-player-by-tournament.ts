 ...
 */
export const csgoStatsForPlayerByTournament = z.object({
  active: z.boolean(),
  age: z.number().gte(0),
  birthday: z.string(),
 ...
 */
export const csgoStatsForPlayerByTournamentResponse = z
  .object({
    active: z.boolean(),
    age: z.number().gte(0),
    birthday: z.string(),
    current_team: csgoStatsForPlayerByTournamentCurrentTeamResponse,
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const csgoStatsForPlayerByTournamentRequest = z
  .object({
