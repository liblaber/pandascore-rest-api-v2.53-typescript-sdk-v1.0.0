 ...
 */
export const csgoStatsForPlayerByMatch = z.object({
  active: z.boolean(),
  age: z.number().gte(0),
  birthday: z.string(),
 ...
 */
export const csgoStatsForPlayerByMatchResponse = z
  .object({
    active: z.boolean(),
    age: z.number().gte(0),
    birthday: z.string(),
    current_team: csgoStatsForPlayerByMatchCurrentTeamResponse,
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const csgoStatsForPlayerByMatchRequest = z
  .object({
