 ...
 */
export const csgoStatsForPlayerByMatch: any = z.lazy(() => {
  return z.object({
    active: z.boolean(),
 ...
 */
export const csgoStatsForPlayerByMatchResponse: any = z.lazy(() => {
  return z
    .object({
      active: z.boolean(),
      age: z.number().gte(0).nullable(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const csgoStatsForPlayerByMatchRequest: any = z.lazy(() => {
  return z
    .object({
