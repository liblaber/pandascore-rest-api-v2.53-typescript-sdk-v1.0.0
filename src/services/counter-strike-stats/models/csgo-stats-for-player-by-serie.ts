 ...
 */
export const csgoStatsForPlayerBySerie: any = z.lazy(() => {
  return z.object({
    active: z.boolean(),
    age: z.number().gte(0).nullable(),
    birthday: z.string().nullable(),
    currentTeam: csgoStatsForPlayerBySerieCurrentTeam.nullable(),
 ...
 */
export const csgoStatsForPlayerBySerieResponse: any = z.lazy(() => {
  return z
    .object({
      active: z.boolean(),
      age: z.number().gte(0).nullable(),
      birthday: z.string().nullable(),
      current_team: csgoStatsForPlayerBySerieCurrentTeamResponse.nullable(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const csgoStatsForPlayerBySerieRequest: any = z.lazy(() => {
  return z
    .object({
