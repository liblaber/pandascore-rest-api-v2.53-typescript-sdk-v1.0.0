 ...
 */
export const csgoStatsForAllPlayersByMatch = z.object({
 ...
 */
export const csgoStatsForAllPlayersByMatchResponse = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const csgoStatsForAllPlayersByMatchRequest = z
  .object({ teams: z.array(csgoTeamForAllStatsPlayersRequest).nullish() })
  .transform((data) => ({
    teams: data['teams'],
  }));
