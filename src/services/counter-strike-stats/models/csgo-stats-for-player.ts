...
import {
  csgoPlayerStats,
  csgoPlayerStatsRequest,
  csgoPlayerStatsResponse,
} from './csgo-player-stats';
import { baseTeam, baseTeamRequest, baseTeamResponse } from '../../common/base-team';

/**
 * The shape of the model inside the application code - what the users use
 */
export const csgoStatsForPlayer = z.object({
  active: z.boolean(),
  age: z.number().gte(0),
  birthday: z.string(),
 ...
 */
export const csgoStatsForPlayerResponse = z
  .object({
    active: z.boolean(),
    age: z.number().gte(0),
    birthday: z.string(),
    current_team: csgoStatsForPlayerCurrentTeamResponse,
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const csgoStatsForPlayerRequest = z
  .object({
