 ...
 */
export const searchOverR6SiegePlayers: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {SearchOverR6SiegePlayers} searchOverR6SiegePlayers
 ...
 */
export type SearchOverR6SiegePlayers = z.infer<typeof searchOverR6SiegePlayers>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverR6SiegePlayersResponse: any = z.lazy(() => {
  return z
    .object({
      birthday: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverR6SiegePlayersRequest: any = z.lazy(() => {
  return z
    .object({
