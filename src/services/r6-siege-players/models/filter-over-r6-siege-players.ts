 ...
 */
export const filterOverR6SiegePlayers: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {FilterOverR6SiegePlayers} filterOverR6SiegePlayers
 ...
 */
export type FilterOverR6SiegePlayers = z.infer<typeof filterOverR6SiegePlayers>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverR6SiegePlayersResponse: any = z.lazy(() => {
  return z
    .object({
      active: z.boolean().optional(),
      birthday: z.array(z.string()).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverR6SiegePlayersRequest: any = z.lazy(() => {
  return z
    .object({
