 ...
 */
export const searchOverOwShortTournaments: any = z.lazy(() => {
  return z.object({
 ...
 */
export const searchOverOwShortTournamentsResponse: any = z.lazy(() => {
  return z
    .object({
      name: z.string().optional(),
      prizepool: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverOwShortTournamentsRequest: any = z.lazy(() => {
  return z
    .object({
