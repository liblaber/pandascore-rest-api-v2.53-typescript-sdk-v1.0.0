 ...
 */
export const rangeOverOwShortTournaments = z.lazy(() => {
  return z.object({
 ...
 */
export const rangeOverOwShortTournamentsResponse = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverOwShortTournamentsRequest = z.lazy(() => {
  return z
    .object({
