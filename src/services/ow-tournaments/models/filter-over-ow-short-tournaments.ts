 ...
 */
export const filterOverOwShortTournaments = z.lazy(() => {
  return z.object({
 ...
 */
export const filterOverOwShortTournamentsResponse = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverOwShortTournamentsRequest = z.lazy(() => {
  return z
    .object({
