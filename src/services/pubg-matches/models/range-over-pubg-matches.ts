 ...
 */
export const rangeOverPubgMatches: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {RangeOverPubgMatches} rangeOverPubgMatches
 * @property {string[]}
 * @property {boolean[]}
 * @property {boolean[]}
 * @property {string[]}
 ...
 */
export type RangeOverPubgMatches = z.infer<typeof rangeOverPubgMatches>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverPubgMatchesResponse: any = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverPubgMatchesRequest: any = z.lazy(() => {
  return z
    .object({
