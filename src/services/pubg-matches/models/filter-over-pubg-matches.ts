...
import {
  ...
  filterOverPubgMatchesOpponentIdRequest,
  filterOverPubgMatchesOpponentIdResponse,
} from './filter-over-pubg-matches-opponent-id';
...
import {
  ...
  filterOverPubgMatchesVideogameTitleRequest,
  filterOverPubgMatchesVideogameTitleResponse,
} from './filter-over-pubg-matches-videogame-title';
import {
  filterOverPubgMatchesVideogameVersion,
  filterOverPubgMatchesVideogameVersionRequest,
  filterOverPubgMatchesVideogameVersionResponse,
} from './filter-over-pubg-matches-videogame-version';
 ...
 */
export const filterOverPubgMatches: any = z.lazy(() => {
  return z.object({
    ...
    opponentId: z.array(filterOverPubgMatchesOpponentId).min(1).optional(),
    ...
    videogameTitle: z.array(filterOverPubgMatchesVideogameTitle).min(1).optional(),
    videogameVersion: z.array(filterOverPubgMatchesVideogameVersion).min(1).optional(),
...
/**
 *
 * @typedef  {FilterOverPubgMatches} filterOverPubgMatches
 * @property {string[]}
 ...
 * @property {boolean}
 * @property {number[]}
 * @property {FilterOverPubgMatchesOpponentId[]} - A Team or a Player (id or slug). You can use`filter[winner_type]=Team` or `filter[winner_type]=Player` to focus on teams or players.
 ...
 * @property {FilterOverPubgMatchesVideogameTitle[]} - A videogame title id or slug. <br/>Only for `/csgo/*`, `/codmw/*`, `/fifa/*` and `/ow/*` endpoints <br/>
 * @property {FilterOverPubgMatchesVideogameVersion[]} - Filter by the names of videogame versions, all versions using `filter[videogame_version]=all`, or by the latest version using `filter[videogame_version]=latest` <br/>Only for `valorant/*` and `/lol/*` endpoints. <br/>
 * @property {OpponentId[]}
 * @property {MatchWinnerType[]}
 */
export type FilterOverPubgMatches = z.infer<typeof filterOverPubgMatches>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverPubgMatchesResponse: any = z.lazy(() => {
  return z
    .object({
      ...
      opponent_id: z.array(filterOverPubgMatchesOpponentIdResponse).min(1).optional(),
      ...
      videogame_title: z.array(filterOverPubgMatchesVideogameTitleResponse).min(1).optional(),
      videogame_version: z.array(filterOverPubgMatchesVideogameVersionResponse).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverPubgMatchesRequest: any = z.lazy(() => {
  return z
    .object({
      ...
      opponentId: z.array(filterOverPubgMatchesOpponentIdRequest).nullish(),
      ...
      videogameTitle: z.array(filterOverPubgMatchesVideogameTitleRequest).nullish(),
      videogameVersion: z.array(filterOverPubgMatchesVideogameVersionRequest).nullish(),
