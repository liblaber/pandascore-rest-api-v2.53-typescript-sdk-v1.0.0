 ...
 */
export const searchOverPubgMatches: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {SearchOverPubgMatches} searchOverPubgMatches
 * @property {MatchType}
 * @property {string}
 * @property {string}
 ...
 */
export type SearchOverPubgMatches = z.infer<typeof searchOverPubgMatches>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverPubgMatchesResponse: any = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverPubgMatchesRequest: any = z.lazy(() => {
  return z
    .object({
