 ...
 */
export const searchOverValorantLeagues = z.lazy(() => {
  return z.object({
 ...
 */
export const searchOverValorantLeaguesResponse = z.lazy(() => {
  return z
    .object({
      name: z.string().optional(),
      slug: z
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverValorantLeaguesRequest = z.lazy(() => {
  return z
