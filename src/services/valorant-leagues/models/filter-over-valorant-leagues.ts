 ...
 */
export const filterOverValorantLeagues: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {FilterOverValorantLeagues} filterOverValorantLeagues
 * @property {number[]}
 * @property {string[]}
 * @property {string[]}
 * @property {string[]}
 * @property {string[]}
 */
export type FilterOverValorantLeagues = z.infer<typeof filterOverValorantLeagues>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverValorantLeaguesResponse: any = z.lazy(() => {
  return z
    .object({
      id: z.array(z.number()).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverValorantLeaguesRequest: any = z.lazy(() => {
  return z
    .object({
