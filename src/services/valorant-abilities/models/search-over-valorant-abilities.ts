 ...
 */
export const searchOverValorantAbilities = z.object({
 ...
 */
export const searchOverValorantAbilitiesResponse = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverValorantAbilitiesRequest = z
  .object({ abilityType: valorantAbilityType.nullish(), name: z.string().nullish() })
  .transform((data) => ({
