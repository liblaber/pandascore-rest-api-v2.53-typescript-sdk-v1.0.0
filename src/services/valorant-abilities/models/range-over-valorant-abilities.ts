 ...
 */
export const rangeOverValorantAbilities = z.lazy(() => {
  return z.object({
    abilityType: z.array(z.string()).min(2).max(2).optional(),
 ...
 */
export const rangeOverValorantAbilitiesResponse = z.lazy(() => {
  return z
    .object({
      ability_type: z.array(z.string()).min(2).max(2).optional(),
      creds: z.array(z.number()).min(2).max(2).optional(),
      id: z.array(z.number()).min(2).max(2).optional(),
      name: z.array(z.string()).min(2).max(2).optional(),
    })
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverValorantAbilitiesRequest = z.lazy(() => {
  return z
    .object({
