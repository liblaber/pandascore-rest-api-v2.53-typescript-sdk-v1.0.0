 ...
 */
export const valorantAbility = z.lazy(() => {
  return z.object({
    abilityType: z.string().nullable(),
 ...
 */
export const valorantAbilityResponse = z.lazy(() => {
  return z
    .object({
      ability_type: z.string().nullable(),
      creds: z.number().gte(0).nullable(),
      id: z.number().gte(1),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const valorantAbilityRequest = z.lazy(() => {
  return z
    .object({
      abilityType: z.string().nullish(),
