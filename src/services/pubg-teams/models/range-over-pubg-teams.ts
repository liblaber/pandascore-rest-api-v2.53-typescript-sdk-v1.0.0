 ...
 */
export const rangeOverPubgTeams: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {RangeOverPubgTeams} rangeOverPubgTeams
 * @property {string[]}
 * @property {number[]}
 * @property {string[]}
 * @property {string[]}
 ...
 * @property {string[]}
 */
export type RangeOverPubgTeams = z.infer<typeof rangeOverPubgTeams>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverPubgTeamsResponse: any = z.lazy(() => {
  return z
    .object({
      acronym: z.array(z.string()).min(2).max(2).optional(),
      id: z.array(z.number()).min(2).max(2).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverPubgTeamsRequest: any = z.lazy(() => {
  return z
    .object({
