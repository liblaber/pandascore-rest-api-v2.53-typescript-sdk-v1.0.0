 ...
 */
export const searchOverDota2Leagues: any = z.lazy(() => {
  return z.object({
 ...
 */
export const searchOverDota2LeaguesResponse: any = z.lazy(() => {
  return z
    .object({
      name: z.string().optional(),
      slug: z
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverDota2LeaguesRequest: any = z.lazy(() => {
  return z
