 ...
 */
export const searchOverValorantWeapons = z.lazy(() => {
  return z.object({
 ...
 */
export const searchOverValorantWeaponsResponse = z.lazy(() => {
  return z
    .object({
      name: z.string().optional(),
    })
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverValorantWeaponsRequest = z.lazy(() => {
