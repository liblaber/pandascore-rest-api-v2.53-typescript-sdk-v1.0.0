 ...
 */
export const gamelessFullGameMatchVideogameVersion: any = z.lazy(() => {
  return z.object({
    current: z.boolean(),
 ...
 */
export const gamelessFullGameMatchVideogameVersionResponse: any = z.lazy(() => {
  return z
    .object({
      current: z.boolean(),
      name: z.string().regex(/^[0-9]+\.[0-9]+(\.[0-9]+)?$/),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const gamelessFullGameMatchVideogameVersionRequest: any = z.lazy(() => {
