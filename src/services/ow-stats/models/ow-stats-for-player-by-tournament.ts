 ...
 */
export const owStatsForPlayerByTournament = z.object({
  active: z.boolean(),
  age: z.number().gte(0),
  birthday: z.string(),
 ...
 */
export const owStatsForPlayerByTournamentResponse = z
  .object({
    active: z.boolean(),
    age: z.number().gte(0),
    birthday: z.string(),
    current_team: owStatsForPlayerByTournamentCurrentTeamResponse,
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const owStatsForPlayerByTournamentRequest = z
  .object({
