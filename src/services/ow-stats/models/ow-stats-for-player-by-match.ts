 ...
 */
export const owStatsForPlayerByMatch: any = z.lazy(() => {
  return z.object({
    active: z.boolean(),
    age: z.number().gte(0).nullable(),
    birthday: z.string().nullable(),
    currentTeam: owStatsForPlayerByMatchCurrentTeam.nullable(),
 ...
 */
export const owStatsForPlayerByMatchResponse: any = z.lazy(() => {
  return z
    .object({
      active: z.boolean(),
      age: z.number().gte(0).nullable(),
      birthday: z.string().nullable(),
      current_team: owStatsForPlayerByMatchCurrentTeamResponse.nullable(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const owStatsForPlayerByMatchRequest: any = z.lazy(() => {
  return z
    .object({
