...
import {
  owGameStatsGameMap,
  owGameStatsGameMapRequest,
  owGameStatsGameMapResponse,
} from './ow-game-stats-game-map';
import {
 ...
 */
export const owGameStatsGame = z.object({
 ...
 */
export const owGameStatsGameResponse = z
  .object({
    ...
    id: z.number().gte(1),
    length: z.number().gte(0),
    map: owGameStatsGameMapResponse,
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const owGameStatsGameRequest = z
  .object({
