 ...
 */
export const winner1_6: any = z.lazy(() => {
  return z.object({
    active: z.boolean(),
 ...
 */
export type Winner1_6 = z.infer<typeof winner1_6>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const winner1_6Response: any = z.lazy(() => {
  return z
    .object({
      active: z.boolean(),
      age: z.number().gte(0).nullable(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const winner1_6Request: any = z.lazy(() => {
  return z
    .object({
