...
import {
  ...
  owStatsForPlayerByGameCurrentTeamRequest,
  owStatsForPlayerByGameCurrentTeamResponse,
} from './ow-stats-for-player-by-game-current-team';
import {
  owPlayerStatsByGame,
  owPlayerStatsByGameRequest,
  owPlayerStatsByGameResponse,
} from './ow-player-stats-by-game';

/**
 * The shape of the model inside the application code - what the users use
 */
export const owStatsForPlayerByGame = z.object({
  active: z.boolean(),
  age: z.number().gte(0),
  birthday: z.string(),
  ...
  slug: z
    ...
    .min(1)
    .regex(/^[a-z0-9_-]+$/),
  stats: owPlayerStatsByGame,
});

/**
 * Player's aggregated statistics for a game
 * @typedef  {OwStatsForPlayerByGame} owStatsForPlayerByGame - Player's aggregated statistics for a game - Player's aggregated statistics for a game
 ...
 * @property {OwStatsForPlayerByGameCurrentTeam}
 * @property {any}
 ...
 * @property {OwPlayerStatsByGame} - Player's statistics for a game
 */
export type OwStatsForPlayerByGame = z.infer<typeof owStatsForPlayerByGame>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const owStatsForPlayerByGameResponse = z
  .object({
    active: z.boolean(),
    age: z.number().gte(0),
    birthday: z.string(),
    current_team: owStatsForPlayerByGameCurrentTeamResponse,
    ...
    slug: z
      ...
      .min(1)
      .regex(/^[a-z0-9_-]+$/),
    stats: owPlayerStatsByGameResponse,
  })
  .transform((data) => ({
    active: data['active'],
    age: data['age'],
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const owStatsForPlayerByGameRequest = z
  .object({
    active: z.boolean().nullish(),
    age: z.number().nullish(),
    birthday: z.string().nullish(),
    currentTeam: owStatsForPlayerByGameCurrentTeamRequest.nullish(),
    ...
    stats: owPlayerStatsByGameRequest.nullish(),
  })
  .transform((data) => ({
    active: data['active'],
    age: data['age'],
