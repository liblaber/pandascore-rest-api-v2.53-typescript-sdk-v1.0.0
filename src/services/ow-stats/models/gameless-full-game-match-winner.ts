 ...
 */
export const gamelessFullGameMatchWinner = z.union([winner1_6, winner2_6]);
 ...
 */
export const gamelessFullGameMatchWinnerResponse = z.union([winner1_6Response, winner2_6Response]);

/**
 * The shape of the model mapping from the application shape into the api schema.
 * Is equal to application shape if all property names match the api schema
 */
export const gamelessFullGameMatchWinnerRequest = z.union([winner1_6Request, winner2_6Request]);
