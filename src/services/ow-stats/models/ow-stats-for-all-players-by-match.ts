 ...
 */
export const owStatsForAllPlayersByMatch = z.object({
 ...
 */
export const owStatsForAllPlayersByMatchResponse = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const owStatsForAllPlayersByMatchRequest = z
  .object({ teams: z.array(owTeamForAllStatsPlayersRequest).nullish() })
  .transform((data) => ({
    teams: data['teams'],
  }));
