 ...
 */
export const videogameOverwatch: any = z.lazy(() => {
  return z.object({
    currentVersion: z
      .string()
      .regex(/^[0-9]+\.[0-9]+(\.[0-9]+)?$/)
...
/**
 *
 * @typedef  {VideogameOverwatch} videogameOverwatch
 * @property {string}
 * @property {any}
 ...
 * @property {any}
 */
export type VideogameOverwatch = z.infer<typeof videogameOverwatch>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const videogameOverwatchResponse: any = z.lazy(() => {
  return z
    .object({
      current_version: z
        .string()
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const videogameOverwatchRequest: any = z.lazy(() => {
  return z
    .object({
