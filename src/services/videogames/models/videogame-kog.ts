 ...
 */
export const videogameKog: any = z.lazy(() => {
  return z.object({
    currentVersion: z
      .string()
      .regex(/^[0-9]+\.[0-9]+(\.[0-9]+)?$/)
...
/**
 *
 * @typedef  {VideogameKog} videogameKog
 * @property {string}
 * @property {any}
 ...
 * @property {any}
 */
export type VideogameKog = z.infer<typeof videogameKog>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const videogameKogResponse: any = z.lazy(() => {
  return z
    .object({
      current_version: z
        .string()
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const videogameKogRequest: any = z.lazy(() => {
  return z
    .object({
