 ...
 */
export const videogamePubg: any = z.lazy(() => {
  return z.object({
    currentVersion: z
      .string()
      .regex(/^[0-9]+\.[0-9]+(\.[0-9]+)?$/)
...
/**
 *
 * @typedef  {VideogamePubg} videogamePubg
 * @property {string}
 * @property {any}
 ...
 * @property {any}
 */
export type VideogamePubg = z.infer<typeof videogamePubg>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const videogamePubgResponse: any = z.lazy(() => {
  return z
    .object({
      current_version: z
        .string()
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const videogamePubgRequest: any = z.lazy(() => {
  return z
    .object({
