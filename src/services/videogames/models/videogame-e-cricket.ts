 ...
 */
export const videogameECricket: any = z.lazy(() => {
  return z.object({
    currentVersion: z
      .string()
      .regex(/^[0-9]+\.[0-9]+(\.[0-9]+)?$/)
...
/**
 *
 * @typedef  {VideogameECricket} videogameECricket
 * @property {string}
 * @property {any}
 ...
 * @property {any}
 */
export type VideogameECricket = z.infer<typeof videogameECricket>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const videogameECricketResponse: any = z.lazy(() => {
  return z
    .object({
      current_version: z
        .string()
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const videogameECricketRequest: any = z.lazy(() => {
  return z
    .object({
