 ...
 */
export const videogameLoL: any = z.lazy(() => {
  return z.object({
    currentVersion: z
      .string()
      .regex(/^[0-9]+\.[0-9]+(\.[0-9]+)?$/)
...
/**
 *
 * @typedef  {VideogameLoL} videogameLoL
 * @property {string}
 * @property {any}
 ...
 * @property {any}
 */
export type VideogameLoL = z.infer<typeof videogameLoL>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const videogameLoLResponse: any = z.lazy(() => {
  return z
    .object({
      current_version: z
        .string()
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const videogameLoLRequest: any = z.lazy(() => {
  return z
    .object({
