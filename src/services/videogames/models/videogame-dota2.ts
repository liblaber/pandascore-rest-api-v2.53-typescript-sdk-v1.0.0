 ...
 */
export const videogameDota2: any = z.lazy(() => {
  return z.object({
    currentVersion: z
      .string()
      .regex(/^[0-9]+\.[0-9]+(\.[0-9]+)?$/)
...
/**
 *
 * @typedef  {VideogameDota2} videogameDota2
 * @property {string}
 * @property {any}
 ...
 * @property {any}
 */
export type VideogameDota2 = z.infer<typeof videogameDota2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const videogameDota2Response: any = z.lazy(() => {
  return z
    .object({
      current_version: z
        .string()
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const videogameDota2Request: any = z.lazy(() => {
  return z
    .object({
