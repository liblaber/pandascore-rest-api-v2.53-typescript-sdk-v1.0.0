 ...
 */
export const videogameCodmw: any = z.lazy(() => {
  return z.object({
    currentVersion: z
      .string()
      .regex(/^[0-9]+\.[0-9]+(\.[0-9]+)?$/)
...
/**
 *
 * @typedef  {VideogameCodmw} videogameCodmw
 * @property {string}
 * @property {any}
 ...
 * @property {any}
 */
export type VideogameCodmw = z.infer<typeof videogameCodmw>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const videogameCodmwResponse: any = z.lazy(() => {
  return z
    .object({
      current_version: z
        .string()
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const videogameCodmwRequest: any = z.lazy(() => {
  return z
    .object({
