 ...
 */
export const rangeOverOwMaps = z.lazy(() => {
  return z.object({
    gameMode: z.array(z.string()).min(2).max(2).optional(),
 ...
 */
export const rangeOverOwMapsResponse = z.lazy(() => {
  return z
    .object({
      game_mode: z.array(z.string()).min(2).max(2).optional(),
      id: z.array(z.number()).min(2).max(2).optional(),
      name: z.array(z.string()).min(2).max(2).optional(),
      slug: z.array(z.string()).min(2).max(2).optional(),
    })
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverOwMapsRequest = z.lazy(() => {
  return z
    .object({
