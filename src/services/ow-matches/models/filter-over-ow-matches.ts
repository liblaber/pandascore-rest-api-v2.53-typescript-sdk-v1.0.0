...
import {
  ...
  filterOverOwMatchesOpponentIdRequest,
  filterOverOwMatchesOpponentIdResponse,
} from './filter-over-ow-matches-opponent-id';
...
import {
  ...
  filterOverOwMatchesVideogameTitleRequest,
  filterOverOwMatchesVideogameTitleResponse,
} from './filter-over-ow-matches-videogame-title';
import {
  filterOverOwMatchesVideogameVersion,
  filterOverOwMatchesVideogameVersionRequest,
  filterOverOwMatchesVideogameVersionResponse,
} from './filter-over-ow-matches-videogame-version';
 ...
 */
export const filterOverOwMatches: any = z.lazy(() => {
  return z.object({
    ...
    opponentId: z.array(filterOverOwMatchesOpponentId).min(1).optional(),
    ...
    videogameTitle: z.array(filterOverOwMatchesVideogameTitle).min(1).optional(),
    videogameVersion: z.array(filterOverOwMatchesVideogameVersion).min(1).optional(),
...
/**
 *
 * @typedef  {FilterOverOwMatches} filterOverOwMatches
 * @property {string[]}
 ...
 * @property {boolean}
 * @property {number[]}
 * @property {FilterOverOwMatchesOpponentId[]} - A Team or a Player (id or slug). You can use`filter[winner_type]=Team` or `filter[winner_type]=Player` to focus on teams or players.
 ...
 * @property {FilterOverOwMatchesVideogameTitle[]} - A videogame title id or slug. <br/>Only for `/csgo/*`, `/codmw/*`, `/fifa/*` and `/ow/*` endpoints <br/>
 * @property {FilterOverOwMatchesVideogameVersion[]} - Filter by the names of videogame versions, all versions using `filter[videogame_version]=all`, or by the latest version using `filter[videogame_version]=latest` <br/>Only for `valorant/*` and `/lol/*` endpoints. <br/>
 * @property {OpponentId[]}
 * @property {MatchWinnerType[]}
 */
export type FilterOverOwMatches = z.infer<typeof filterOverOwMatches>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverOwMatchesResponse: any = z.lazy(() => {
  return z
    .object({
      ...
      opponent_id: z.array(filterOverOwMatchesOpponentIdResponse).min(1).optional(),
      ...
      videogame_title: z.array(filterOverOwMatchesVideogameTitleResponse).min(1).optional(),
      videogame_version: z.array(filterOverOwMatchesVideogameVersionResponse).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverOwMatchesRequest: any = z.lazy(() => {
  return z
    .object({
      ...
      opponentId: z.array(filterOverOwMatchesOpponentIdRequest).nullish(),
      ...
      videogameTitle: z.array(filterOverOwMatchesVideogameTitleRequest).nullish(),
      videogameVersion: z.array(filterOverOwMatchesVideogameVersionRequest).nullish(),
