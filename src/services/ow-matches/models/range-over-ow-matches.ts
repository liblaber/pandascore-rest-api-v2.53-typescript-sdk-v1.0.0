 ...
 */
export const rangeOverOwMatches: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {RangeOverOwMatches} rangeOverOwMatches
 * @property {string[]}
 * @property {boolean[]}
 * @property {boolean[]}
 * @property {string[]}
 ...
 */
export type RangeOverOwMatches = z.infer<typeof rangeOverOwMatches>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverOwMatchesResponse: any = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverOwMatchesRequest: any = z.lazy(() => {
  return z
    .object({
