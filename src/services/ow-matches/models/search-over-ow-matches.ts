 ...
 */
export const searchOverOwMatches: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {SearchOverOwMatches} searchOverOwMatches
 * @property {MatchType}
 * @property {string}
 * @property {string}
 ...
 */
export type SearchOverOwMatches = z.infer<typeof searchOverOwMatches>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverOwMatchesResponse: any = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverOwMatchesRequest: any = z.lazy(() => {
  return z
    .object({
