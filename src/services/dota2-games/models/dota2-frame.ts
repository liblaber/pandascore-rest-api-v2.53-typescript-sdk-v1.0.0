...
import {
  dota2FrameTeam,
  dota2FrameTeamRequest,
  dota2FrameTeamResponse,
} from '../../common/dota2-frame-team';

/**
 * The shape of the model inside the application code - what the users use
 */
export const dota2Frame = z.object({
 ...
 */
export const dota2FrameResponse = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const dota2FrameRequest = z
  .object({
