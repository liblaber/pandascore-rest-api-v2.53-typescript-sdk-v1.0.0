 ...
 */
export const filterOverFifaLeagues: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {FilterOverFifaLeagues} filterOverFifaLeagues
 * @property {number[]}
 * @property {string[]}
 * @property {string[]}
 * @property {string[]}
 * @property {string[]}
 */
export type FilterOverFifaLeagues = z.infer<typeof filterOverFifaLeagues>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverFifaLeaguesResponse: any = z.lazy(() => {
  return z
    .object({
      id: z.array(z.number()).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverFifaLeaguesRequest: any = z.lazy(() => {
  return z
    .object({
