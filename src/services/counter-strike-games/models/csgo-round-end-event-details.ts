 ...
 */
export const csgoRoundEndEventDetails: any = z.lazy(() => {
  return z.object({
    outcome: csgoOutcome,
 ...
 */
export const csgoRoundEndEventDetailsResponse: any = z.lazy(() => {
  return z
    .object({
      outcome: csgoOutcome,
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const csgoRoundEndEventDetailsRequest: any = z.lazy(() => {
  return z
