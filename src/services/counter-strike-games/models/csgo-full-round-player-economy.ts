 ...
 */
export const csgoFullRoundPlayerEconomy = z.lazy(() => {
  return z.object({
 ...
 */
export const csgoFullRoundPlayerEconomyResponse = z.lazy(() => {
  return z
    .object({
      armor: z.string().nullable(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const csgoFullRoundPlayerEconomyRequest = z.lazy(() => {
  return z
    .object({
      armor: z.string().nullish(),
