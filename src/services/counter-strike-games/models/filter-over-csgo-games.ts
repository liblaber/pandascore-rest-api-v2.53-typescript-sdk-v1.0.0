 ...
 */
export const filterOverCsgoGames: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {FilterOverCsgoGames} filterOverCsgoGames
 * @property {string[]}
 ...
 * @property {GameStatus[]}
 */
export type FilterOverCsgoGames = z.infer<typeof filterOverCsgoGames>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverCsgoGamesResponse: any = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverCsgoGamesRequest: any = z.lazy(() => {
  return z
    .object({
