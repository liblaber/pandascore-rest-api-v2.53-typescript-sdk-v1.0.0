 ...
 */
export const csgoFullRoundWinner: any = z.lazy(() => {
  return z.object({
    side: csgoRoundSide,
 ...
 */
export const csgoFullRoundWinnerResponse: any = z.lazy(() => {
  return z
    .object({
      side: csgoRoundSide,
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const csgoFullRoundWinnerRequest: any = z.lazy(() => {
  return z
    .object({ side: csgoRoundSide.nullish(), teamId: z.number().nullish(), teamName: z.string().nullish() })
    .transform((data) => ({
      side: data['side'],
      team_id: data['teamId'],
