 ...
 */
export const csgoRoundStartEventDetails = z.object({
 ...
 */
export const csgoRoundStartEventDetailsResponse = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const csgoRoundStartEventDetailsRequest = z
  .object({
    counterTerrorists: csgoRoundsScoreRequest.nullish(),
    terrorists: csgoRoundsScoreRequest.nullish(),
  })
  .transform((data) => ({
