 ...
 */
export const searchOverKogShortTournaments = z.lazy(() => {
  return z.object({
 ...
 */
export const searchOverKogShortTournamentsResponse = z.lazy(() => {
  return z
    .object({
      name: z.string().optional(),
      prizepool: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverKogShortTournamentsRequest = z.lazy(() => {
  return z
    .object({
