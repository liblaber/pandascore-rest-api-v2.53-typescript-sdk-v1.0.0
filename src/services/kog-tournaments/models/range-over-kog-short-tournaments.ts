 ...
 */
export const rangeOverKogShortTournaments = z.lazy(() => {
  return z.object({
 ...
 */
export const rangeOverKogShortTournamentsResponse = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverKogShortTournamentsRequest = z.lazy(() => {
  return z
    .object({
