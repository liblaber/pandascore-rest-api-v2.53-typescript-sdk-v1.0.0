 ...
 */
export const filterOverKogShortTournaments = z.lazy(() => {
  return z.object({
 ...
 */
export const filterOverKogShortTournamentsResponse = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverKogShortTournamentsRequest = z.lazy(() => {
  return z
    .object({
