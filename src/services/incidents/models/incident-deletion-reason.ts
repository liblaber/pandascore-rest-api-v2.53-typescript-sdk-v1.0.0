 ...
 */
export const incidentDeletionReason: any = z.lazy(() => {
  return z.union([z.string(), z.string(), incidentDeletionReasonDeleted]);
});
 ...
 */
export const incidentDeletionReasonResponse: any = z.lazy(() => {
  return z.union([z.string(), z.string(), incidentDeletionReasonDeleted]);
});
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const incidentDeletionReasonRequest: any = z.lazy(() => {
  return z.union([z.string(), z.string(), incidentDeletionReasonDeleted]);
});
