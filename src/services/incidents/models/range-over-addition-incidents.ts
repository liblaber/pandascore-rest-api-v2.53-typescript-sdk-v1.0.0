 ...
 */
export const rangeOverAdditionIncidents = z.lazy(() => {
  return z.object({
 ...
 */
export const rangeOverAdditionIncidentsResponse = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverAdditionIncidentsRequest = z.lazy(() => {
  return z
