 ...
 */
export const filterOverRlTeams: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {FilterOverRlTeams} filterOverRlTeams
 * @property {string[]}
 * @property {number[]}
 * @property {string[]}
 * @property {string[]}
 ...
 */
export type FilterOverRlTeams = z.infer<typeof filterOverRlTeams>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverRlTeamsResponse: any = z.lazy(() => {
  return z
    .object({
      acronym: z.array(z.string()).min(1).optional(),
      id: z.array(z.number()).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverRlTeamsRequest: any = z.lazy(() => {
  return z
    .object({
