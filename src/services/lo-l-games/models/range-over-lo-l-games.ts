 ...
 */
export const rangeOverLoLGames: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {RangeOverLoLGames} rangeOverLoLGames
 * @property {string[]}
 * @property {boolean[]}
 * @property {boolean[]}
 * @property {string[]}
 ...
 */
export type RangeOverLoLGames = z.infer<typeof rangeOverLoLGames>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverLoLGamesResponse: any = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverLoLGamesRequest: any = z.lazy(() => {
  return z
    .object({
