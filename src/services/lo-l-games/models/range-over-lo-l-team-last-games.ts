 ...
 */
export const rangeOverLoLTeamLastGames = z.lazy(() => {
  return z.object({
 ...
 */
export const rangeOverLoLTeamLastGamesResponse = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverLoLTeamLastGamesRequest = z.lazy(() => {
  return z
    .object({
