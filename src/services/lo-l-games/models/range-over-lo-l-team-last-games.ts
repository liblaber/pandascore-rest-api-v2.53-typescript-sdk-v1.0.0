 ...
 */
export const rangeOverLoLTeamLastGames: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {RangeOverLoLTeamLastGames} rangeOverLoLTeamLastGames
 * @property {string[]}
 * @property {boolean[]}
 * @property {boolean[]}
 * @property {string[]}
 ...
 */
export type RangeOverLoLTeamLastGames = z.infer<typeof rangeOverLoLTeamLastGames>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverLoLTeamLastGamesResponse: any = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverLoLTeamLastGamesRequest: any = z.lazy(() => {
  return z
    .object({
