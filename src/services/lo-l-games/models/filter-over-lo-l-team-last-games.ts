 ...
 */
export const filterOverLoLTeamLastGames = z.lazy(() => {
  return z.object({
 ...
 */
export const filterOverLoLTeamLastGamesResponse = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverLoLTeamLastGamesRequest = z.lazy(() => {
  return z
    .object({
