...
import {
  loLFrameTeam,
  loLFrameTeamRequest,
  loLFrameTeamResponse,
} from '../../common/lo-l-frame-team';

/**
 * The shape of the model inside the application code - what the users use
 */
export const loLGameFrame = z.object({
  blue: loLFrameTeam,
 ...
 */
export const loLGameFrameResponse = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const loLGameFrameRequest = z
  .object({
