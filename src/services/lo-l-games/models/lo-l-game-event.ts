...
import {
  loLEventPayload,
  loLEventPayloadRequest,
  loLEventPayloadResponse,
} from './lo-l-event-payload';
import { loLEventType } from './lo-l-event-type';

/**
 * The shape of the model inside the application code - what the users use
 */
export const loLGameEvent = z.object({
 ...
 */
export const loLGameEventResponse = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const loLGameEventRequest = z
  .object({
