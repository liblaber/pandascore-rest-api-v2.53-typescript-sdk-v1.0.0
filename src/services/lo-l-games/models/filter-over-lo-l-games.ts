 ...
 */
export const filterOverLoLGames: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {FilterOverLoLGames} filterOverLoLGames
 * @property {string[]}
 ...
 */
export type FilterOverLoLGames = z.infer<typeof filterOverLoLGames>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverLoLGamesResponse: any = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverLoLGamesRequest: any = z.lazy(() => {
  return z
    .object({
