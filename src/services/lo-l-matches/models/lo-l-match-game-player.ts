...
} from '../../common/lo-l-kill-counters';
import {
  loLKillsSeries,
  loLKillsSeriesRequest,
  loLKillsSeriesResponse,
} from '../../common/lo-l-kills-series';
import { loLMatchGamePlayerRole } from './lo-l-match-game-player-role';

/**
 * The shape of the model inside the application code - what the users use
 */
export const loLMatchGamePlayer = z.object({
 ...
 */
export const loLMatchGamePlayerResponse = z
  .object({
    assists: z.number().gte(0),
    deaths: z.number().gte(0),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const loLMatchGamePlayerRequest = z
  .object({
