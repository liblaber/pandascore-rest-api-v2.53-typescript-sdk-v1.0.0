 ...
 */
export const rangeOverLoLMatches: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {RangeOverLoLMatches} rangeOverLoLMatches
 * @property {string[]}
 * @property {boolean[]}
 * @property {boolean[]}
 * @property {string[]}
 ...
 */
export type RangeOverLoLMatches = z.infer<typeof rangeOverLoLMatches>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverLoLMatchesResponse: any = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverLoLMatchesRequest: any = z.lazy(() => {
  return z
    .object({
