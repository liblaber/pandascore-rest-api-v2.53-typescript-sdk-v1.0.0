...
import {
  ...
  filterOverLoLMatchesOpponentIdRequest,
  filterOverLoLMatchesOpponentIdResponse,
} from './filter-over-lo-l-matches-opponent-id';
...
import {
  ...
  filterOverLoLMatchesVideogameTitleRequest,
  filterOverLoLMatchesVideogameTitleResponse,
} from './filter-over-lo-l-matches-videogame-title';
import {
  filterOverLoLMatchesVideogameVersion,
  filterOverLoLMatchesVideogameVersionRequest,
  filterOverLoLMatchesVideogameVersionResponse,
} from './filter-over-lo-l-matches-videogame-version';
 ...
 */
export const filterOverLoLMatches: any = z.lazy(() => {
  return z.object({
    ...
    opponentId: z.array(filterOverLoLMatchesOpponentId).min(1).optional(),
    ...
    videogameTitle: z.array(filterOverLoLMatchesVideogameTitle).min(1).optional(),
    videogameVersion: z.array(filterOverLoLMatchesVideogameVersion).min(1).optional(),
...
/**
 *
 * @typedef  {FilterOverLoLMatches} filterOverLoLMatches
 * @property {string[]}
 ...
 * @property {boolean}
 * @property {number[]}
 * @property {FilterOverLoLMatchesOpponentId[]} - A Team or a Player (id or slug). You can use`filter[winner_type]=Team` or `filter[winner_type]=Player` to focus on teams or players.
 ...
 * @property {FilterOverLoLMatchesVideogameTitle[]} - A videogame title id or slug. <br/>Only for `/csgo/*`, `/codmw/*`, `/fifa/*` and `/ow/*` endpoints <br/>
 * @property {FilterOverLoLMatchesVideogameVersion[]} - Filter by the names of videogame versions, all versions using `filter[videogame_version]=all`, or by the latest version using `filter[videogame_version]=latest` <br/>Only for `valorant/*` and `/lol/*` endpoints. <br/>
 * @property {OpponentId[]}
 * @property {MatchWinnerType[]}
 */
export type FilterOverLoLMatches = z.infer<typeof filterOverLoLMatches>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverLoLMatchesResponse: any = z.lazy(() => {
  return z
    .object({
      ...
      opponent_id: z.array(filterOverLoLMatchesOpponentIdResponse).min(1).optional(),
      ...
      videogame_title: z.array(filterOverLoLMatchesVideogameTitleResponse).min(1).optional(),
      videogame_version: z.array(filterOverLoLMatchesVideogameVersionResponse).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverLoLMatchesRequest: any = z.lazy(() => {
  return z
    .object({
      ...
      opponentId: z.array(filterOverLoLMatchesOpponentIdRequest).nullish(),
      ...
      videogameTitle: z.array(filterOverLoLMatchesVideogameTitleRequest).nullish(),
      videogameVersion: z.array(filterOverLoLMatchesVideogameVersionRequest).nullish(),
