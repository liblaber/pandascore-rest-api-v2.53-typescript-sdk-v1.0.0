...
export class CodmwSeriesService extends BaseService {
   ...
   */
  async getCodmwSeries(
    params?: GetCodmwSeriesParams,
    requestConfig?: RequestConfig,
  ): Promise<HttpResponse<Serie[]>> {
    const path = '/codmw/series';
    const options: any = {
  ...
  async getCodmwSeriesRunning(
    ...
    const path = '/codmw/series/running';
    const options: any = {
      responseSchema: z.array(serieResponse),
      requestSchema: z.any(),
      queryParams: {},
  ...
  async getCodmwSeriesUpcoming(
    ...
    const path = '/codmw/series/upcoming';
    const options: any = {
      responseSchema: z.array(serieResponse),
      requestSchema: z.any(),
      queryParams: {},
