 ...
 */
export const rangeOverCodmwSeries: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {RangeOverCodmwSeries} rangeOverCodmwSeries
 * @property {string[]}
 * @property {string[]}
 * @property {number[]}
 * @property {number[]}
 ...
 * @property {number[]}
 */
export type RangeOverCodmwSeries = z.infer<typeof rangeOverCodmwSeries>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverCodmwSeriesResponse: any = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverCodmwSeriesRequest: any = z.lazy(() => {
  return z
    .object({
