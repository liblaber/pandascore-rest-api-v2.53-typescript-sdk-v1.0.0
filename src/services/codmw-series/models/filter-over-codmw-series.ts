...
import {
  ...
  filterOverCodmwSeriesVideogameTitleRequest,
  filterOverCodmwSeriesVideogameTitleResponse,
} from './filter-over-codmw-series-videogame-title';
 ...
 */
export const filterOverCodmwSeries: any = z.lazy(() => {
  return z.object({
    ...
    videogameTitle: z.array(filterOverCodmwSeriesVideogameTitle).min(1).optional(),
...
/**
 *
 * @typedef  {FilterOverCodmwSeries} filterOverCodmwSeries
 * @property {string[]}
 * @property {string[]}
 * @property {number[]}
 * @property {number[]}
 ...
 * @property {string[]}
 * @property {string[]}
 * @property {FilterOverCodmwSeriesVideogameTitle[]} - A videogame title id or slug. <br/>Only for `/csgo/*`, `/codmw/*`, `/fifa/*` and `/ow/*` endpoints <br/>
 * @property {OpponentId[]}
 * @property {OpponentType[]}
 * @property {number[]}
 */
export type FilterOverCodmwSeries = z.infer<typeof filterOverCodmwSeries>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverCodmwSeriesResponse: any = z.lazy(() => {
  return z
    .object({
      ...
      season: z.array(z.string()).min(1).optional(),
      slug: z.array(z.string()).min(1).optional(),
      videogame_title: z.array(filterOverCodmwSeriesVideogameTitleResponse).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverCodmwSeriesRequest: any = z.lazy(() => {
  return z
    .object({
      ...
      videogameTitle: z.array(filterOverCodmwSeriesVideogameTitleRequest).nullish(),
