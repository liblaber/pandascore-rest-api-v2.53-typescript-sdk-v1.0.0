 ...
 */
export const searchOverStarcraft2Matches: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {SearchOverStarcraft2Matches} searchOverStarcraft2Matches
 * @property {MatchType}
 * @property {string}
 * @property {string}
 ...
 */
export type SearchOverStarcraft2Matches = z.infer<typeof searchOverStarcraft2Matches>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverStarcraft2MatchesResponse: any = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverStarcraft2MatchesRequest: any = z.lazy(() => {
  return z
    .object({
