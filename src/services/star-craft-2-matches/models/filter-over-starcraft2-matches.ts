...
import {
  ...
  filterOverStarcraft2MatchesOpponentIdRequest,
  filterOverStarcraft2MatchesOpponentIdResponse,
} from './filter-over-starcraft2-matches-opponent-id';
...
import {
  ...
  filterOverStarcraft2MatchesVideogameTitleRequest,
  filterOverStarcraft2MatchesVideogameTitleResponse,
} from './filter-over-starcraft2-matches-videogame-title';
import {
  filterOverStarcraft2MatchesVideogameVersion,
  filterOverStarcraft2MatchesVideogameVersionRequest,
  filterOverStarcraft2MatchesVideogameVersionResponse,
} from './filter-over-starcraft2-matches-videogame-version';
 ...
 */
export const filterOverStarcraft2Matches: any = z.lazy(() => {
  return z.object({
    ...
    opponentId: z.array(filterOverStarcraft2MatchesOpponentId).min(1).optional(),
    ...
    videogameTitle: z.array(filterOverStarcraft2MatchesVideogameTitle).min(1).optional(),
    videogameVersion: z.array(filterOverStarcraft2MatchesVideogameVersion).min(1).optional(),
...
/**
 *
 * @typedef  {FilterOverStarcraft2Matches} filterOverStarcraft2Matches
 * @property {string[]}
 ...
 * @property {boolean}
 * @property {number[]}
 * @property {FilterOverStarcraft2MatchesOpponentId[]} - A Team or a Player (id or slug). You can use`filter[winner_type]=Team` or `filter[winner_type]=Player` to focus on teams or players.
 ...
 * @property {FilterOverStarcraft2MatchesVideogameTitle[]} - A videogame title id or slug. <br/>Only for `/csgo/*`, `/codmw/*`, `/fifa/*` and `/ow/*` endpoints <br/>
 * @property {FilterOverStarcraft2MatchesVideogameVersion[]} - Filter by the names of videogame versions, all versions using `filter[videogame_version]=all`, or by the latest version using `filter[videogame_version]=latest` <br/>Only for `valorant/*` and `/lol/*` endpoints. <br/>
 * @property {OpponentId[]}
 * @property {MatchWinnerType[]}
 */
export type FilterOverStarcraft2Matches = z.infer<typeof filterOverStarcraft2Matches>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverStarcraft2MatchesResponse: any = z.lazy(() => {
  return z
    .object({
      ...
      opponent_id: z.array(filterOverStarcraft2MatchesOpponentIdResponse).min(1).optional(),
      ...
      videogame_title: z.array(filterOverStarcraft2MatchesVideogameTitleResponse).min(1).optional(),
      videogame_version: z.array(filterOverStarcraft2MatchesVideogameVersionResponse).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverStarcraft2MatchesRequest: any = z.lazy(() => {
  return z
    .object({
      ...
      opponentId: z.array(filterOverStarcraft2MatchesOpponentIdRequest).nullish(),
      ...
      videogameTitle: z.array(filterOverStarcraft2MatchesVideogameTitleRequest).nullish(),
      videogameVersion: z.array(filterOverStarcraft2MatchesVideogameVersionRequest).nullish(),
