 ...
 */
export const filterOverStarcraft2Matches = z.lazy(() => {
  return z.object({
 ...
 */
export const filterOverStarcraft2MatchesResponse = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverStarcraft2MatchesRequest = z.lazy(() => {
  return z
    .object({
