 ...
 */
export const rangeOverStarcraft2Matches: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {RangeOverStarcraft2Matches} rangeOverStarcraft2Matches
 * @property {string[]}
 * @property {boolean[]}
 * @property {boolean[]}
 * @property {string[]}
 ...
 */
export type RangeOverStarcraft2Matches = z.infer<typeof rangeOverStarcraft2Matches>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverStarcraft2MatchesResponse: any = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverStarcraft2MatchesRequest: any = z.lazy(() => {
  return z
    .object({
