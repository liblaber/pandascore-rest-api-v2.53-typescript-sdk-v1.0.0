 ...
 */
export const filterOverStarcraft2MatchesVideogameTitle = z.lazy(() => {
 ...
 */
export const filterOverStarcraft2MatchesVideogameTitleResponse = z.lazy(() => {
  return z.union([z.number(), z.string()]);
});
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverStarcraft2MatchesVideogameTitleRequest = z.lazy(() => {
  return z.union([z.number(), z.string()]);
});
