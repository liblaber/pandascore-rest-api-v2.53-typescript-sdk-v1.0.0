 ...
 */
export const rangeOverRlPlayers: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {RangeOverRlPlayers} rangeOverRlPlayers
 * @property {string[]}
 * @property {string[]}
 * @property {number[]}
 * @property {string[]}
 ...
 * @property {string[]}
 */
export type RangeOverRlPlayers = z.infer<typeof rangeOverRlPlayers>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverRlPlayersResponse: any = z.lazy(() => {
  return z
    .object({
      birthday: z.array(z.string()).min(2).max(2).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverRlPlayersRequest: any = z.lazy(() => {
  return z
    .object({
