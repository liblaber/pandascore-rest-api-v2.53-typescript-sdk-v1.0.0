 ...
 */
export const searchOverRlPlayers: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {SearchOverRlPlayers} searchOverRlPlayers
 ...
 */
export type SearchOverRlPlayers = z.infer<typeof searchOverRlPlayers>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverRlPlayersResponse: any = z.lazy(() => {
  return z
    .object({
      birthday: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverRlPlayersRequest: any = z.lazy(() => {
  return z
    .object({
