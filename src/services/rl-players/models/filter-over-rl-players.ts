 ...
 */
export const filterOverRlPlayers: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {FilterOverRlPlayers} filterOverRlPlayers
 ...
 */
export type FilterOverRlPlayers = z.infer<typeof filterOverRlPlayers>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverRlPlayersResponse: any = z.lazy(() => {
  return z
    .object({
      active: z.boolean().optional(),
      birthday: z.array(z.string()).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverRlPlayersRequest: any = z.lazy(() => {
  return z
    .object({
