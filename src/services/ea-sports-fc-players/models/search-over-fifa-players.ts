 ...
 */
export const searchOverFifaPlayers: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {SearchOverFifaPlayers} searchOverFifaPlayers
 ...
 */
export type SearchOverFifaPlayers = z.infer<typeof searchOverFifaPlayers>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverFifaPlayersResponse: any = z.lazy(() => {
  return z
    .object({
      birthday: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverFifaPlayersRequest: any = z.lazy(() => {
  return z
    .object({
