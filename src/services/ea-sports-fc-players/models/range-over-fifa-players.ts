 ...
 */
export const rangeOverFifaPlayers: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {RangeOverFifaPlayers} rangeOverFifaPlayers
 * @property {string[]}
 * @property {string[]}
 * @property {number[]}
 * @property {string[]}
 ...
 * @property {string[]}
 */
export type RangeOverFifaPlayers = z.infer<typeof rangeOverFifaPlayers>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverFifaPlayersResponse: any = z.lazy(() => {
  return z
    .object({
      birthday: z.array(z.string()).min(2).max(2).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverFifaPlayersRequest: any = z.lazy(() => {
  return z
    .object({
