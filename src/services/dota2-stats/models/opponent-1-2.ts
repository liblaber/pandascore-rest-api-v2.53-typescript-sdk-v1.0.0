 ...
 */
export const opponent1_2: any = z.lazy(() => {
  return z.object({
    active: z.boolean(),
...
/**
 *
 * @typedef  {Opponent1_2} opponent1_2
 ...
 */
export type Opponent1_2 = z.infer<typeof opponent1_2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const opponent1_2Response: any = z.lazy(() => {
  return z
    .object({
      active: z.boolean(),
      age: z.number().gte(0).nullable(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const opponent1_2Request: any = z.lazy(() => {
  return z
    .object({
