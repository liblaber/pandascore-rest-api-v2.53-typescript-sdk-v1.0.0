 ...
 */
export const dota2StatsForTeamByTournament: any = z.lazy(() => {
  return z.object({
 ...
 */
export const dota2StatsForTeamByTournamentResponse: any = z.lazy(() => {
  return z
    .object({
      acronym: z.string().nullable(),
      id: z.number().gte(1),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const dota2StatsForTeamByTournamentRequest: any = z.lazy(() => {
  return z
    .object({
