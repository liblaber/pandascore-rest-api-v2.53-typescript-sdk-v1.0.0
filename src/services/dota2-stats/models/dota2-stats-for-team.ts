...
import {
  dota2TotalTeamStat,
  dota2TotalTeamStatRequest,
  dota2TotalTeamStatResponse,
} from './dota2-total-team-stat';

/**
 * The shape of the model inside the application code - what the users use
 */
export const dota2StatsForTeam = z.object({
  acronym: z.string(),
  id: z.number().gte(1),
  imageUrl: z.string(),
 ...
 */
export const dota2StatsForTeamResponse = z
  .object({
    acronym: z.string(),
    id: z.number().gte(1),
    image_url: z.string(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const dota2StatsForTeamRequest = z
  .object({
