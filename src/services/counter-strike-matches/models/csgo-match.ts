...
import {
  csgoMatchPlayer,
  csgoMatchPlayerRequest,
  csgoMatchPlayerResponse,
} from './csgo-match-player';
...
import {
  csgoMatchWinner,
  csgoMatchWinnerRequest,
  csgoMatchWinnerResponse,
} from './csgo-match-winner';
import {
  csgoMatchWinnerId,
  csgoMatchWinnerIdRequest,
  csgoMatchWinnerIdResponse,
} from './csgo-match-winner-id';
import { matchWinnerType } from '../../common/match-winner-type';

/**
 * The shape of the model inside the application code - what the users use
 */
export const csgoMatch = z.object({
 ...
 */
export const csgoMatchResponse = z
  .object({
    ...
    videogame_title: csgoMatchVideogameTitleResponse,
    videogame_version: csgoMatchVideogameVersionResponse,
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const csgoMatchRequest = z
  .object({
