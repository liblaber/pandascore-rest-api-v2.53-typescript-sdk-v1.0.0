...
import {
  csgoMatchGamePlayer,
  csgoMatchGamePlayerRequest,
  csgoMatchGamePlayerResponse,
} from './csgo-match-game-player';
import {
  csgoRoundsScore,
  csgoRoundsScoreRequest,
  csgoRoundsScoreResponse,
} from '../../common/csgo-rounds-score';
 ...
 */
export const csgoMatchGame = z.object({
  ...
  players: z.array(csgoMatchGamePlayer),
 ...
 */
export const csgoMatchGameResponse = z
  .object({
    ...
    players: z.array(csgoMatchGamePlayerResponse),
    position: z.number().gte(1),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const csgoMatchGameRequest = z
  .object({
