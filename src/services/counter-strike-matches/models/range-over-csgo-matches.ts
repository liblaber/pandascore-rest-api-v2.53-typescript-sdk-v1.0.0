 ...
 */
export const rangeOverCsgoMatches: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {RangeOverCsgoMatches} rangeOverCsgoMatches
 * @property {string[]}
 * @property {boolean[]}
 * @property {boolean[]}
 * @property {string[]}
 ...
 */
export type RangeOverCsgoMatches = z.infer<typeof rangeOverCsgoMatches>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverCsgoMatchesResponse: any = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverCsgoMatchesRequest: any = z.lazy(() => {
  return z
    .object({
