...
import {
  ...
  filterOverCsgoMatchesOpponentIdRequest,
  filterOverCsgoMatchesOpponentIdResponse,
} from './filter-over-csgo-matches-opponent-id';
...
import {
  ...
  filterOverCsgoMatchesVideogameTitleRequest,
  filterOverCsgoMatchesVideogameTitleResponse,
} from './filter-over-csgo-matches-videogame-title';
import {
  filterOverCsgoMatchesVideogameVersion,
  filterOverCsgoMatchesVideogameVersionRequest,
  filterOverCsgoMatchesVideogameVersionResponse,
} from './filter-over-csgo-matches-videogame-version';
 ...
 */
export const filterOverCsgoMatches: any = z.lazy(() => {
  return z.object({
    ...
    opponentId: z.array(filterOverCsgoMatchesOpponentId).min(1).optional(),
    ...
    videogameTitle: z.array(filterOverCsgoMatchesVideogameTitle).min(1).optional(),
    videogameVersion: z.array(filterOverCsgoMatchesVideogameVersion).min(1).optional(),
...
/**
 *
 * @typedef  {FilterOverCsgoMatches} filterOverCsgoMatches
 * @property {string[]}
 ...
 * @property {boolean}
 * @property {number[]}
 * @property {FilterOverCsgoMatchesOpponentId[]} - A Team or a Player (id or slug). You can use`filter[winner_type]=Team` or `filter[winner_type]=Player` to focus on teams or players.
 ...
 * @property {FilterOverCsgoMatchesVideogameTitle[]} - A videogame title id or slug. <br/>Only for `/csgo/*`, `/codmw/*`, `/fifa/*` and `/ow/*` endpoints <br/>
 * @property {FilterOverCsgoMatchesVideogameVersion[]} - Filter by the names of videogame versions, all versions using `filter[videogame_version]=all`, or by the latest version using `filter[videogame_version]=latest` <br/>Only for `valorant/*` and `/lol/*` endpoints. <br/>
 * @property {OpponentId[]}
 * @property {MatchWinnerType[]}
 */
export type FilterOverCsgoMatches = z.infer<typeof filterOverCsgoMatches>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverCsgoMatchesResponse: any = z.lazy(() => {
  return z
    .object({
      ...
      opponent_id: z.array(filterOverCsgoMatchesOpponentIdResponse).min(1).optional(),
      ...
      videogame_title: z.array(filterOverCsgoMatchesVideogameTitleResponse).min(1).optional(),
      videogame_version: z.array(filterOverCsgoMatchesVideogameVersionResponse).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverCsgoMatchesRequest: any = z.lazy(() => {
  return z
    .object({
      ...
      opponentId: z.array(filterOverCsgoMatchesOpponentIdRequest).nullish(),
      ...
      videogameTitle: z.array(filterOverCsgoMatchesVideogameTitleRequest).nullish(),
      videogameVersion: z.array(filterOverCsgoMatchesVideogameVersionRequest).nullish(),
