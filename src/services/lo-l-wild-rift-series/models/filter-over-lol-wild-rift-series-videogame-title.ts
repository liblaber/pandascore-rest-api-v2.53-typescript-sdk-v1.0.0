 ...
 */
export const filterOverLolWildRiftSeriesVideogameTitle = z.lazy(() => {
 ...
 */
export const filterOverLolWildRiftSeriesVideogameTitleResponse = z.lazy(() => {
  return z.union([z.number(), z.string()]);
});
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverLolWildRiftSeriesVideogameTitleRequest = z.lazy(() => {
  return z.union([z.number(), z.string()]);
});
