 ...
 */
export const rangeOverLolWildRiftSeries: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {RangeOverLolWildRiftSeries} rangeOverLolWildRiftSeries
 * @property {string[]}
 * @property {string[]}
 * @property {number[]}
 * @property {number[]}
 ...
 * @property {number[]}
 */
export type RangeOverLolWildRiftSeries = z.infer<typeof rangeOverLolWildRiftSeries>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverLolWildRiftSeriesResponse: any = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverLolWildRiftSeriesRequest: any = z.lazy(() => {
  return z
    .object({
