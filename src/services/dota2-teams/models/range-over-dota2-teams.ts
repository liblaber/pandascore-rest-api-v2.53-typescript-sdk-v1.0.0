 ...
 */
export const rangeOverDota2Teams: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {RangeOverDota2Teams} rangeOverDota2Teams
 * @property {string[]}
 * @property {number[]}
 * @property {string[]}
 * @property {string[]}
 ...
 * @property {string[]}
 */
export type RangeOverDota2Teams = z.infer<typeof rangeOverDota2Teams>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverDota2TeamsResponse: any = z.lazy(() => {
  return z
    .object({
      acronym: z.array(z.string()).min(2).max(2).optional(),
      id: z.array(z.number()).min(2).max(2).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverDota2TeamsRequest: any = z.lazy(() => {
  return z
    .object({
