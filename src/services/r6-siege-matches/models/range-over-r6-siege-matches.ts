 ...
 */
export const rangeOverR6SiegeMatches: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {RangeOverR6SiegeMatches} rangeOverR6SiegeMatches
 * @property {string[]}
 * @property {boolean[]}
 * @property {boolean[]}
 * @property {string[]}
 ...
 */
export type RangeOverR6SiegeMatches = z.infer<typeof rangeOverR6SiegeMatches>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverR6SiegeMatchesResponse: any = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverR6SiegeMatchesRequest: any = z.lazy(() => {
  return z
    .object({
