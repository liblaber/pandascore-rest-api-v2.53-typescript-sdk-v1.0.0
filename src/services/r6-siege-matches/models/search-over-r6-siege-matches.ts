 ...
 */
export const searchOverR6SiegeMatches: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {SearchOverR6SiegeMatches} searchOverR6SiegeMatches
 * @property {MatchType}
 * @property {string}
 * @property {string}
 ...
 */
export type SearchOverR6SiegeMatches = z.infer<typeof searchOverR6SiegeMatches>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverR6SiegeMatchesResponse: any = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverR6SiegeMatchesRequest: any = z.lazy(() => {
  return z
    .object({
