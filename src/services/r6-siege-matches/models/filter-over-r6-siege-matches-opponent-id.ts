 ...
 */
export const filterOverR6SiegeMatchesOpponentId = z.lazy(() => {
 ...
 */
export const filterOverR6SiegeMatchesOpponentIdResponse = z.lazy(() => {
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverR6SiegeMatchesOpponentIdRequest = z.lazy(() => {
