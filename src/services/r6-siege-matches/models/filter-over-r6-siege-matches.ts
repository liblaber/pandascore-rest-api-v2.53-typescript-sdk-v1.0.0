...
import {
  ...
  filterOverR6SiegeMatchesOpponentIdRequest,
  filterOverR6SiegeMatchesOpponentIdResponse,
} from './filter-over-r6-siege-matches-opponent-id';
...
import {
  ...
  filterOverR6SiegeMatchesVideogameTitleRequest,
  filterOverR6SiegeMatchesVideogameTitleResponse,
} from './filter-over-r6-siege-matches-videogame-title';
import {
  filterOverR6SiegeMatchesVideogameVersion,
  filterOverR6SiegeMatchesVideogameVersionRequest,
  filterOverR6SiegeMatchesVideogameVersionResponse,
} from './filter-over-r6-siege-matches-videogame-version';
 ...
 */
export const filterOverR6SiegeMatches: any = z.lazy(() => {
  return z.object({
    ...
    opponentId: z.array(filterOverR6SiegeMatchesOpponentId).min(1).optional(),
    ...
    videogameTitle: z.array(filterOverR6SiegeMatchesVideogameTitle).min(1).optional(),
    videogameVersion: z.array(filterOverR6SiegeMatchesVideogameVersion).min(1).optional(),
...
/**
 *
 * @typedef  {FilterOverR6SiegeMatches} filterOverR6SiegeMatches
 * @property {string[]}
 ...
 * @property {boolean}
 * @property {number[]}
 * @property {FilterOverR6SiegeMatchesOpponentId[]} - A Team or a Player (id or slug). You can use`filter[winner_type]=Team` or `filter[winner_type]=Player` to focus on teams or players.
 ...
 * @property {FilterOverR6SiegeMatchesVideogameTitle[]} - A videogame title id or slug. <br/>Only for `/csgo/*`, `/codmw/*`, `/fifa/*` and `/ow/*` endpoints <br/>
 * @property {FilterOverR6SiegeMatchesVideogameVersion[]} - Filter by the names of videogame versions, all versions using `filter[videogame_version]=all`, or by the latest version using `filter[videogame_version]=latest` <br/>Only for `valorant/*` and `/lol/*` endpoints. <br/>
 * @property {OpponentId[]}
 * @property {MatchWinnerType[]}
 */
export type FilterOverR6SiegeMatches = z.infer<typeof filterOverR6SiegeMatches>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverR6SiegeMatchesResponse: any = z.lazy(() => {
  return z
    .object({
      ...
      opponent_id: z.array(filterOverR6SiegeMatchesOpponentIdResponse).min(1).optional(),
      ...
      videogame_title: z.array(filterOverR6SiegeMatchesVideogameTitleResponse).min(1).optional(),
      videogame_version: z.array(filterOverR6SiegeMatchesVideogameVersionResponse).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverR6SiegeMatchesRequest: any = z.lazy(() => {
  return z
    .object({
      ...
      opponentId: z.array(filterOverR6SiegeMatchesOpponentIdRequest).nullish(),
      ...
      videogameTitle: z.array(filterOverR6SiegeMatchesVideogameTitleRequest).nullish(),
      videogameVersion: z.array(filterOverR6SiegeMatchesVideogameVersionRequest).nullish(),
