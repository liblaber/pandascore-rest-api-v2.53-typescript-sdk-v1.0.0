 ...
 */
export const rangeOverStarcraftBroodWarPlayers = z.object({
 ...
 */
export const rangeOverStarcraftBroodWarPlayersResponse = z
  .object({
    birthday: z.array(z.string()).min(2).max(2).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverStarcraftBroodWarPlayersRequest = z
  .object({
