 ...
 */
export const rangeOverStarcraftBroodWarPlayers: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {RangeOverStarcraftBroodWarPlayers} rangeOverStarcraftBroodWarPlayers
 * @property {string[]}
 * @property {string[]}
 * @property {number[]}
 * @property {string[]}
 ...
 * @property {string[]}
 */
export type RangeOverStarcraftBroodWarPlayers = z.infer<typeof rangeOverStarcraftBroodWarPlayers>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverStarcraftBroodWarPlayersResponse: any = z.lazy(() => {
  return z
    .object({
      birthday: z.array(z.string()).min(2).max(2).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverStarcraftBroodWarPlayersRequest: any = z.lazy(() => {
  return z
    .object({
