 ...
 */
export const searchOverStarcraftBroodWarPlayers = z.object({
 ...
 */
export const searchOverStarcraftBroodWarPlayersResponse = z
  .object({
    birthday: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverStarcraftBroodWarPlayersRequest = z
  .object({
