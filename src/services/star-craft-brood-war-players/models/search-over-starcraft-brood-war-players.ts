 ...
 */
export const searchOverStarcraftBroodWarPlayers: any = z.lazy(() => {
  return z.object({
 ...
 */
export const searchOverStarcraftBroodWarPlayersResponse: any = z.lazy(() => {
  return z
    .object({
      birthday: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverStarcraftBroodWarPlayersRequest: any = z.lazy(() => {
  return z
    .object({
