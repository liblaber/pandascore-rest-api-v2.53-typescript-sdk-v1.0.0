 ...
 */
export const filterOverStarcraftBroodWarPlayers: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {FilterOverStarcraftBroodWarPlayers} filterOverStarcraftBroodWarPlayers
 ...
 */
export type FilterOverStarcraftBroodWarPlayers = z.infer<typeof filterOverStarcraftBroodWarPlayers>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverStarcraftBroodWarPlayersResponse: any = z.lazy(() => {
  return z
    .object({
      active: z.boolean().optional(),
      birthday: z.array(z.string()).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverStarcraftBroodWarPlayersRequest: any = z.lazy(() => {
  return z
    .object({
