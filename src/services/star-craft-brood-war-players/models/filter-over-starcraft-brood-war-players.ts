 ...
 */
export const filterOverStarcraftBroodWarPlayers = z.object({
 ...
 */
export const filterOverStarcraftBroodWarPlayersResponse = z
  .object({
    active: z.boolean().optional(),
    birthday: z.array(z.string()).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverStarcraftBroodWarPlayersRequest = z
  .object({
