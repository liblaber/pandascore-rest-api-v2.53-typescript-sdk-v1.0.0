 ...
 */
export const rangeOverOwSeries: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {RangeOverOwSeries} rangeOverOwSeries
 * @property {string[]}
 * @property {string[]}
 * @property {number[]}
 * @property {number[]}
 ...
 * @property {number[]}
 */
export type RangeOverOwSeries = z.infer<typeof rangeOverOwSeries>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverOwSeriesResponse: any = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverOwSeriesRequest: any = z.lazy(() => {
  return z
    .object({
