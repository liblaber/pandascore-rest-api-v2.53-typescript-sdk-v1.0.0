...
import {
  ...
  filterOverOwSeriesVideogameTitleRequest,
  filterOverOwSeriesVideogameTitleResponse,
} from './filter-over-ow-series-videogame-title';
 ...
 */
export const filterOverOwSeries: any = z.lazy(() => {
  return z.object({
    ...
    videogameTitle: z.array(filterOverOwSeriesVideogameTitle).min(1).optional(),
...
/**
 *
 * @typedef  {FilterOverOwSeries} filterOverOwSeries
 * @property {string[]}
 * @property {string[]}
 * @property {number[]}
 * @property {number[]}
 ...
 * @property {string[]}
 * @property {string[]}
 * @property {FilterOverOwSeriesVideogameTitle[]} - A videogame title id or slug. <br/>Only for `/csgo/*`, `/codmw/*`, `/fifa/*` and `/ow/*` endpoints <br/>
 * @property {OpponentId[]}
 * @property {OpponentType[]}
 * @property {number[]}
 */
export type FilterOverOwSeries = z.infer<typeof filterOverOwSeries>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverOwSeriesResponse: any = z.lazy(() => {
  return z
    .object({
      ...
      season: z.array(z.string()).min(1).optional(),
      slug: z.array(z.string()).min(1).optional(),
      videogame_title: z.array(filterOverOwSeriesVideogameTitleResponse).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverOwSeriesRequest: any = z.lazy(() => {
  return z
    .object({
      ...
      videogameTitle: z.array(filterOverOwSeriesVideogameTitleRequest).nullish(),
