 ...
 */
export const rangeOverDota2ShortTournaments = z.lazy(() => {
  return z.object({
 ...
 */
export const rangeOverDota2ShortTournamentsResponse = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverDota2ShortTournamentsRequest = z.lazy(() => {
  return z
    .object({
