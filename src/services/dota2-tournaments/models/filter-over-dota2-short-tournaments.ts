 ...
 */
export const filterOverDota2ShortTournaments = z.lazy(() => {
  return z.object({
 ...
 */
export const filterOverDota2ShortTournamentsResponse = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverDota2ShortTournamentsRequest = z.lazy(() => {
  return z
    .object({
