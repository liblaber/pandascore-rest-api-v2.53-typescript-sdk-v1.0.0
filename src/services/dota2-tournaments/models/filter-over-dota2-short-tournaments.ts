...
import {
  ...
  filterOverDota2ShortTournamentsVideogameTitleRequest,
  filterOverDota2ShortTournamentsVideogameTitleResponse,
} from './filter-over-dota2-short-tournaments-videogame-title';
 ...
 */
export const filterOverDota2ShortTournaments: any = z.lazy(() => {
  return z.object({
    ...
    videogameTitle: z.array(filterOverDota2ShortTournamentsVideogameTitle).min(1).optional(),
...
/**
 *
 * @typedef  {FilterOverDota2ShortTournaments} filterOverDota2ShortTournaments
 * @property {string[]}
 ...
 * @property {FilterOverDota2ShortTournamentsVideogameTitle[]} - A videogame title id or slug. <br/>Only for `/csgo/*`, `/codmw/*`, `/fifa/*` and `/ow/*` endpoints <br/>
 * @property {OpponentId[]}
 * @property {OpponentType[]}
 */
export type FilterOverDota2ShortTournaments = z.infer<typeof filterOverDota2ShortTournaments>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverDota2ShortTournamentsResponse: any = z.lazy(() => {
  return z
    .object({
      ...
      slug: z.array(z.string()).min(1).optional(),
      tier: z.array(searchOverValorantShortTournamentsTier2).min(1).optional(),
      videogame_title: z.array(filterOverDota2ShortTournamentsVideogameTitleResponse).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverDota2ShortTournamentsRequest: any = z.lazy(() => {
  return z
    .object({
      ...
      videogameTitle: z.array(filterOverDota2ShortTournamentsVideogameTitleRequest).nullish(),
