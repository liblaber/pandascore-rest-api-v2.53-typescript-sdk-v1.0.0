 ...
 */
export const searchOverStarcraft2Series = z.lazy(() => {
  return z.object({
 ...
 */
export const searchOverStarcraft2SeriesResponse = z.lazy(() => {
  return z
    .object({
      name: z.string().optional(),
      season: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverStarcraft2SeriesRequest = z.lazy(() => {
  return z
    .object({
