 ...
 */
export const rangeOverStarcraft2Series: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {RangeOverStarcraft2Series} rangeOverStarcraft2Series
 * @property {string[]}
 * @property {string[]}
 * @property {number[]}
 * @property {number[]}
 ...
 * @property {number[]}
 */
export type RangeOverStarcraft2Series = z.infer<typeof rangeOverStarcraft2Series>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverStarcraft2SeriesResponse: any = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverStarcraft2SeriesRequest: any = z.lazy(() => {
  return z
    .object({
