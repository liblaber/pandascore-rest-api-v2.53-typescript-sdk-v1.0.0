 ...
 */
export const rangeOverStarcraft2Series = z.lazy(() => {
  return z.object({
 ...
 */
export const rangeOverStarcraft2SeriesResponse = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverStarcraft2SeriesRequest = z.lazy(() => {
  return z
    .object({
