...
import {
  ...
  filterOverStarcraft2SeriesVideogameTitleRequest,
  filterOverStarcraft2SeriesVideogameTitleResponse,
} from './filter-over-starcraft2-series-videogame-title';
 ...
 */
export const filterOverStarcraft2Series: any = z.lazy(() => {
  return z.object({
    ...
    videogameTitle: z.array(filterOverStarcraft2SeriesVideogameTitle).min(1).optional(),
...
/**
 *
 * @typedef  {FilterOverStarcraft2Series} filterOverStarcraft2Series
 * @property {string[]}
 * @property {string[]}
 * @property {number[]}
 * @property {number[]}
 ...
 * @property {string[]}
 * @property {string[]}
 * @property {FilterOverStarcraft2SeriesVideogameTitle[]} - A videogame title id or slug. <br/>Only for `/csgo/*`, `/codmw/*`, `/fifa/*` and `/ow/*` endpoints <br/>
 * @property {OpponentId[]}
 * @property {OpponentType[]}
 * @property {number[]}
 */
export type FilterOverStarcraft2Series = z.infer<typeof filterOverStarcraft2Series>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverStarcraft2SeriesResponse: any = z.lazy(() => {
  return z
    .object({
      ...
      season: z.array(z.string()).min(1).optional(),
      slug: z.array(z.string()).min(1).optional(),
      videogame_title: z.array(filterOverStarcraft2SeriesVideogameTitleResponse).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverStarcraft2SeriesRequest: any = z.lazy(() => {
  return z
    .object({
      ...
      videogameTitle: z.array(filterOverStarcraft2SeriesVideogameTitleRequest).nullish(),
