 ...
 */
export const rangeOverPubgShortTournaments = z.object({
 ...
 */
export const rangeOverPubgShortTournamentsResponse = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverPubgShortTournamentsRequest = z
  .object({
