 ...
 */
export const searchOverLolWildRiftMatches = z.object({
 ...
 */
export const searchOverLolWildRiftMatchesResponse = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverLolWildRiftMatchesRequest = z
  .object({
