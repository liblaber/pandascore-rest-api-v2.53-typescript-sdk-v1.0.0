 ...
 */
export const videogameRocketLeague = z.object({
...
/**
 *
 * @typedef  {VideogameRocketLeague} videogameRocketLeague
 * @property {string}
 * @property {any}
 ...
 * @property {any}
 */
export type VideogameRocketLeague = z.infer<typeof videogameRocketLeague>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const videogameRocketLeagueResponse = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const videogameRocketLeagueRequest = z
  .object({
