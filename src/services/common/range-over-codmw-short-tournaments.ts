 ...
 */
export const rangeOverCodmwShortTournaments = z.object({
 ...
 */
export const rangeOverCodmwShortTournamentsResponse = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverCodmwShortTournamentsRequest = z
  .object({
