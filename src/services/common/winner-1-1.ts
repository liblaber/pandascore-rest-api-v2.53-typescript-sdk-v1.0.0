 ...
 */
export const winner1_1: any = z.lazy(() => {
  return z.object({
    active: z.boolean(),
 ...
 */
export type Winner1_1 = z.infer<typeof winner1_1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const winner1_1Response: any = z.lazy(() => {
  return z
    .object({
      active: z.boolean(),
      age: z.number().gte(0).nullable(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const winner1_1Request: any = z.lazy(() => {
  return z
    .object({
