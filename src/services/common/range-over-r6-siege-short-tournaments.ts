 ...
 */
export const rangeOverR6SiegeShortTournaments = z.object({
 ...
 */
export const rangeOverR6SiegeShortTournamentsResponse = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverR6SiegeShortTournamentsRequest = z
  .object({
