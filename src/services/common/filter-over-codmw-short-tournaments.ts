 ...
 */
export const filterOverCodmwShortTournaments = z.object({
 ...
 */
export const filterOverCodmwShortTournamentsResponse = z
  .object({
    ...
    tier: z.array(searchOverValorantShortTournamentsTier2).min(1).optional(),
    videogame_title: z
      .array(filterOverCodmwShortTournamentsVideogameTitleResponse)
      .min(1)
      .optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverCodmwShortTournamentsRequest = z
  .object({
