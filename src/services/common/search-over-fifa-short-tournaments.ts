 ...
 */
export const searchOverFifaShortTournaments = z.object({
 ...
 */
export const searchOverFifaShortTournamentsResponse = z
  .object({
    name: z.string().optional(),
    prizepool: z.string().optional(),
    slug: z
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverFifaShortTournamentsRequest = z
  .object({
