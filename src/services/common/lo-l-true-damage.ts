 ...
 */
export const loLTrueDamage: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {LoLTrueDamage} loLTrueDamage
 * @property {number}
 ...
 * @property {number}
 */
export type LoLTrueDamage = z.infer<typeof loLTrueDamage>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const loLTrueDamageResponse: any = z.lazy(() => {
  return z
    .object({
      dealt: z.number().gte(0).nullable(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const loLTrueDamageRequest: any = z.lazy(() => {
  return z
    .object({
