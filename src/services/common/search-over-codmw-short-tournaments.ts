 ...
 */
export const searchOverCodmwShortTournaments = z.object({
 ...
 */
export const searchOverCodmwShortTournamentsResponse = z
  .object({
    name: z.string().optional(),
    prizepool: z.string().optional(),
    slug: z
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverCodmwShortTournamentsRequest = z
  .object({
