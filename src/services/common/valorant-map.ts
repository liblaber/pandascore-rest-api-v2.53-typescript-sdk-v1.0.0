 ...
 */
export const valorantMap = z.object({
  id: z.number().gte(1),
  imageUrl: z.string(),
  name: z.string(),
  slug: z
 ...
 * @typedef  {ValorantMap} valorantMap - An object that represents a Valorant map - An object that represents a Valorant map
 ...
 */
export const valorantMapResponse = z
  .object({
    id: z.number().gte(1),
    image_url: z.string(),
    name: z.string(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const valorantMapRequest = z
  .object({
    id: z.number().nullish(),
