 ...
 */
export const filterOverOwShortTournaments = z.object({
 ...
 */
export const filterOverOwShortTournamentsResponse = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverOwShortTournamentsRequest = z
  .object({
