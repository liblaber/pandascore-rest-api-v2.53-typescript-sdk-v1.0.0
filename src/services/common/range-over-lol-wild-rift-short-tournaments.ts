 ...
 */
export const rangeOverLolWildRiftShortTournaments = z.object({
 ...
 */
export type RangeOverLolWildRiftShortTournaments = z.infer<
  typeof rangeOverLolWildRiftShortTournaments
>;
 ...
 */
export const rangeOverLolWildRiftShortTournamentsResponse = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverLolWildRiftShortTournamentsRequest = z
  .object({
