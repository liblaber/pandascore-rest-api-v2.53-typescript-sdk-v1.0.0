 ...
 */
export const rangeOverStarcraft2ShortTournaments = z.object({
 ...
 */
export type RangeOverStarcraft2ShortTournaments = z.infer<
  typeof rangeOverStarcraft2ShortTournaments
>;
 ...
 */
export const rangeOverStarcraft2ShortTournamentsResponse = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverStarcraft2ShortTournamentsRequest = z
  .object({
