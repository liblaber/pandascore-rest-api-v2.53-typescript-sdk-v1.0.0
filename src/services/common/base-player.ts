 ...
 */
export const basePlayer: any = z.lazy(() => {
  return z.object({
    active: z.boolean(),
 ...
 */
export type BasePlayer = z.infer<typeof basePlayer>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const basePlayerResponse: any = z.lazy(() => {
  return z
    .object({
      active: z.boolean(),
      age: z.number().gte(0).nullable(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const basePlayerRequest: any = z.lazy(() => {
  return z
    .object({
