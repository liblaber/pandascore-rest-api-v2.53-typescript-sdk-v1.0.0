 ...
 */
export const tournamentVideogameTitle: any = z.lazy(() => {
  return z.object({
    id: z.number().gte(1),
    name: z.string(),
    slug: z
 ...
 */
export const tournamentVideogameTitleResponse: any = z.lazy(() => {
  return z
    .object({
      id: z.number().gte(1),
      name: z.string(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const tournamentVideogameTitleRequest: any = z.lazy(() => {
  return z
    .object({
      id: z.number().nullish(),
