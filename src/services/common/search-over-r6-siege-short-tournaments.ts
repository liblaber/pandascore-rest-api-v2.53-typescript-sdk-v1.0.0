 ...
 */
export const searchOverR6SiegeShortTournaments = z.object({
 ...
 */
export const searchOverR6SiegeShortTournamentsResponse = z
  .object({
    name: z.string().optional(),
    prizepool: z.string().optional(),
    slug: z
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverR6SiegeShortTournamentsRequest = z
  .object({
