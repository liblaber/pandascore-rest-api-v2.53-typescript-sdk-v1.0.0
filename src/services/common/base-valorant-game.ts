...
import {
  baseValorantGameMap,
  baseValorantGameMapRequest,
  baseValorantGameMapResponse,
} from './base-valorant-game-map';
import {
  valorantGameRound,
 ...
 */
export const baseValorantGame = z.object({
 ...
 */
export const baseValorantGameResponse = z
  .object({
    ...
    id: z.number().gte(1),
    length: z.number().gte(0),
    map: baseValorantGameMapResponse,
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const baseValorantGameRequest = z
  .object({
