 ...
 */
export const rangeOverStarcraftBroodWarShortTournaments = z.object({
 ...
 */
export type RangeOverStarcraftBroodWarShortTournaments = z.infer<
  typeof rangeOverStarcraftBroodWarShortTournaments
>;
 ...
 */
export const rangeOverStarcraftBroodWarShortTournamentsResponse = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverStarcraftBroodWarShortTournamentsRequest = z
  .object({
