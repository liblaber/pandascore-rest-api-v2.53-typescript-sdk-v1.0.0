 ...
 */
export const dota2GamePlayerOpponent = z.union([opponent1_2, opponent2_2]);
 ...
 */
export const dota2GamePlayerOpponentResponse = z.union([opponent1_2Response, opponent2_2Response]);

/**
 * The shape of the model mapping from the application shape into the api schema.
 * Is equal to application shape if all property names match the api schema
 */
export const dota2GamePlayerOpponentRequest = z.union([opponent1_2Request, opponent2_2Request]);
