...
} from './videogame-e-cricket';

/**
 * The shape of the model inside the application code - what the users use
 */
export const videogame = z.union([
  videogameLoL,
  videogameCsgo,
  videogameDota2,
  videogameOverwatch,
 ...
 */
export const videogameResponse = z.union([
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const videogameRequest = z.union([
  videogameLoLRequest,
