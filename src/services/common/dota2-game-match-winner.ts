 ...
 */
export const dota2GameMatchWinner = z.union([winner1_4, winner2_4]);
 ...
 */
export const dota2GameMatchWinnerResponse = z.union([winner1_4Response, winner2_4Response]);

/**
 * The shape of the model mapping from the application shape into the api schema.
 * Is equal to application shape if all property names match the api schema
 */
export const dota2GameMatchWinnerRequest = z.union([winner1_4Request, winner2_4Request]);
