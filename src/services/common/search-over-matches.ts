 ...
 */
export const searchOverMatches: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {SearchOverMatches} searchOverMatches
 * @property {MatchType}
 * @property {string}
 * @property {string}
 ...
 */
export type SearchOverMatches = z.infer<typeof searchOverMatches>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverMatchesResponse: any = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverMatchesRequest: any = z.lazy(() => {
  return z
    .object({
