 ...
 */
export const filterOverStarcraftBroodWarMatches = z.object({
 ...
 */
export const filterOverStarcraftBroodWarMatchesResponse = z
  .object({
    ...
    videogame_title: z
      .array(filterOverStarcraftBroodWarMatchesVideogameTitleResponse)
      .min(1)
      .optional(),
    videogame_version: z
      .array(filterOverStarcraftBroodWarMatchesVideogameVersionResponse)
      .min(1)
      .optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverStarcraftBroodWarMatchesRequest = z
  .object({
