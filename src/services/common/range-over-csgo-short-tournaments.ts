 ...
 */
export const rangeOverCsgoShortTournaments = z.object({
 ...
 */
export const rangeOverCsgoShortTournamentsResponse = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverCsgoShortTournamentsRequest = z
  .object({
