 ...
 */
export const filterOverRlShortTournaments = z.object({
 ...
 */
export const filterOverRlShortTournamentsResponse = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverRlShortTournamentsRequest = z
  .object({
