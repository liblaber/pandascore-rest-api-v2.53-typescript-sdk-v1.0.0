 ...
 */
export const searchOverStarcraftBroodWarShortTournaments = z.object({
 ...
 */
export type SearchOverStarcraftBroodWarShortTournaments = z.infer<
  typeof searchOverStarcraftBroodWarShortTournaments
>;
 ...
 */
export const searchOverStarcraftBroodWarShortTournamentsResponse = z
  .object({
    name: z.string().optional(),
    prizepool: z.string().optional(),
    slug: z
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverStarcraftBroodWarShortTournamentsRequest = z
  .object({
