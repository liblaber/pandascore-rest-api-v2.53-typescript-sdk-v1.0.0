 ...
 */
export const filterOverCsgoShortTournaments = z.object({
 ...
 */
export const filterOverCsgoShortTournamentsResponse = z
  .object({
    ...
    tier: z.array(searchOverValorantShortTournamentsTier2).min(1).optional(),
    videogame_title: z
      .array(filterOverCsgoShortTournamentsVideogameTitleResponse)
      .min(1)
      .optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverCsgoShortTournamentsRequest = z
  .object({
