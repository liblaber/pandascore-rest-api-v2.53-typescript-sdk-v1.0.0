 ...
 */
export const rangeOverValorantShortTournaments = z.object({
 ...
 */
export const rangeOverValorantShortTournamentsResponse = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverValorantShortTournamentsRequest = z
  .object({
