 ...
 */
export const filterOverShortTournaments = z.lazy(() => {
  return z.object({
 ...
 */
export const filterOverShortTournamentsResponse = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverShortTournamentsRequest = z.lazy(() => {
  return z
    .object({
