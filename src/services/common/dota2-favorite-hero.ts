import { z } from 'zod';
import { dota2Hero, dota2HeroRequest, dota2HeroResponse } from './dota2-hero';
import { dota2UsedItem, dota2UsedItemRequest, dota2UsedItemResponse } from './dota2-used-item';

/**
 * The shape of the model inside the application code - what the users use
 */
export const dota2FavoriteHero = z.object({
 ...
 */
export const dota2FavoriteHeroResponse = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const dota2FavoriteHeroRequest = z
  .object({
