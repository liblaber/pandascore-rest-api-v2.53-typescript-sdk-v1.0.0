 ...
 */
export const rangeOverStarcraftBroodWarSeries = z.object({
 ...
 */
export const rangeOverStarcraftBroodWarSeriesResponse = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverStarcraftBroodWarSeriesRequest = z
  .object({
