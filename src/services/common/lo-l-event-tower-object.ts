 ...
 */
export const loLEventTowerObject = z.object({
 ...
 */
export const loLEventTowerObjectResponse = z
  .object({
    name: loLEventTowerValue,
    side: loLTeamColor,
  })
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const loLEventTowerObjectRequest = z
  .object({ name: loLEventTowerValue.nullish(), side: loLTeamColor.nullish() })
  .transform((data) => ({
    name: data['name'],
    side: data['side'],
  }));
