...
import {
  owGameRoundTeam,
  owGameRoundTeamRequest,
  owGameRoundTeamResponse,
} from './ow-game-round-team';

/**
 * The shape of the model inside the application code - what the users use
 */
export const owGameRound = z.object({
 ...
 */
export const owGameRoundResponse = z
  .object({
    round: z.number().gte(1),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const owGameRoundRequest = z
