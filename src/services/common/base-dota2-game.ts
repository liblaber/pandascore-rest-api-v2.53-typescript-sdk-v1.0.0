import { z } from 'zod';
import { dota2FullGamePlayer, dota2FullGamePlayerRequest, dota2FullGamePlayerResponse } from './dota2-full-game-player';
 ...
 */
export const baseDota2Game: any = z.lazy(() => {
  return z.object({
    ...
    winner: gameWinner,
    winnerType: baseDota2GameWinnerType.nullable(),
  });
});
 ...
 */
export const baseDota2GameResponse: any = z.lazy(() => {
  return z
    .object({
      ...
      winner_type: baseDota2GameWinnerType.nullable(),
    })
    .transform((data) => ({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const baseDota2GameRequest: any = z.lazy(() => {
  return z
    .object({
