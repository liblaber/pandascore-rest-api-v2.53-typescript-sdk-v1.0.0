 ...
 */
export const opponent1_3: any = z.lazy(() => {
  return z.object({
    active: z.boolean(),
...
/**
 *
 * @typedef  {Opponent1_3} opponent1_3
 ...
 */
export type Opponent1_3 = z.infer<typeof opponent1_3>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const opponent1_3Response: any = z.lazy(() => {
  return z
    .object({
      active: z.boolean(),
      age: z.number().gte(0).nullable(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const opponent1_3Request: any = z.lazy(() => {
  return z
    .object({
