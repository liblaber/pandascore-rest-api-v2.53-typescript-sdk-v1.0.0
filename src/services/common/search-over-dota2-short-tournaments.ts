 ...
 */
export const searchOverDota2ShortTournaments = z.object({
 ...
 */
export const searchOverDota2ShortTournamentsResponse = z
  .object({
    name: z.string().optional(),
    prizepool: z.string().optional(),
    slug: z
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverDota2ShortTournamentsRequest = z
  .object({
