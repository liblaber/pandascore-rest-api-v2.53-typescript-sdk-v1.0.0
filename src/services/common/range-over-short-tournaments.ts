 ...
 */
export const rangeOverShortTournaments = z.lazy(() => {
  return z.object({
 ...
 */
export const rangeOverShortTournamentsResponse = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverShortTournamentsRequest = z.lazy(() => {
  return z
    .object({
