 ...
 */
export const secondaryPathResponse = z
  .object({
    id: z.number().gte(1),
    image_url: z.string(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const secondaryPathRequest = z
  .object({
    id: z.number().nullish(),
