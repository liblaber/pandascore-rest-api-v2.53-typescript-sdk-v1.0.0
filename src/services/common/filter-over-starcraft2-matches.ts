 ...
 */
export const filterOverStarcraft2Matches = z.object({
 ...
 */
export const filterOverStarcraft2MatchesResponse = z
  .object({
    ...
    videogame_version: z
      .array(filterOverStarcraft2MatchesVideogameVersionResponse)
      .min(1)
      .optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverStarcraft2MatchesRequest = z
  .object({
