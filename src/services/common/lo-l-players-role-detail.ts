...
import {
  baseLoLChampion,
  baseLoLChampionRequest,
  baseLoLChampionResponse,
} from './base-lo-l-champion';
import { baseLoLSpell, baseLoLSpellRequest, baseLoLSpellResponse } from './base-lo-l-spell';

/**
 * The shape of the model inside the application code - what the users use
 */
export const loLPlayersRoleDetail = z.object({
 ...
 */
export const loLPlayersRoleDetailResponse = z
  .object({
    assists: z.number().gte(0),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const loLPlayersRoleDetailRequest = z
  .object({
