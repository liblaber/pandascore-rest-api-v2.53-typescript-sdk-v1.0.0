 ...
 */
export const rangeOverKogShortTournaments = z.object({
 ...
 */
export const rangeOverKogShortTournamentsResponse = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverKogShortTournamentsRequest = z
  .object({
