 ...
 */
export const csgoWeapon = z.object({
  ammoClipMax: z.number().gte(0),
  ammoMax: z.number().gte(0),
  cost: z.number().gte(0),
  id: z.number().gte(1),
  imageUrl: z.string(),
  killReward: z.number().gte(0),
  kind: csgoWeaponKind,
  name: z.string(),
  slug: z
    .string()
 ...
 */
export const csgoWeaponResponse = z
  .object({
    ammo_clip_max: z.number().gte(0),
    ammo_max: z.number().gte(0),
    cost: z.number().gte(0),
    id: z.number().gte(1),
    image_url: z.string(),
    kill_reward: z.number().gte(0),
    kind: csgoWeaponKind,
    name: z.string(),
    slug: z
      .string()
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const csgoWeaponRequest = z
  .object({
