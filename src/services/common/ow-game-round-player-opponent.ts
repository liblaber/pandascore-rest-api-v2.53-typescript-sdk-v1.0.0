 ...
 */
export const owGameRoundPlayerOpponent = z.lazy(() => {
 ...
 */
export const owGameRoundPlayerOpponentResponse = z.lazy(() => {
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const owGameRoundPlayerOpponentRequest = z.lazy(() => {
