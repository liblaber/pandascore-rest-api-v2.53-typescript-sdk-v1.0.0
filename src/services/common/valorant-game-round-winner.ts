 ...
 */
export const valorantGameRoundWinner = z.lazy(() => {
  return z.object({
    id: z.number().gte(1),
    side: z.string(),
  });
 ...
 */
export const valorantGameRoundWinnerResponse = z.lazy(() => {
  return z
    .object({
      id: z.number().gte(1),
      side: z.string(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const valorantGameRoundWinnerRequest = z.lazy(() => {
  return z.object({ id: z.number().nullish(), side: z.string().nullish() }).transform((data) => ({
    id: data['id'],
    side: data['side'],
  }));
});
