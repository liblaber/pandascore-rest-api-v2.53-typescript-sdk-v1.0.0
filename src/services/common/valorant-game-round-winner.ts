 ...
 */
export const valorantGameRoundWinner: any = z.lazy(() => {
  return z.object({
    id: z.number().gte(1),
 ...
 */
export const valorantGameRoundWinnerResponse: any = z.lazy(() => {
  return z
    .object({
      id: z.number().gte(1),
      side: valorantTeamSide,
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const valorantGameRoundWinnerRequest: any = z.lazy(() => {
  return z.object({ id: z.number().nullish(), side: valorantTeamSide.nullish() }).transform((data) => ({
    id: data['id'],
    side: data['side'],
  }));
});
