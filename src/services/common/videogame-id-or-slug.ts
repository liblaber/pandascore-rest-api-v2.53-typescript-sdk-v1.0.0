 ...
 */
export const videogameIdOrSlug = z.union([videogameId, videogameSlug]);
 ...
 */
export const videogameIdOrSlugResponse = z.union([videogameId, videogameSlug]);

/**
 * The shape of the model mapping from the application shape into the api schema.
 * Is equal to application shape if all property names match the api schema
 */
export const videogameIdOrSlugRequest = z.union([videogameId, videogameSlug]);
