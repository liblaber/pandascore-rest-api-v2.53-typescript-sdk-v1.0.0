 ...
 */
export const filterOverLolWildRiftMatches = z.object({
 ...
 */
export const filterOverLolWildRiftMatchesResponse = z
  .object({
    ...
    videogame_version: z
      .array(filterOverLolWildRiftMatchesVideogameVersionResponse)
      .min(1)
      .optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverLolWildRiftMatchesRequest = z
  .object({
