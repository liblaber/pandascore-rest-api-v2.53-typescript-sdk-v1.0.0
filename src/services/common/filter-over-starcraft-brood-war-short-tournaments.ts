 ...
 */
export const filterOverStarcraftBroodWarShortTournaments = z.object({
  ...
  videogameTitle: z
    .array(filterOverStarcraftBroodWarShortTournamentsVideogameTitle)
    .min(1)
    .optional(),
 ...
 */
export type FilterOverStarcraftBroodWarShortTournaments = z.infer<
  typeof filterOverStarcraftBroodWarShortTournaments
>;
 ...
 */
export const filterOverStarcraftBroodWarShortTournamentsResponse = z
  .object({
    ...
    tier: z.array(searchOverValorantShortTournamentsTier2).min(1).optional(),
    videogame_title: z
      .array(filterOverStarcraftBroodWarShortTournamentsVideogameTitleResponse)
      .min(1)
      .optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverStarcraftBroodWarShortTournamentsRequest = z
  .object({
    ...
    videogameTitle: z
      .array(filterOverStarcraftBroodWarShortTournamentsVideogameTitleRequest)
      .nullish(),
