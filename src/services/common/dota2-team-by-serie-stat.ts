 ...
 */
export const dota2TeamBySerieStat = z.object({
 ...
 */
export const dota2TeamBySerieStatResponse = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const dota2TeamBySerieStatRequest = z
  .object({
