 ...
 */
export const loLEventNashorObject = z.object({
 ...
 */
export const loLEventNashorObjectResponse = z
  .object({
    name: loLEventNashorValue,
  })
  .transform((data) => ({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const loLEventNashorObjectRequest = z
  .object({ name: loLEventNashorValue.nullish() })
  .transform((data) => ({
    name: data['name'],
  }));
