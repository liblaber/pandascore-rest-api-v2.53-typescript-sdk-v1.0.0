 ...
 */
export const shortTournamentWinnerId: any = z.lazy(() => {
 ...
 */
export const shortTournamentWinnerIdResponse: any = z.lazy(() => {
  return z.union([z.number(), z.number()]);
});
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const shortTournamentWinnerIdRequest: any = z.lazy(() => {
  return z.union([z.number(), z.number()]);
});
