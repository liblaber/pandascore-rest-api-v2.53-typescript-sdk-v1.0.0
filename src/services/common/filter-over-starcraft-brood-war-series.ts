 ...
 */
export const filterOverStarcraftBroodWarSeries = z.object({
 ...
 */
export const filterOverStarcraftBroodWarSeriesResponse = z
  .object({
    ...
    slug: z.array(z.string()).min(1).optional(),
    videogame_title: z
      .array(filterOverStarcraftBroodWarSeriesVideogameTitleResponse)
      .min(1)
      .optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverStarcraftBroodWarSeriesRequest = z
  .object({
