 ...
 */
export const searchOverLolWildRiftShortTournaments = z.object({
 ...
 */
export type SearchOverLolWildRiftShortTournaments = z.infer<
  typeof searchOverLolWildRiftShortTournaments
>;
 ...
 */
export const searchOverLolWildRiftShortTournamentsResponse = z
  .object({
    name: z.string().optional(),
    prizepool: z.string().optional(),
    slug: z
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverLolWildRiftShortTournamentsRequest = z
  .object({
