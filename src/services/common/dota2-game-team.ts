 ...
 */
export const dota2GameTeam = z.object({
 ...
 */
export const dota2GameTeamResponse = z
  .object({
    bans: z.array(z.number()),
    barracks_status: barracksStatusResponse,
    faction: dota2Faction,
    ...
    tower_status: towerStatusResponse,
  })
  .transform((data) => ({
    bans: data['bans'],
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const dota2GameTeamRequest = z
  .object({
