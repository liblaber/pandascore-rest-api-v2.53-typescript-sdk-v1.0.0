 ...
 */
export const rangeOverFifaShortTournaments = z.object({
 ...
 */
export const rangeOverFifaShortTournamentsResponse = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverFifaShortTournamentsRequest = z
  .object({
