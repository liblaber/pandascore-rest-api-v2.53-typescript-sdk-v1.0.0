 ...
 */
export const rangeOverMatches: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {RangeOverMatches} rangeOverMatches
 * @property {string[]}
 * @property {boolean[]}
 * @property {boolean[]}
 * @property {string[]}
 ...
 */
export type RangeOverMatches = z.infer<typeof rangeOverMatches>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverMatchesResponse: any = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverMatchesRequest: any = z.lazy(() => {
  return z
    .object({
