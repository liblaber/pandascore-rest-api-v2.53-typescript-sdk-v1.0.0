 ...
 */
export const rangeOverDota2ShortTournaments = z.object({
 ...
 */
export const rangeOverDota2ShortTournamentsResponse = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverDota2ShortTournamentsRequest = z
  .object({
