 ...
 */
export const filterOverFifaShortTournaments = z.object({
 ...
 */
export const filterOverFifaShortTournamentsResponse = z
  .object({
    ...
    tier: z.array(searchOverValorantShortTournamentsTier2).min(1).optional(),
    videogame_title: z
      .array(filterOverFifaShortTournamentsVideogameTitleResponse)
      .min(1)
      .optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverFifaShortTournamentsRequest = z
  .object({
