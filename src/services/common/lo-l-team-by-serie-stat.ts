 ...
 */
export const loLTeamBySerieStatResponse = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const loLTeamBySerieStatRequest = z
  .object({
