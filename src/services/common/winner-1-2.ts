 ...
 */
export const winner1_2 = z.object({
  active: z.boolean(),
  age: z.number().gte(0),
  birthday: z.string(),
  firstName: z.string(),
 ...
 */
export type Winner1_2 = z.infer<typeof winner1_2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const winner1_2Response = z
  .object({
    active: z.boolean(),
    age: z.number().gte(0),
    birthday: z.string(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const winner1_2Request = z
  .object({
