 ...
 */
export const filterOverValorantShortTournaments = z.object({
 ...
 */
export const filterOverValorantShortTournamentsResponse = z
  .object({
    ...
    tier: z.array(searchOverValorantShortTournamentsTier2).min(1).optional(),
    videogame_title: z
      .array(filterOverValorantShortTournamentsVideogameTitleResponse)
      .min(1)
      .optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverValorantShortTournamentsRequest = z
  .object({
