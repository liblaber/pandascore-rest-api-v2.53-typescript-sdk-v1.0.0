...
import { fullGameMatchWinner, fullGameMatchWinnerRequest, fullGameMatchWinnerResponse } from './full-game-match-winner';
import {
 ...
 */
export const fullGameMatch: any = z.lazy(() => {
  return z.object({
    ...
    videogame: z.any(),
    videogameVersion: fullGameMatchVideogameVersion.nullable(),
 ...
 */
export const fullGameMatchResponse: any = z.lazy(() => {
  return z
    .object({
      ...
      videogame: z.any(),
      videogame_version: fullGameMatchVideogameVersionResponse.nullable(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const fullGameMatchRequest: any = z.lazy(() => {
  return z
    .object({
