 ...
 */
export const searchOverOwShortTournaments = z.object({
 ...
 */
export const searchOverOwShortTournamentsResponse = z
  .object({
    name: z.string().optional(),
    prizepool: z.string().optional(),
    slug: z
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverOwShortTournamentsRequest = z
  .object({
