...
import {
  loLPhysicalDamage,
  loLPhysicalDamageRequest,
  loLPhysicalDamageResponse,
} from './lo-l-physical-damage';
 ...
 */
export const loLGamePlayer = z.object({
 ...
 */
export const loLGamePlayerResponse = z
  .object({
    assists: z.number().gte(0),
    champion: loLGamePlayerChampionResponse,
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const loLGamePlayerRequest = z
  .object({
