 ...
 */
export const searchOverCsgoShortTournaments = z.object({
 ...
 */
export const searchOverCsgoShortTournamentsResponse = z
  .object({
    name: z.string().optional(),
    prizepool: z.string().optional(),
    slug: z
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverCsgoShortTournamentsRequest = z
  .object({
