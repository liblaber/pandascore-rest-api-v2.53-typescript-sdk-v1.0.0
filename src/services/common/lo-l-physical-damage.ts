 ...
 */
export const loLPhysicalDamage: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {LoLPhysicalDamage} loLPhysicalDamage
 * @property {number}
 ...
 * @property {number}
 */
export type LoLPhysicalDamage = z.infer<typeof loLPhysicalDamage>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const loLPhysicalDamageResponse: any = z.lazy(() => {
  return z
    .object({
      dealt: z.number().gte(0).nullable(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const loLPhysicalDamageRequest: any = z.lazy(() => {
  return z
    .object({
