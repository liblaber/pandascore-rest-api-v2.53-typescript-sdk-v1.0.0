 ...
 */
export const filterOverLolWildRiftShortTournaments = z.object({
 ...
 */
export type FilterOverLolWildRiftShortTournaments = z.infer<
  typeof filterOverLolWildRiftShortTournaments
>;
 ...
 */
export const filterOverLolWildRiftShortTournamentsResponse = z
  .object({
    ...
    tier: z.array(searchOverValorantShortTournamentsTier2).min(1).optional(),
    videogame_title: z
      .array(filterOverLolWildRiftShortTournamentsVideogameTitleResponse)
      .min(1)
      .optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverLolWildRiftShortTournamentsRequest = z
  .object({
