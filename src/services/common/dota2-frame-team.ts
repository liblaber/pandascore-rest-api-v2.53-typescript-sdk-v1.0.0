...
import {
  dota2FramePlayer,
  dota2FramePlayerRequest,
  dota2FramePlayerResponse,
} from './dota2-frame-player';

/**
 * The shape of the model inside the application code - what the users use
 */
export const dota2FrameTeam = z.object({
 ...
 */
export const dota2FrameTeamResponse = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const dota2FrameTeamRequest = z
  .object({
