 ...
 */
export const rangeOverStarcraftBroodWarMatches = z.object({
 ...
 */
export const rangeOverStarcraftBroodWarMatchesResponse = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverStarcraftBroodWarMatchesRequest = z
  .object({
