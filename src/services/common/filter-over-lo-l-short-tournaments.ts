 ...
 */
export const filterOverLoLShortTournaments = z.object({
 ...
 */
export const filterOverLoLShortTournamentsResponse = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverLoLShortTournamentsRequest = z
  .object({
