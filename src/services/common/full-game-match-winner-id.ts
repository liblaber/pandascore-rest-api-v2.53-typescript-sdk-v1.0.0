 ...
 */
export const fullGameMatchWinnerId: any = z.lazy(() => {
 ...
 */
export const fullGameMatchWinnerIdResponse: any = z.lazy(() => {
  return z.union([z.number(), z.number()]);
});
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const fullGameMatchWinnerIdRequest: any = z.lazy(() => {
  return z.union([z.number(), z.number()]);
});
