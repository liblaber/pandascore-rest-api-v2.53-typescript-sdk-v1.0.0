 ...
 */
export const fullGameMatchVideogameVersion = z.object({
  current: z.boolean(),
 ...
 */
export const fullGameMatchVideogameVersionResponse = z
  .object({
    current: z.boolean(),
    name: z.string().regex(/^[0-9]+\.[0-9]+(\.[0-9]+)?$/),
  })
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const fullGameMatchVideogameVersionRequest = z
