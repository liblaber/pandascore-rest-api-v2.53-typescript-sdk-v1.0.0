 ...
 */
export const loLTeamLastGame = z.object({
  ...
  players: z.array(loLGamePlayer),
  position: z.number().gte(1),
  status: gameStatus,
  teams: z.array(loLGameTeam),
  winner: gameWinner,
 ...
 */
export const loLTeamLastGameResponse = z
  .object({
    ...
    players: z.array(loLGamePlayerResponse),
    position: z.number().gte(1),
    status: gameStatus,
    teams: z.array(loLGameTeamResponse),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const loLTeamLastGameRequest = z
  .object({
