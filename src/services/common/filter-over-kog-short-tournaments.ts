 ...
 */
export const filterOverKogShortTournaments = z.object({
 ...
 */
export const filterOverKogShortTournamentsResponse = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverKogShortTournamentsRequest = z
  .object({
