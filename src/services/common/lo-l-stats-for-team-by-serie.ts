...
} from './lo-l-team-by-serie-stat';

/**
 * The shape of the model inside the application code - what the users use
 */
export const loLStatsForTeamBySerie = z.object({
  acronym: z.string(),
  id: z.number().gte(1),
  imageUrl: z.string(),
 ...
 */
export const loLStatsForTeamBySerieResponse = z
  .object({
    acronym: z.string(),
    id: z.number().gte(1),
    image_url: z.string(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const loLStatsForTeamBySerieRequest = z
  .object({
