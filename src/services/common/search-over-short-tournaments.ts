 ...
 */
export const searchOverShortTournaments: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {SearchOverShortTournaments} searchOverShortTournaments
 * @property {string}
 * @property {string}
 * @property {string}
 ...
 */
export type SearchOverShortTournaments = z.infer<typeof searchOverShortTournaments>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverShortTournamentsResponse: any = z.lazy(() => {
  return z
    .object({
      name: z.string().optional(),
      prizepool: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverShortTournamentsRequest: any = z.lazy(() => {
  return z
    .object({
