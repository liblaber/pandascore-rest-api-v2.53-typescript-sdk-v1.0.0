 ...
 */
export const matchWinner = z.union([winner1_1, winner2_1]);
 ...
 */
export const matchWinnerResponse = z.union([winner1_1Response, winner2_1Response]);

/**
 * The shape of the model mapping from the application shape into the api schema.
 * Is equal to application shape if all property names match the api schema
 */
export const matchWinnerRequest = z.union([winner1_1Request, winner2_1Request]);
