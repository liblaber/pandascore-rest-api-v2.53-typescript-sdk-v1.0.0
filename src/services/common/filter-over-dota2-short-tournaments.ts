 ...
 */
export const filterOverDota2ShortTournaments = z.object({
 ...
 */
export const filterOverDota2ShortTournamentsResponse = z
  .object({
    ...
    tier: z.array(searchOverValorantShortTournamentsTier2).min(1).optional(),
    videogame_title: z
      .array(filterOverDota2ShortTournamentsVideogameTitleResponse)
      .min(1)
      .optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverDota2ShortTournamentsRequest = z
  .object({
