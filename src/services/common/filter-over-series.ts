...
import {
  ...
  filterOverSeriesVideogameTitleRequest,
  filterOverSeriesVideogameTitleResponse,
} from './filter-over-series-videogame-title';
 ...
 */
export const filterOverSeries: any = z.lazy(() => {
  return z.object({
    ...
    videogameTitle: z.array(filterOverSeriesVideogameTitle).min(1).optional(),
...
/**
 *
 * @typedef  {FilterOverSeries} filterOverSeries
 * @property {string[]}
 * @property {string[]}
 * @property {number[]}
 * @property {number[]}
 ...
 * @property {string[]}
 * @property {string[]}
 * @property {FilterOverSeriesVideogameTitle[]} - A videogame title id or slug. <br/>Only for `/csgo/*`, `/codmw/*`, `/fifa/*` and `/ow/*` endpoints <br/>
 * @property {OpponentId[]}
 * @property {OpponentType[]}
 * @property {number[]}
 */
export type FilterOverSeries = z.infer<typeof filterOverSeries>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverSeriesResponse: any = z.lazy(() => {
  return z
    .object({
      ...
      season: z.array(z.string()).min(1).optional(),
      slug: z.array(z.string()).min(1).optional(),
      videogame_title: z.array(filterOverSeriesVideogameTitleResponse).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverSeriesRequest: any = z.lazy(() => {
  return z
    .object({
      ...
      videogameTitle: z.array(filterOverSeriesVideogameTitleRequest).nullish(),
