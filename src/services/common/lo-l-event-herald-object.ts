 ...
 */
export const loLEventHeraldObject = z.object({
 ...
 */
export const loLEventHeraldObjectResponse = z
  .object({
    name: loLEventHeraldValue,
  })
  .transform((data) => ({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const loLEventHeraldObjectRequest = z
  .object({ name: loLEventHeraldValue.nullish() })
  .transform((data) => ({
    name: data['name'],
  }));
