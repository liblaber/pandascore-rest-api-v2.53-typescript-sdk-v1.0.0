 ...
 */
export const searchOverStarcraft2ShortTournaments = z.object({
 ...
 */
export type SearchOverStarcraft2ShortTournaments = z.infer<
  typeof searchOverStarcraft2ShortTournaments
>;
 ...
 */
export const searchOverStarcraft2ShortTournamentsResponse = z
  .object({
    name: z.string().optional(),
    prizepool: z.string().optional(),
    slug: z
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverStarcraft2ShortTournamentsRequest = z
  .object({
