...
import {
  valorantShortAgent,
  valorantShortAgentRequest,
  valorantShortAgentResponse,
} from './valorant-short-agent';
import {
 ...
 */
export const valorantGamePlayer = z.object({
  active: z.boolean(),
  age: z.number().gte(0),
  agent: valorantShortAgent,
  assists: z.number().gte(0),
  averageCombatScore: z.number().gte(0),
  averageDamagePerRound: z.number().gte(0),
  averageEconomyScore: z.number().gte(0),
  birthday: z.string(),
 ...
 */
export const valorantGamePlayerResponse = z
  .object({
    active: z.boolean(),
    age: z.number().gte(0),
    agent: valorantShortAgentResponse,
    assists: z.number().gte(0),
    average_combat_score: z.number().gte(0),
    average_damage_per_round: z.number().gte(0),
    average_economy_score: z.number().gte(0),
    birthday: z.string(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const valorantGamePlayerRequest = z
  .object({
