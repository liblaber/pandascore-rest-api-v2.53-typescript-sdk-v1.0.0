 ...
 */
export const filterOverStarcraft2ShortTournaments = z.object({
 ...
 */
export type FilterOverStarcraft2ShortTournaments = z.infer<
  typeof filterOverStarcraft2ShortTournaments
>;
 ...
 */
export const filterOverStarcraft2ShortTournamentsResponse = z
  .object({
    ...
    tier: z.array(searchOverValorantShortTournamentsTier2).min(1).optional(),
    videogame_title: z
      .array(filterOverStarcraft2ShortTournamentsVideogameTitleResponse)
      .min(1)
      .optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverStarcraft2ShortTournamentsRequest = z
  .object({
