 ...
 */
export const filterOverTeams: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {FilterOverTeams} filterOverTeams
 * @property {string[]}
 * @property {number[]}
 * @property {string[]}
 * @property {string[]}
 ...
 */
export type FilterOverTeams = z.infer<typeof filterOverTeams>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverTeamsResponse: any = z.lazy(() => {
  return z
    .object({
      acronym: z.array(z.string()).min(1).optional(),
      id: z.array(z.number()).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverTeamsRequest: any = z.lazy(() => {
  return z
    .object({
