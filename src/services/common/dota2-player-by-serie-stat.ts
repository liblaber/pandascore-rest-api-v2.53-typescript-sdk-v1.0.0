 ...
 */
export const dota2PlayerBySerieStat = z.object({
 ...
 */
export const dota2PlayerBySerieStatResponse = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const dota2PlayerBySerieStatRequest = z
  .object({
