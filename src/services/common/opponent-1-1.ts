 ...
 */
export const opponent1_1: any = z.lazy(() => {
  return z.object({
    active: z.boolean(),
...
/**
 *
 * @typedef  {Opponent1_1} opponent1_1
 ...
 */
export type Opponent1_1 = z.infer<typeof opponent1_1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const opponent1_1Response: any = z.lazy(() => {
  return z
    .object({
      active: z.boolean(),
      age: z.number().gte(0).nullable(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const opponent1_1Request: any = z.lazy(() => {
  return z
    .object({
