 ...
 */
export const loLMagicDamage: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {LoLMagicDamage} loLMagicDamage
 * @property {number}
 ...
 * @property {number}
 */
export type LoLMagicDamage = z.infer<typeof loLMagicDamage>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const loLMagicDamageResponse: any = z.lazy(() => {
  return z
    .object({
      dealt: z.number().gte(0).nullable(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const loLMagicDamageRequest: any = z.lazy(() => {
  return z
    .object({
