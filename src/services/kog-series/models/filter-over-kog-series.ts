...
import {
  ...
  filterOverKogSeriesVideogameTitleRequest,
  filterOverKogSeriesVideogameTitleResponse,
} from './filter-over-kog-series-videogame-title';
 ...
 */
export const filterOverKogSeries: any = z.lazy(() => {
  return z.object({
    ...
    videogameTitle: z.array(filterOverKogSeriesVideogameTitle).min(1).optional(),
...
/**
 *
 * @typedef  {FilterOverKogSeries} filterOverKogSeries
 * @property {string[]}
 * @property {string[]}
 * @property {number[]}
 * @property {number[]}
 ...
 * @property {string[]}
 * @property {string[]}
 * @property {FilterOverKogSeriesVideogameTitle[]} - A videogame title id or slug. <br/>Only for `/csgo/*`, `/codmw/*`, `/fifa/*` and `/ow/*` endpoints <br/>
 * @property {OpponentId[]}
 * @property {OpponentType[]}
 * @property {number[]}
 */
export type FilterOverKogSeries = z.infer<typeof filterOverKogSeries>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverKogSeriesResponse: any = z.lazy(() => {
  return z
    .object({
      ...
      season: z.array(z.string()).min(1).optional(),
      slug: z.array(z.string()).min(1).optional(),
      videogame_title: z.array(filterOverKogSeriesVideogameTitleResponse).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverKogSeriesRequest: any = z.lazy(() => {
  return z
    .object({
      ...
      videogameTitle: z.array(filterOverKogSeriesVideogameTitleRequest).nullish(),
