 ...
 */
export const rangeOverKogSeries: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {RangeOverKogSeries} rangeOverKogSeries
 * @property {string[]}
 * @property {string[]}
 * @property {number[]}
 * @property {number[]}
 ...
 * @property {number[]}
 */
export type RangeOverKogSeries = z.infer<typeof rangeOverKogSeries>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverKogSeriesResponse: any = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverKogSeriesRequest: any = z.lazy(() => {
  return z
    .object({
