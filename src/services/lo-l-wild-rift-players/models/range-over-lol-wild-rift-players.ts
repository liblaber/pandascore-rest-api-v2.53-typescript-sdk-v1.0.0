 ...
 */
export const rangeOverLolWildRiftPlayers: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {RangeOverLolWildRiftPlayers} rangeOverLolWildRiftPlayers
 * @property {string[]}
 * @property {string[]}
 * @property {number[]}
 * @property {string[]}
 ...
 * @property {string[]}
 */
export type RangeOverLolWildRiftPlayers = z.infer<typeof rangeOverLolWildRiftPlayers>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverLolWildRiftPlayersResponse: any = z.lazy(() => {
  return z
    .object({
      birthday: z.array(z.string()).min(2).max(2).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverLolWildRiftPlayersRequest: any = z.lazy(() => {
  return z
    .object({
