 ...
 */
export const filterOverLolWildRiftPlayers = z.lazy(() => {
  return z.object({
 ...
 */
export const filterOverLolWildRiftPlayersResponse = z.lazy(() => {
  return z
    .object({
      active: z.boolean().optional(),
      birthday: z.array(z.string()).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverLolWildRiftPlayersRequest = z.lazy(() => {
  return z
    .object({
