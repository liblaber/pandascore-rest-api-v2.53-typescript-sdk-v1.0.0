 ...
 */
export const filterOverLolWildRiftPlayers: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {FilterOverLolWildRiftPlayers} filterOverLolWildRiftPlayers
 ...
 */
export type FilterOverLolWildRiftPlayers = z.infer<typeof filterOverLolWildRiftPlayers>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverLolWildRiftPlayersResponse: any = z.lazy(() => {
  return z
    .object({
      active: z.boolean().optional(),
      birthday: z.array(z.string()).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverLolWildRiftPlayersRequest: any = z.lazy(() => {
  return z
    .object({
