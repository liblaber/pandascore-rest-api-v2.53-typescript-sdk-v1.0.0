 ...
 */
export const filterOverLolWildRiftMatches = z.lazy(() => {
  return z.object({
 ...
 */
export const filterOverLolWildRiftMatchesResponse = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverLolWildRiftMatchesRequest = z.lazy(() => {
  return z
    .object({
