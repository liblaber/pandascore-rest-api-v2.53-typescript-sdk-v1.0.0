...
import {
  ...
  filterOverLolWildRiftMatchesOpponentIdRequest,
  filterOverLolWildRiftMatchesOpponentIdResponse,
} from './filter-over-lol-wild-rift-matches-opponent-id';
...
import {
  ...
  filterOverLolWildRiftMatchesVideogameTitleRequest,
  filterOverLolWildRiftMatchesVideogameTitleResponse,
} from './filter-over-lol-wild-rift-matches-videogame-title';
import {
  filterOverLolWildRiftMatchesVideogameVersion,
  filterOverLolWildRiftMatchesVideogameVersionRequest,
  filterOverLolWildRiftMatchesVideogameVersionResponse,
} from './filter-over-lol-wild-rift-matches-videogame-version';
 ...
 */
export const filterOverLolWildRiftMatches: any = z.lazy(() => {
  return z.object({
    ...
    opponentId: z.array(filterOverLolWildRiftMatchesOpponentId).min(1).optional(),
    ...
    videogameTitle: z.array(filterOverLolWildRiftMatchesVideogameTitle).min(1).optional(),
    videogameVersion: z.array(filterOverLolWildRiftMatchesVideogameVersion).min(1).optional(),
...
/**
 *
 * @typedef  {FilterOverLolWildRiftMatches} filterOverLolWildRiftMatches
 * @property {string[]}
 ...
 * @property {boolean}
 * @property {number[]}
 * @property {FilterOverLolWildRiftMatchesOpponentId[]} - A Team or a Player (id or slug). You can use`filter[winner_type]=Team` or `filter[winner_type]=Player` to focus on teams or players.
 ...
 * @property {FilterOverLolWildRiftMatchesVideogameTitle[]} - A videogame title id or slug. <br/>Only for `/csgo/*`, `/codmw/*`, `/fifa/*` and `/ow/*` endpoints <br/>
 * @property {FilterOverLolWildRiftMatchesVideogameVersion[]} - Filter by the names of videogame versions, all versions using `filter[videogame_version]=all`, or by the latest version using `filter[videogame_version]=latest` <br/>Only for `valorant/*` and `/lol/*` endpoints. <br/>
 * @property {OpponentId[]}
 * @property {MatchWinnerType[]}
 */
export type FilterOverLolWildRiftMatches = z.infer<typeof filterOverLolWildRiftMatches>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverLolWildRiftMatchesResponse: any = z.lazy(() => {
  return z
    .object({
      ...
      opponent_id: z.array(filterOverLolWildRiftMatchesOpponentIdResponse).min(1).optional(),
      ...
      videogame_title: z.array(filterOverLolWildRiftMatchesVideogameTitleResponse).min(1).optional(),
      videogame_version: z.array(filterOverLolWildRiftMatchesVideogameVersionResponse).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverLolWildRiftMatchesRequest: any = z.lazy(() => {
  return z
    .object({
      ...
      opponentId: z.array(filterOverLolWildRiftMatchesOpponentIdRequest).nullish(),
      ...
      videogameTitle: z.array(filterOverLolWildRiftMatchesVideogameTitleRequest).nullish(),
      videogameVersion: z.array(filterOverLolWildRiftMatchesVideogameVersionRequest).nullish(),
