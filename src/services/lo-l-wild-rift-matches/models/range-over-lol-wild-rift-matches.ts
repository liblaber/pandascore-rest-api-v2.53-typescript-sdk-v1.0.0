 ...
 */
export const rangeOverLolWildRiftMatches: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {RangeOverLolWildRiftMatches} rangeOverLolWildRiftMatches
 * @property {string[]}
 * @property {boolean[]}
 * @property {boolean[]}
 * @property {string[]}
 ...
 */
export type RangeOverLolWildRiftMatches = z.infer<typeof rangeOverLolWildRiftMatches>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverLolWildRiftMatchesResponse: any = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverLolWildRiftMatchesRequest: any = z.lazy(() => {
  return z
    .object({
