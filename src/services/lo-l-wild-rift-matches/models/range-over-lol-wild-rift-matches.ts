 ...
 */
export const rangeOverLolWildRiftMatches = z.lazy(() => {
  return z.object({
 ...
 */
export const rangeOverLolWildRiftMatchesResponse = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverLolWildRiftMatchesRequest = z.lazy(() => {
  return z
    .object({
