...
import {
  ...
  filterOverKogMatchesOpponentIdRequest,
  filterOverKogMatchesOpponentIdResponse,
} from './filter-over-kog-matches-opponent-id';
...
import {
  ...
  filterOverKogMatchesVideogameTitleRequest,
  filterOverKogMatchesVideogameTitleResponse,
} from './filter-over-kog-matches-videogame-title';
import {
  filterOverKogMatchesVideogameVersion,
  filterOverKogMatchesVideogameVersionRequest,
  filterOverKogMatchesVideogameVersionResponse,
} from './filter-over-kog-matches-videogame-version';
 ...
 */
export const filterOverKogMatches: any = z.lazy(() => {
  return z.object({
    ...
    opponentId: z.array(filterOverKogMatchesOpponentId).min(1).optional(),
    ...
    videogameTitle: z.array(filterOverKogMatchesVideogameTitle).min(1).optional(),
    videogameVersion: z.array(filterOverKogMatchesVideogameVersion).min(1).optional(),
...
/**
 *
 * @typedef  {FilterOverKogMatches} filterOverKogMatches
 * @property {string[]}
 ...
 * @property {boolean}
 * @property {number[]}
 * @property {FilterOverKogMatchesOpponentId[]} - A Team or a Player (id or slug). You can use`filter[winner_type]=Team` or `filter[winner_type]=Player` to focus on teams or players.
 ...
 * @property {FilterOverKogMatchesVideogameTitle[]} - A videogame title id or slug. <br/>Only for `/csgo/*`, `/codmw/*`, `/fifa/*` and `/ow/*` endpoints <br/>
 * @property {FilterOverKogMatchesVideogameVersion[]} - Filter by the names of videogame versions, all versions using `filter[videogame_version]=all`, or by the latest version using `filter[videogame_version]=latest` <br/>Only for `valorant/*` and `/lol/*` endpoints. <br/>
 * @property {OpponentId[]}
 * @property {MatchWinnerType[]}
 */
export type FilterOverKogMatches = z.infer<typeof filterOverKogMatches>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverKogMatchesResponse: any = z.lazy(() => {
  return z
    .object({
      ...
      opponent_id: z.array(filterOverKogMatchesOpponentIdResponse).min(1).optional(),
      ...
      videogame_title: z.array(filterOverKogMatchesVideogameTitleResponse).min(1).optional(),
      videogame_version: z.array(filterOverKogMatchesVideogameVersionResponse).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverKogMatchesRequest: any = z.lazy(() => {
  return z
    .object({
      ...
      opponentId: z.array(filterOverKogMatchesOpponentIdRequest).nullish(),
      ...
      videogameTitle: z.array(filterOverKogMatchesVideogameTitleRequest).nullish(),
      videogameVersion: z.array(filterOverKogMatchesVideogameVersionRequest).nullish(),
