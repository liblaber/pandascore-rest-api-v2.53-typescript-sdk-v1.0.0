 ...
 */
export const rangeOverKogMatches: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {RangeOverKogMatches} rangeOverKogMatches
 * @property {string[]}
 * @property {boolean[]}
 * @property {boolean[]}
 * @property {string[]}
 ...
 */
export type RangeOverKogMatches = z.infer<typeof rangeOverKogMatches>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverKogMatchesResponse: any = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverKogMatchesRequest: any = z.lazy(() => {
  return z
    .object({
