 ...
 */
export const searchOverKogMatches: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {SearchOverKogMatches} searchOverKogMatches
 * @property {MatchType}
 * @property {string}
 * @property {string}
 ...
 */
export type SearchOverKogMatches = z.infer<typeof searchOverKogMatches>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverKogMatchesResponse: any = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverKogMatchesRequest: any = z.lazy(() => {
  return z
    .object({
