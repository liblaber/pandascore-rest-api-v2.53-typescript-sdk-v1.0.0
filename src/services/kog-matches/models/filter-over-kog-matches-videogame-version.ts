 ...
 */
export const filterOverKogMatchesVideogameVersion = z.lazy(() => {
 ...
 */
export const filterOverKogMatchesVideogameVersionResponse = z.lazy(() => {
  return z.union([z.string(), z.any(), z.any()]);
});
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverKogMatchesVideogameVersionRequest = z.lazy(() => {
  return z.union([z.string(), z.any(), z.any()]);
});
