 ...
 */
export const searchOverRlMatches: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {SearchOverRlMatches} searchOverRlMatches
 * @property {MatchType}
 * @property {string}
 * @property {string}
 ...
 */
export type SearchOverRlMatches = z.infer<typeof searchOverRlMatches>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverRlMatchesResponse: any = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverRlMatchesRequest: any = z.lazy(() => {
  return z
    .object({
