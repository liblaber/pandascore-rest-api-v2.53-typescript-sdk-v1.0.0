 ...
 */
export const rangeOverRlMatches: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {RangeOverRlMatches} rangeOverRlMatches
 * @property {string[]}
 * @property {boolean[]}
 * @property {boolean[]}
 * @property {string[]}
 ...
 */
export type RangeOverRlMatches = z.infer<typeof rangeOverRlMatches>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverRlMatchesResponse: any = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverRlMatchesRequest: any = z.lazy(() => {
  return z
    .object({
