 ...
 */
export const filterOverRlMatchesOpponentId = z.lazy(() => {
 ...
 */
export const filterOverRlMatchesOpponentIdResponse = z.lazy(() => {
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverRlMatchesOpponentIdRequest = z.lazy(() => {
