...
import {
  ...
  filterOverRlMatchesOpponentIdRequest,
  filterOverRlMatchesOpponentIdResponse,
} from './filter-over-rl-matches-opponent-id';
...
import {
  ...
  filterOverRlMatchesVideogameTitleRequest,
  filterOverRlMatchesVideogameTitleResponse,
} from './filter-over-rl-matches-videogame-title';
import {
  filterOverRlMatchesVideogameVersion,
  filterOverRlMatchesVideogameVersionRequest,
  filterOverRlMatchesVideogameVersionResponse,
} from './filter-over-rl-matches-videogame-version';
 ...
 */
export const filterOverRlMatches: any = z.lazy(() => {
  return z.object({
    ...
    opponentId: z.array(filterOverRlMatchesOpponentId).min(1).optional(),
    ...
    videogameTitle: z.array(filterOverRlMatchesVideogameTitle).min(1).optional(),
    videogameVersion: z.array(filterOverRlMatchesVideogameVersion).min(1).optional(),
...
/**
 *
 * @typedef  {FilterOverRlMatches} filterOverRlMatches
 * @property {string[]}
 ...
 * @property {boolean}
 * @property {number[]}
 * @property {FilterOverRlMatchesOpponentId[]} - A Team or a Player (id or slug). You can use`filter[winner_type]=Team` or `filter[winner_type]=Player` to focus on teams or players.
 ...
 * @property {FilterOverRlMatchesVideogameTitle[]} - A videogame title id or slug. <br/>Only for `/csgo/*`, `/codmw/*`, `/fifa/*` and `/ow/*` endpoints <br/>
 * @property {FilterOverRlMatchesVideogameVersion[]} - Filter by the names of videogame versions, all versions using `filter[videogame_version]=all`, or by the latest version using `filter[videogame_version]=latest` <br/>Only for `valorant/*` and `/lol/*` endpoints. <br/>
 * @property {OpponentId[]}
 * @property {MatchWinnerType[]}
 */
export type FilterOverRlMatches = z.infer<typeof filterOverRlMatches>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverRlMatchesResponse: any = z.lazy(() => {
  return z
    .object({
      ...
      opponent_id: z.array(filterOverRlMatchesOpponentIdResponse).min(1).optional(),
      ...
      videogame_title: z.array(filterOverRlMatchesVideogameTitleResponse).min(1).optional(),
      videogame_version: z.array(filterOverRlMatchesVideogameVersionResponse).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverRlMatchesRequest: any = z.lazy(() => {
  return z
    .object({
      ...
      opponentId: z.array(filterOverRlMatchesOpponentIdRequest).nullish(),
      ...
      videogameTitle: z.array(filterOverRlMatchesVideogameTitleRequest).nullish(),
      videogameVersion: z.array(filterOverRlMatchesVideogameVersionRequest).nullish(),
