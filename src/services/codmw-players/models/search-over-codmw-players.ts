 ...
 */
export const searchOverCodmwPlayers: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {SearchOverCodmwPlayers} searchOverCodmwPlayers
 ...
 */
export type SearchOverCodmwPlayers = z.infer<typeof searchOverCodmwPlayers>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverCodmwPlayersResponse: any = z.lazy(() => {
  return z
    .object({
      birthday: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverCodmwPlayersRequest: any = z.lazy(() => {
  return z
    .object({
