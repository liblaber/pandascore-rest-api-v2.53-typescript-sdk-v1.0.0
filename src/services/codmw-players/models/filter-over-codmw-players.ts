 ...
 */
export const filterOverCodmwPlayers: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {FilterOverCodmwPlayers} filterOverCodmwPlayers
 ...
 */
export type FilterOverCodmwPlayers = z.infer<typeof filterOverCodmwPlayers>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverCodmwPlayersResponse: any = z.lazy(() => {
  return z
    .object({
      active: z.boolean().optional(),
      birthday: z.array(z.string()).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverCodmwPlayersRequest: any = z.lazy(() => {
  return z
    .object({
