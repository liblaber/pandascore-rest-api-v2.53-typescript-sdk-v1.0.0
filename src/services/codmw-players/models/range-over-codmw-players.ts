 ...
 */
export const rangeOverCodmwPlayers: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {RangeOverCodmwPlayers} rangeOverCodmwPlayers
 * @property {string[]}
 * @property {string[]}
 * @property {number[]}
 * @property {string[]}
 ...
 * @property {string[]}
 */
export type RangeOverCodmwPlayers = z.infer<typeof rangeOverCodmwPlayers>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverCodmwPlayersResponse: any = z.lazy(() => {
  return z
    .object({
      birthday: z.array(z.string()).min(2).max(2).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverCodmwPlayersRequest: any = z.lazy(() => {
  return z
    .object({
