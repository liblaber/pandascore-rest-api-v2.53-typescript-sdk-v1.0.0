 ...
 */
export const rangeOverDota2Matches: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {RangeOverDota2Matches} rangeOverDota2Matches
 * @property {string[]}
 * @property {boolean[]}
 * @property {boolean[]}
 * @property {string[]}
 ...
 */
export type RangeOverDota2Matches = z.infer<typeof rangeOverDota2Matches>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverDota2MatchesResponse: any = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverDota2MatchesRequest: any = z.lazy(() => {
  return z
    .object({
