...
import {
  ...
  filterOverDota2MatchesOpponentIdRequest,
  filterOverDota2MatchesOpponentIdResponse,
} from './filter-over-dota2-matches-opponent-id';
...
import {
  ...
  filterOverDota2MatchesVideogameTitleRequest,
  filterOverDota2MatchesVideogameTitleResponse,
} from './filter-over-dota2-matches-videogame-title';
import {
  filterOverDota2MatchesVideogameVersion,
  filterOverDota2MatchesVideogameVersionRequest,
  filterOverDota2MatchesVideogameVersionResponse,
} from './filter-over-dota2-matches-videogame-version';
 ...
 */
export const filterOverDota2Matches: any = z.lazy(() => {
  return z.object({
    ...
    opponentId: z.array(filterOverDota2MatchesOpponentId).min(1).optional(),
    ...
    videogameTitle: z.array(filterOverDota2MatchesVideogameTitle).min(1).optional(),
    videogameVersion: z.array(filterOverDota2MatchesVideogameVersion).min(1).optional(),
...
/**
 *
 * @typedef  {FilterOverDota2Matches} filterOverDota2Matches
 * @property {string[]}
 ...
 * @property {boolean}
 * @property {number[]}
 * @property {FilterOverDota2MatchesOpponentId[]} - A Team or a Player (id or slug). You can use`filter[winner_type]=Team` or `filter[winner_type]=Player` to focus on teams or players.
 ...
 * @property {FilterOverDota2MatchesVideogameTitle[]} - A videogame title id or slug. <br/>Only for `/csgo/*`, `/codmw/*`, `/fifa/*` and `/ow/*` endpoints <br/>
 * @property {FilterOverDota2MatchesVideogameVersion[]} - Filter by the names of videogame versions, all versions using `filter[videogame_version]=all`, or by the latest version using `filter[videogame_version]=latest` <br/>Only for `valorant/*` and `/lol/*` endpoints. <br/>
 * @property {OpponentId[]}
 * @property {MatchWinnerType[]}
 */
export type FilterOverDota2Matches = z.infer<typeof filterOverDota2Matches>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverDota2MatchesResponse: any = z.lazy(() => {
  return z
    .object({
      ...
      opponent_id: z.array(filterOverDota2MatchesOpponentIdResponse).min(1).optional(),
      ...
      videogame_title: z.array(filterOverDota2MatchesVideogameTitleResponse).min(1).optional(),
      videogame_version: z.array(filterOverDota2MatchesVideogameVersionResponse).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverDota2MatchesRequest: any = z.lazy(() => {
  return z
    .object({
      ...
      opponentId: z.array(filterOverDota2MatchesOpponentIdRequest).nullish(),
      ...
      videogameTitle: z.array(filterOverDota2MatchesVideogameTitleRequest).nullish(),
      videogameVersion: z.array(filterOverDota2MatchesVideogameVersionRequest).nullish(),
