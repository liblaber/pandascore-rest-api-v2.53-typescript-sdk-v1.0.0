 ...
 */
export const rangeOverPubgSeries: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {RangeOverPubgSeries} rangeOverPubgSeries
 * @property {string[]}
 * @property {string[]}
 * @property {number[]}
 * @property {number[]}
 ...
 * @property {number[]}
 */
export type RangeOverPubgSeries = z.infer<typeof rangeOverPubgSeries>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverPubgSeriesResponse: any = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverPubgSeriesRequest: any = z.lazy(() => {
  return z
    .object({
