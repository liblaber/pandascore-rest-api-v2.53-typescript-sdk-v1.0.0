 ...
 */
export const rangeOverStarcraft2ShortTournaments: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {RangeOverStarcraft2ShortTournaments} rangeOverStarcraft2ShortTournaments
 * @property {string[]}
 * @property {boolean[]}
 * @property {string[]}
 * @property {boolean[]}
 ...
 */
export type RangeOverStarcraft2ShortTournaments = z.infer<typeof rangeOverStarcraft2ShortTournaments>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverStarcraft2ShortTournamentsResponse: any = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverStarcraft2ShortTournamentsRequest: any = z.lazy(() => {
  return z
    .object({
