 ...
 */
export const rangeOverStarcraft2ShortTournaments = z.lazy(() => {
  return z.object({
 ...
 */
export const rangeOverStarcraft2ShortTournamentsResponse = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverStarcraft2ShortTournamentsRequest = z.lazy(() => {
  return z
    .object({
