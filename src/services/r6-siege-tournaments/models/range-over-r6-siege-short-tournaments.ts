 ...
 */
export const rangeOverR6SiegeShortTournaments: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {RangeOverR6SiegeShortTournaments} rangeOverR6SiegeShortTournaments
 * @property {string[]}
 * @property {boolean[]}
 * @property {string[]}
 * @property {boolean[]}
 ...
 */
export type RangeOverR6SiegeShortTournaments = z.infer<typeof rangeOverR6SiegeShortTournaments>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverR6SiegeShortTournamentsResponse: any = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverR6SiegeShortTournamentsRequest: any = z.lazy(() => {
  return z
    .object({
