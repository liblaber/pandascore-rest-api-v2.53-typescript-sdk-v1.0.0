 ...
 */
export const rangeOverR6SiegeShortTournaments = z.lazy(() => {
  return z.object({
 ...
 */
export const rangeOverR6SiegeShortTournamentsResponse = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverR6SiegeShortTournamentsRequest = z.lazy(() => {
  return z
    .object({
