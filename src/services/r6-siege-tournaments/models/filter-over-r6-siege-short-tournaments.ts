 ...
 */
export const filterOverR6SiegeShortTournaments: any = z.lazy(() => {
  return z.object({
 ...
 */
export const filterOverR6SiegeShortTournamentsResponse: any = z.lazy(() => {
  return z
    .object({
      ...
      slug: z.array(z.string()).min(1).optional(),
      tier: z.array(searchOverValorantShortTournamentsTier2).min(1).optional(),
      videogame_title: z.array(filterOverR6SiegeShortTournamentsVideogameTitleResponse).min(1).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverR6SiegeShortTournamentsRequest: any = z.lazy(() => {
  return z
    .object({
