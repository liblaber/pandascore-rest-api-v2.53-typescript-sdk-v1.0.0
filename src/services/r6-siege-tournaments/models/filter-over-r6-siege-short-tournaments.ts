 ...
 */
export const filterOverR6SiegeShortTournaments = z.lazy(() => {
  return z.object({
 ...
 */
export const filterOverR6SiegeShortTournamentsResponse = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverR6SiegeShortTournamentsRequest = z.lazy(() => {
  return z
    .object({
