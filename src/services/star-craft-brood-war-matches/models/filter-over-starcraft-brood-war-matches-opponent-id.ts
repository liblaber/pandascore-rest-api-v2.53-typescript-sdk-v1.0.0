 ...
 */
export const filterOverStarcraftBroodWarMatchesOpponentId = z.lazy(() => {
 ...
 */
export const filterOverStarcraftBroodWarMatchesOpponentIdResponse = z.lazy(() => {
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverStarcraftBroodWarMatchesOpponentIdRequest = z.lazy(() => {
