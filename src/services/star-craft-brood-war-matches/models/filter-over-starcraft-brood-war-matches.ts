 ...
 */
export const filterOverStarcraftBroodWarMatches = z.lazy(() => {
  return z.object({
 ...
 */
export const filterOverStarcraftBroodWarMatchesResponse = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverStarcraftBroodWarMatchesRequest = z.lazy(() => {
  return z
    .object({
