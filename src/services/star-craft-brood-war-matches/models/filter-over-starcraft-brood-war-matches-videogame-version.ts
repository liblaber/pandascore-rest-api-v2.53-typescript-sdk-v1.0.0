 ...
 */
export const filterOverStarcraftBroodWarMatchesVideogameVersion = z.lazy(() => {
 ...
 */
export const filterOverStarcraftBroodWarMatchesVideogameVersionResponse = z.lazy(() => {
  return z.union([z.string(), z.any(), z.any()]);
});
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filterOverStarcraftBroodWarMatchesVideogameVersionRequest = z.lazy(() => {
  return z.union([z.string(), z.any(), z.any()]);
});
