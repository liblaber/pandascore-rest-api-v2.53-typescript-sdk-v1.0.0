 ...
 */
export const rangeOverStarcraftBroodWarMatches = z.lazy(() => {
  return z.object({
    ...
    matchType: z.array(z.string()).min(2).max(2).optional(),
 ...
 */
export const rangeOverStarcraftBroodWarMatchesResponse = z.lazy(() => {
  return z
    .object({
      ...
      forfeit: z.array(z.boolean()).min(2).max(2).optional(),
      id: z.array(z.number()).min(2).max(2).optional(),
      match_type: z.array(z.string()).min(2).max(2).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverStarcraftBroodWarMatchesRequest = z.lazy(() => {
  return z
    .object({
