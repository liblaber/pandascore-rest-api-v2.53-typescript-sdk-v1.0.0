 ...
 */
export const rangeOverStarcraftBroodWarMatches: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {RangeOverStarcraftBroodWarMatches} rangeOverStarcraftBroodWarMatches
 * @property {string[]}
 * @property {boolean[]}
 * @property {boolean[]}
 * @property {string[]}
 ...
 */
export type RangeOverStarcraftBroodWarMatches = z.infer<typeof rangeOverStarcraftBroodWarMatches>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverStarcraftBroodWarMatchesResponse: any = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverStarcraftBroodWarMatchesRequest: any = z.lazy(() => {
  return z
    .object({
