 ...
 */
export const searchOverStarcraftBroodWarMatches: any = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {SearchOverStarcraftBroodWarMatches} searchOverStarcraftBroodWarMatches
 * @property {MatchType}
 * @property {string}
 * @property {string}
 ...
 */
export type SearchOverStarcraftBroodWarMatches = z.infer<typeof searchOverStarcraftBroodWarMatches>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverStarcraftBroodWarMatchesResponse: any = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const searchOverStarcraftBroodWarMatchesRequest: any = z.lazy(() => {
  return z
    .object({
