 ...
 */
export const rangeOverCsgoWeapons = z.lazy(() => {
  return z.object({
    ...
    kind: z.array(z.string()).min(2).max(2).optional(),
 ...
 */
export const rangeOverCsgoWeaponsResponse = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rangeOverCsgoWeaponsRequest = z.lazy(() => {
  return z
    .object({
