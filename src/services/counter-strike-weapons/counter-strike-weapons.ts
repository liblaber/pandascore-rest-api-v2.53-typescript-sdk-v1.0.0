...
import { CsgoWeapon, csgoWeaponResponse } from '../common';
...
export class CounterStrikeWeaponsService extends BaseService {
  ...
  async getCsgoWeaponsCsgoWeaponIdOrSlug(
    ...
    const path = this.client.buildPath('/csgo/weapons/{csgo_weapon_id_or_slug}', {
      csgo_weapon_id_or_slug: csgoWeaponIdOrSlug,
    });
    const options: any = {
